= Function: Document Controlled Expiry 6.6.1
...
You can completely avoid _N1QL(...)_ and use _couchbase.replace(bucket_binding, meta, doc)_ as the docControlledSelfExpiry_661 variant is much faster.
