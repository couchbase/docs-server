...
function CreateRecurringTimer(context) {
    ...
    if (context.mode === "via_onupdate") {
        ...
        //  Depending on your local you may need to adjust this for example
        // in Los Angeles, CA, USA it will excute 7 hours later than GMT.
...
+
----
2020-08-06T08:50:21.529-07:00 [INFO] "Finish CreateRecurringTimer (local time) nextSchedule" "2020-08-06 08:50:51.527"
2020-08-06T08:50:21.527-07:00 [INFO] "From CreateRecurringTimer: creating timer" "via_onupdate" "recurring_timer::1"
2020-08-06T08:50:21.526-07:00 [INFO] "From OnUpdate: create/overwrite doc.active" true "recurring_timer::1"
2020-08-06T08:48:46.638-07:00 [INFO] "From OnUpdate: no active Timer to cancel, doc.active" false "recurring_timer::1"
----
+
...
+
----
2020-08-05T17:09:34.619-07:00 [INFO] "From RecurringTimerCallback: timer fired" {"id":"recurring_timer::1","mode":"via_onupdate"}
2020-08-05T17:09:34.714-07:00 [INFO] "USER FUNCTION DONE OKAY (curl 200 took 95 ms.)"
2020-08-05T17:09:34.716-07:00 [INFO] "From CreateRecurringTimer: creating timer" "via_callback" "recurring_timer::1"
2020-08-05T17:09:34.716-07:00 [INFO] "Finish CreateRecurringTimer nextSchedule" "2020-08-06T07:00:00.000Z"
----
+
...
----
{
  "last_update": "2020-08-06T00:09:31.153Z",
  "apiReqDate": "2020-08-05",
  "curl_success": true,
  "valid": true,
  "millis": 464
}
...
. Wait about 30 seconds and repeat the above, to see the status of the most recent "work or cURL operation" of this Eventing function is merely writing a time stamp to the *cur_recurring_timer::1* initially 30 seconds, but for requests 2-N on a daily basis.
...
+
----
2020-08-06T00:00:01.021-07:00 [INFO] "From RecurringTimerCallback: timer fired" {"id":"recurring_timer::1","mode":"via_callback"}
2020-08-06T00:00:01.485-07:00 [INFO] "USER FUNCTION DONE OKAY (curl 200 took 464 ms.)"
2020-08-06T00:00:01.487-07:00 [INFO] "From CreateRecurringTimer: creating timer" "via_callback" "recurring_timer::1"
2020-08-06T00:00:01.487-07:00 [INFO] "Finish CreateRecurringTimer nextSchedule" "2020-08-07T07:00:00.000Z"
----
+
[Optional] Wait until the next morning and CLick "Log" link for Deployed Function *external_rest_via_curl_get* to view the activity.  
Now check the results of the callback, access the *Couchbase Web Console* > *Buckets* page and click the *Documents* link of the *source* bucket.
...
----
{
  "last_update": "2020-08-06T07:00:01.021Z",
  "apiReqDate": "2020-08-06",
  "curl_success": true,
  "valid": true,
  "millis": 464
}
...
+
----
2020-08-06T07:47:05.150-07:00 [INFO] "From OnUpdate: canceled active Timer, doc.active" false "recurring_timer::1"
----
