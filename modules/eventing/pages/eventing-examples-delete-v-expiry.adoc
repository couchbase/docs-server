...
[source,N1QL]
----
UPSERT INTO default (KEY, VALUE) VALUES ("SampleDocument2", {"a_key":"a_value"}, {"expiration":600});
----
Issue the above commandin the Query Workbench of the UI.

For information on setting docum,ent expiration times via N1QL, refer to xref:n1ql:n1ql-language-reference/insert.adoc#example-7a[Insert a document with expiration]
--
