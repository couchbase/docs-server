...
*Goal*: DIfferntiate between a deltion or an expiration.
...
+
image::del_v_expiry_01_settings.png[,484]
...
+
image::del_v_expiry_02_editor_with_default.png[,100%]
...
+
image::del_v_expiry_03_editor_with_code.png[,100%]
** Click *Save*.
...
* The expiry pager is run (default every 60 mnutes).
* Compaction is run. 
...
+
image::del_v_expiry_04_editor_view_bkt.png[,100%]
...
+
image::del_v_expiry_04b_editor_view_bkt.png[,100%]

. Access the *Couchbase Web Console* > *Eventing* page, click the function name *delete_v_expire* you should see statistics under the Deployment Statistics:
+
image::del_v_expiry_04_expiration.png[,800]
...
----
+
image::del_v_expiry_05_log_expired.png[,100%]

. Now lets create another document and perform a normal delete on it. Access the *Couchbase Web Console* > *Buckets* page and click the *Documents* link of the *source* bucket.
...
. Access the *Couchbase Web Console* > *Eventing* page, click the function name *delete_v_expire* you should see statistics under the Deployment Statistics:
+
image::del_v_expiry_06_deletion.png[,800]
...
----
+
image::del_v_expiry_06_log_deleted.png[,100%]
