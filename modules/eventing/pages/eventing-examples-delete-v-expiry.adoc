...
. Therefore we first wait the 10 minute period from the creation of SampleDocument2 and then we will try to access the document to expidiate the expiry.  
...
. Cick on the *Documents* link for the bucket *source* if the expiration on the document SampleDocument2 has occured there will be no documents found.
