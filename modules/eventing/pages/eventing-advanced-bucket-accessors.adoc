...
These seven (7) new accessors make it possible to utilize and leverage CAS directly and/or set a document expiration (or TTL) in the Data Service (or KV) via Eventing plus perfrom distributed atomic counter operations.
