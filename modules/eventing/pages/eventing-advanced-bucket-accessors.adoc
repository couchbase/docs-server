...
:description: pass:q[_Advanced Bucket Accessors_ make it possible to access advanced KV functionality using the following built-in operators.]
...
*The Advanced INCREMENT operation*: _result = couchbase.increment(binding, meta)_
