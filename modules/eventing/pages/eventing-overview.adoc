...
Apart from notifications and alerts, Functions provide an option to propagate data changes.
You can propagate data changes and move documents to a different bucket inside your Couchbase cluster.
Since Couchbase is a NoSQL document-oriented data platform, Functions provide an easy option to perform cascade deletes.
