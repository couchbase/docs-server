...
* Integrate with external REST endpoints via cURL functionality.
...
The use of (https://docs.couchbase.com/server/current/learn/services-and-indexes/services/services.html)[MDS services] in Couchbase enables workload isolation and independent scalability of any service in a Couchbase cluster. 
