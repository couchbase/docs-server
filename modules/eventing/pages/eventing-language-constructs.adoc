...
The following advanced bucket accessors have been added to expose a richer set of options and operators.  Unlike the basic bucket acessors these operations have non-trivial argument sets and return values for complete details refer to xref:eventing-advanced-bucket-accessors.adoc[Advanced Bucket Accessors Details].
...
xref:eventing-advanced-bucket-accessors.adoc#advanced_get_op[(full details)].
...
xref:eventing-advanced-bucket-accessors.adoc#advanced_insert_op[(full details)].
...
xref:eventing-advanced-bucket-accessors.adoc#advanced_upsert_op[(full details)].
...
xref:eventing-advanced-bucket-accessors.adoc#advanced_replace_op[(full details)].
...
xref:eventing-advanced-bucket-accessors.adoc#advanced_delete_op[(full details)].
...
xref:eventing-advanced-bucket-accessors.adoc#advanced_increment_op[(full details)].
...
xref:eventing-advanced-bucket-accessors.adoc#advanced_decrement_op[(full details)].
The document must have the below structure:
+
[source,javascript]
----
