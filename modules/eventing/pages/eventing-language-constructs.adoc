...
Note, if the bucket binding has a wild card of `+++*+++` for the scope and/or the collection you must also provide meta.keyspace in addition to meta.id in the meta object.
