...
For more informaton see xref:eventing-advanced-bucket-accessors.adoc#advanced_get_op[advanced GET operation].
...
For more informaton see xref:eventing-advanced-bucket-accessors.adoc#advanced_insert_op[advanced INSERT operation].
...
For more informaton see xref:eventing-advanced-bucket-accessors.adoc#advanced_upsert_op[advanced UPSERT operation].
...
It also allows specifying an expiration time (or TTL) to be set on the document. 
For more informaton see xref:eventing-advanced-bucket-accessors.adoc#advanced_replace_op[advanced REPLACE operation].
...
For more informaton see xref:eventing-advanced-bucket-accessors.adoc#advanced_delete_op[advanced DELETE operation].
...
For more informaton see xref:eventing-advanced-bucket-accessors.adoc#advanced_increment_op[advanced INCREMENT operation].
+
...
For more informaton see xref:eventing-advanced-bucket-accessors.adoc#advanced_decrement_op[advanced DECREMENT operation].
+
The document must have the below structure:
+
[source,javascript]
