 ...
 *** For the binding, select "bucket alias", specify *src_user* as the "alias name" of the bucket, and select *users* as the associated bucket, and select "read only".  *Note we will not be using this binding as we have no need of it beacuse we will use N1QL.*
...
----
+
After exeuting the above N1QL statement you should see a table of 'user' data as follows:
+
...
----
+
After exeuting the above N1QL statement you should see a table of 'transaction' data as follows:
+
...
----
+
After exeuting the above N1QL statement you should see a table showing counts as follows:
+
...
----
+
After exeuting the above N1QL statement you should see only one 'transaction' item follows:
+
