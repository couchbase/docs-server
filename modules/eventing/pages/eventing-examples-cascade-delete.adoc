...
. Access the *Couchbase Web Console* > *Query* and rerun your compund query as above. 
...
. Access the *Couchbase Web Console* > *Query* and run the following N1QL statments
