...
NOTE: Couchbase Server doesn't permit a rebalancing operation when a Function lifecycle operation is in progress. Deploy,
undeploy and delete are the usual Function lifecycle operations. Similarly, when a rebalancing operation is in +
progress, you are not allowed to perform a Function lifecycle operation.
--
