...
Any user Administrator or non-Administrator can read the configuration.
|
2+a|
Sample API:
...
[source,console]
----
curl -XGET http://anyAuthedUser:password@192.168.1.5:8096/api/v1/config
----
...
Only users with Administrator roles can alter the configuration.
|
2+a|
