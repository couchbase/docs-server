...
* The timer context size can be increased globally via the REST API through version 6.6.1. Starting with 6.6.2 timer context size may on a per Function handler basis in the Function's settings. [.status]#Couchbase Server 6.6.2#
