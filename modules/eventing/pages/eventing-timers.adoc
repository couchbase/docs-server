...
Couchbase scans for active timers every 7 seconds this creates a maximum delay of 7secs + the time it takes to process timers ahead of the given timer on a given thread.
