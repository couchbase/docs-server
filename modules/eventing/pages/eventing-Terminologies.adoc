...
Workers can be defined as an execution unit that is assigned a group of vBuckets. The worker units are used mostly during Eventing Function or handler execution.
