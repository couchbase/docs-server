...
As of version 6.6.2 meta also contains the property datatype (json or binary) because Eventing can now process binary documents which were previously suppressed. [.status]#Couchbase Server 6.6.2#
...
>>>>>>> 47fd8de5... Add new 6.6.2 capabilities, notations, and scriptlets (#1900)
