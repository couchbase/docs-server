...
The Function in its purest form offers a rule to implement logic closer to the data, but cannot trigger another Function directly.
...
* When I undeploy all handlers the metadata bucket is not fully cleared (this is a regression in 6.6.1 only).
+
