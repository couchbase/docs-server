...
+
No this is not supported in 6.5, however this will be supported in 6.6.0 - refer to xref:eventing-timers.adoc#limitations[Timers: Limitations].

* Can I create a Recurring timer?
+
No this is not supported in 6.5, however this will be supported in 6.6.0 -  xref:eventing-timers.adoc#limitations[Timers: Limitations].

* Can I schedule Timer far into the future
+
Yes, however there is an issue limited to 6.5.X where there can be an adverse performance impact (fixed in 6.6.0) on an otherwise idle Eventing system refer to xref:eventing-timers.adoc#limitations[Timers: Limitations].
