...
+
image::debug_websocket_disconnected.png[,50%]
...
=== The Debugging Window (or Tab) in Chrome borwser.

. Once the pasted URL is processed by Chrome the resulting debugger window will look somthing like the following:
+
