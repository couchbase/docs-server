...
+
This simple example here only has a log(....) statement in the *OnUpdate* handler that will merely list items in the bucket 'beer-sample', e.g. 7,303 documents. Basically only thing the function does is print the key or ID of each document.
