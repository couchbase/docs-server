...
handler's functionality operations across its typical lifecyle (for a deeper insight refer to the more detailed xref:eventing-examples.adoc[Eventing Examples])
