...
The following Scriptlets demonstrate using N1QL within an Eventing handlr.

[cols="1,1,1"]
|=== 
| xref:eventing-handler-basicN1qlSelectStmt.adoc[N1qlSelectStmt]
| xref:eventing-handler-basicN1qlPreparedSelectStmt.adoc[N1qlPreparedSelectStmt]
|
|===
