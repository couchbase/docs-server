...
*Binary Document Support*: The following Scriptlets demonstrate support for binary documents in Eventing. [.status]#Couchbase Server 6.6.2# 

[cols="1,1,1"]
|=== 
| xref:eventing:eventing-handler-testBinaryVsJSON.adoc[testBinaryVsJSON]
|
|
|===
