...
These tuturial like guides are ideal for a novice to learn the basics of Eventing via complete start to finish instructions.
+
[cols="1,1,1"]
|=== 
...
** Trivial _Scriptlet (Handler Only) Examples_ 

The following introduce more use cases but assume the reader has a good understanding of the Eventing System and requires little guidance.
+
[cols="1,1,1"]
|=== 
...
The following introduce more use cases where documents are modified without knowlege of the document's schema.
+
[cols="1,1,1"]
|=== 
