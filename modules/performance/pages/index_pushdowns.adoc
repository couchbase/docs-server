...
This is explained with an example in the following section <<composite-predicate-with-range-scan-on-prefix-index-keys, Composite predicate with range-scan on prefix index-keys>>.
