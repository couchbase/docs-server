...
Using JSON provides a flexible data mode, and xref:n1ql:n1ql-language-reference/index.adoc[N1QL supports enhanced SQL for JSON] to make query processing easier.
...
image::n1ql/n1ql-language-reference/query_execution.png[]
