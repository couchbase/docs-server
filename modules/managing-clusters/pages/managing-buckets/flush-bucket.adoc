...
xref:managing-clusters/create-bucket.adoc[Create a Bucket]
...
image::managing-buckets/flushOptionEnabled.png[,350,align=left]
...
[#flush_bucket_button]
image::managing-buckets/flushBucketButton.png[,350,align=left]
