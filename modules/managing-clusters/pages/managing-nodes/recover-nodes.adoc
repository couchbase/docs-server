...
xref:managing-clusters:managing-nodes/failover-graceful.adoc#graceful-failover-with-the-cli[Graceful
...
Perform graceful failover as documented in
xref:managing-clusters:managing-nodes/failover-graceful.adoc#graceful-failover-with-the-rest-api[Graceful
