...
(see
xref:managing-clusters:managing-nodes/initialize-node.adoc#initialize-node-with-the-cllii[Initialize
a Node with the CLI].)
...
(see
xref:managing-clusters:managing-nodes/initialize-node.adoc#initialize-node-with-the-rest-api[Initialize
