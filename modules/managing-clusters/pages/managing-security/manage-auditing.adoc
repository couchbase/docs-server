...
[#audit-tab]
image::managing-security/auditTab.png[,140,align=left]

This brings up the [.ui]*Audit* view:

[#audit-view]
image::managing-security/auditView.png[,820,align=left]

To enable auditing, check the [.ui]*Audit events & write them to a log* checkbox:

[#enable-auditing]
image::managing-security/enableAuditing.png[,480,align=left]
...
image::managing-security/setRotationTimeInterval.png[,290,align=left]
...
image::managing-security/eventFilteringUIdataServiceInitial.png[,720,align=left]
...
image::managing-security/eventFilteringToggle.png[,160,align=left]

The panel now appears as follows:

[#eventFilteringUIdataServiceEnabled]
image::managing-security/eventFilteringUIdataServiceEnabled.png[,720,align=left]
...
(See
xref:understanding-couchbase:security/authentication-overview.adoc[Authentication], for information on authentication domains.) Left-click on the *Save* button, to save the list of users.
