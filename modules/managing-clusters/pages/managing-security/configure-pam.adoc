...
image::managing-security/securityViewInitial.png[,820]
...
image::managing-security/manageUserNewSubsequent2.png[,310]
+
...
+
[#couchbase_login]
image::managing-security/couchbaseLogin.png[,360]
+
