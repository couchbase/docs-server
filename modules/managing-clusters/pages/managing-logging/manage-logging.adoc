...
[#welcome]
image::managing-logging/loggingScreenBasic.png[,720,align=left]
...
[#collect_info]
image::managing-logging/collectInfo.png[,248,align=left]

This brings up the *Collect Information* screen:

[#collect_info_screen]
image::managing-logging/collectInformationScreen.png[,720,align=left]
...
xref:manage-logging.adoc#applying_redaction[Applying Redaction], below).
...
xref:manage-logging.adoc#uploading_log_files[Uploading Log Files], below.
...
image::managing-logging/collectInformationComplete.png[,720,align=left]
...
image::managing-logging/uploadToCouchbaseCheckbox.png[,218,align=left]

The display changes to the following:

[#upload_to_couchbase_dialog_basic]
image::managing-logging/uploadToCouchbaseDialogBasic.png[,302,align=left]
...
image::managing-logging/partialRedactionSelection.png[,682,align=left]
