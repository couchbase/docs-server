...
An explanation of _Server Group Awareness_, and the effect it has on the distribution of vBucket replicas throughout a cluster, is provided in xref:understanding-couchbase:clusters-and-availability/groups.adoc[Server Group Awareness].
...
[#groups_tab]
image::managing-groups/groupsTab.png[,72,align=left]

This brings up the *Server Groups* screen, which might initially appear as follows:

[#groups_server_groups_screen]
image::managing-groups/groupsServerGroupsScreen.png[,820,align=left]
...
image::managing-groups/groupsEditGroupNameTab.png[,140,align=left]

This brings up the *Edit Group Name* dialog:

[#groups_edit_group_name_dialog]
image::managing-groups/groupsEditGroupNameDialog.png[,260,align=left]
...
image::managing-groups/groupsAddGroupTab.png[,120,align=left]
+
This brings up the *Add Group* dialog:
+
[#groups_add_group_dialog]
image::managing-groups/groupsAddGroupDialog.png[,260,align=left]
...
image::managing-groups/groupsServerGroupsNewGroupAdded.png[,820,align=left]
...
image::managing-groups/groupsAccessMoveServerTab.png[,740,align=left]
+
...
image::managing-groups/groupsPendingMoveNotification.png[,740,align=left]
...
image::managing-groups/groupsResetAndApplyChangesButtons.png[,220,align=left]
...
image::managing-groups/groupsRebalanceFollowingMove.png[,820,align=left]
+
...
image::managing-groups/groupsScreenWithOpenGroup.png[,820,align=left]
...
image::managing-groups/groupsConfirmServerRemovalNotice.png[,340,align=left]
+
...
image::managing-groups/groupsRemovalPendingNotification.png[,740,align=left]
...
image::managing-groups/groupsRebalanceButton.png[,100,align=left]
+
At the conclusion of the rebalance, the server has been removed.
+
[#groups_following_server_removal]
image::managing-groups/groupsFollowingServerRemoval.png[,740,align=left]
+
...
+
[#groups_empty_group]
image::managing-groups/groupsEmptyGroup.png[,740,align=left]

. Left-click on the *delete group* tab:
+
[#groups_delete_group]
image::managing-groups/groupsDeleteGroup.png[,100,align=left]
+
A confirmation dialog now appears:
+
[#groups_delete_group_confirmation]
image::managing-groups/groupsDeleteGroupConfirmation.png[,260,align=left]
+
...
image::managing-groups/groupsSelectFromAddServerDialog.png[,340,align=left]
