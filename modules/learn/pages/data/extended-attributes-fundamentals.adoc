...
The Couchbase SDK supports applications' creation and modification of xref:3.3@java-sdk:concept-docs:xattr.adoc[extended attributes] (sometimes referred to as _XATTRs_).
