...
A collection can be indexed.
A collection can be flushed; and it can be dropped.
...
A scope cannot be flushed or indexed (these must occur individually for collections within the scope).
