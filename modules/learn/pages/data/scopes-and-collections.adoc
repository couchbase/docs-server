...
It can also be created and managed by means of the SDK &#8212; currently as a _Developer Preview_ feature: see xref:3.0@java-sdk:howtos:provisioning-cluster-resources.adoc#collection-management[Collection Management].
...
It is also possible to create, maintain, and delete scopes and collections using the N1QL query language.
