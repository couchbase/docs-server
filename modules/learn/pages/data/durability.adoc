...
If auto-failover is configured in this way:
...
* If data has been durably written to _two_ or _three_ nodes, only _one_ of the nodes (either the active or a replica) can be automatically failed over.
