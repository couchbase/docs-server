= Data
:page-aliases: understanding-couchbase:data/data,concepts:data-management,data-modeling:data-modeling-phases,architecture:data-service-core-data-access
...
For further information, see xref:java-sdk::subdocument-operations.adoc[Sub-Document Operations].
...
+
For information on _TTL_, see xref:java-sdk::core-operations.adoc[Core Operations].
