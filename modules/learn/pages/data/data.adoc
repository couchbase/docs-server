...
All items are handled by Couchbase Server's xref:learn:services-and-indexes/services/data-service.adoc[Data Service]; and must be encoded as specified in https://tools.ietf.org/html/rfc8259[RFC 8259^].
