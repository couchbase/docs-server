...
It also enables seemless integration betreen KV and xref:n1ql:n1ql-language-reference/begin-transaction.adoc#purpose[Query] operations within transactions.
...
// == Custom Metadata
include::java-sdk:current:howtos:distributed-acid-transactions-from-the-sdk.adoc[tag=custom-metadata]
