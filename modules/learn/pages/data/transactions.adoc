...
Up to 1024 of these can exist per bucket, covering all active transactions for the bucket.
(Note that each record can store information on multiple transactions, and that the number 1024 is _not_ a concurrency limit on active transactions.)
