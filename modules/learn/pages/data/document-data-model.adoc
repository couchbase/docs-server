...
:page-aliases: understanding-couchbase:data/document-data-model,data-modeling:data-modeling-phases,data-modeling:modeling-relationships,data-modeling:intro-data-modeling
