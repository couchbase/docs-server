...
:description: pass:q[The `_count` function provides a simple count of the input rows from the `map()` function, using the keys and group level.]
:page-aliases: views:views-writing-count,understanding-couchbase:views/views-writing-count
