...
:description: pass:q[The built-in `_sum` function sums the values from the `map()` function call by summing up the information in the value for each row.]
:page-aliases: views:views-writing-sum,understanding-couchbase:views/views-writing-sum
