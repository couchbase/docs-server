...
* Whereas `cbbackupmgr` allows backups, merges, and other related operations only to be executed in _one off_ fashion, the Backup Service provides automated, recurrent execution of such operations.
