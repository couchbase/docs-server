...
For information about using the Eventing Service, see xref:eventing:eventing-overview.adoc[Eventing Service: Fundamentals].

For information about adding or removing an Eventing Service on an existing node of a cluster, see xref:manage:manage-nodes/modify-services-and-rebalance.adoc[Modify Services and Rebalance].