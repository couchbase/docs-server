...
In Couchbase Server 6.6 and later, you can specify that any N1QL query should attempt to use a Full Text Search index, to take advantage of the Search Service's natural-language capabilities.
