= Query Service
:page-aliases: understanding-couchbase:services-and-indexes/services/query-service,architecture:querying-data-with-n1ql
...
For detailed information, see xref:n1ql:n1ql-language-reference/index.adoc[N1QL Lanaguage Reference].
