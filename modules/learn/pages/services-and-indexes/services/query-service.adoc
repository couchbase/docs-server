= Query Service
:page-aliases: understanding-couchbase:services-and-indexes/services/query-service,architecture:querying-data-with-n1ql,architecture:querying-data-and-query-data-service,n1ql:n1ql-intro/data-access-using-n1ql
