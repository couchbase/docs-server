...
In <<example-comp-explain>> above, the query has a composite predicate on continuous leading index-keys, i.e. the index-keys `distance` and `sourceairport`, which occur together the start of the index definition.
