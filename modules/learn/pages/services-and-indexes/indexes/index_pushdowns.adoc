...
#Both LIMIT and OFFSET may not be pushed to index in all cases.
For example, when pushing to the primary index, only LIMIT is pushed (see <<example-page-2>> below).
Observe that, in that case, LIMIT is pushed with the value of the sum of the limit and offset specified in the query.
This may not be as efficient because the Query engine will need to drop the first offset number of documents.#
...
====
When using a primary index, #only LIMIT is pushed#.
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-page-3.json[]
----
====
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-idx-1.json[]
----
====
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-idx-2.json[]
...
----
====
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-idx-3.json[]
----
====
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-max.json[]
----
====
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-min.json[]
----
====
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-count.json[]
----
====
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-distinct.json[]
----
====
