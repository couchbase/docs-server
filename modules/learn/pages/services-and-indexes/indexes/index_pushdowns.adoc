...
----
// ...
include::example$services-and-indexes/indexes/pushdown-comp-plan.json[tags=index;ellipsis;final]
// ...
----
====
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-page-3.json[tags=index;ellipsis;order]
// ...
----
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-idx-1.json[tags=index;ellipsis;query]
// ...
----
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-idx-2.json[tags=index;ellipsis;query]
// ...
----
...
[source,json]
----
include::example$services-and-indexes/indexes/pushdown-idx-3.json[tags=index;ellipsis;query]
// ...
----
====
