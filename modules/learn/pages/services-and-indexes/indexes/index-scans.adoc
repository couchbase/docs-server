= Scans
:description: During query execution, when the index path is chosen, the query engine requests the scan by providing a range of values to return.
...
Using JSON provides a flexible data model, and
