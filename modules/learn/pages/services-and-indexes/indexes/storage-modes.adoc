...
The selection items to be compressed occurs periodically, with the period-duration being shorter than that used for xref:learn:buckets-memory-and-storage/memory.adoc#ejection[Ejection].
