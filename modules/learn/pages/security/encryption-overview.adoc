...
These files you can encrypt include those that store database data, configuration, logs, and audits.
...
See xref:native-encryption-at-rest.adoc[] for more information.

Use third-party tools::
Third party tools can provide centralized encryption at rest. 
