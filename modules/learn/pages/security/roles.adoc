...
The *Sync Gateway Architect* role (which is a _Mobile_ role) allows management of Sync Gateway databases; and of Sync Gateway users, groups, and roles; and allows access to Sync Gateway's `/metrics` endpoint.
...
^| Collection: Sync Gateway Data
^| image:introduction/yes.png[]
^| image:introduction/yes.png[]
^| image:introduction/yes.png[]
^| image:introduction/yes.png[]

^| Collection: Sync Gateway Users, Groups, and Roles
^| image:introduction/yes.png[]
^| image:introduction/yes.png[]
^| image:introduction/yes.png[]
^| image:introduction/yes.png[]
...
The *Sync Gateway Application* role (which is a _Mobile_ role) allows management of Sync Gateway users, groups, and roles; and allows application data to be read and written through Sync Gateway.
The role does not allow access to Couchbase Web Console.
...
The *Sync Gateway Application Read Only* role (which is a _Mobile_ role) allows reading of Sync Gateway users, groups, and roles; and allows application data to be read through Sync Gateway.
The role does not allow access to Couchbase Web Console.
