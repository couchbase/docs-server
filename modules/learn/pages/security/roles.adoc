...
The *Local User Security Admin* role (an _Administration and Global_ role) allows the management of local user roles and the reading of all cluster statistics.
...
The *External User Security Admin* role (an _Administration and Global_ role) allows the management of local user roles and the reading of all cluster statistics.
...
The *External Stats Reader* role (an _Administration and Global_ role) allows access to the `/metrics` endpoint, for _Prometheus_ integration.
...
The *Manage Scope Functions* role allows N1QL functions to be managed for a given scope.
The user can access Couchbase Web Console, but cannot read data.
...
The *Execute Scope Functions* role allows N1QL functions to be executed for a given scope.
The user can access Couchbase Web Console, but cannot read data.
...
The *Manage Global External Functions* role allows global external language functions to be managed.
The user can access Couchbase Web Console, but cannot read data.
...
The *Execute Global External Functions* role allows global N1QL functions to be executed.
The user can access Couchbase Web Console, but cannot read data.
...
The *Manage Scope External Functions* role allows external language functions to be managed for a given scope.
The user can access Couchbase Web Console, but cannot read data.
...
The *Execute Scope External Functions* role allows external language functions to be executed for a given scope.
The user can access Couchbase Web Console, but cannot read data.
...
The *Manage Collections in Scope* role allows the creation and deletion of collections within a given scope.
The role allows full access to the data contained by the collections within the given scope &#8212; including reading and writing.
The role does not permit access to Couchbase Web Console.
