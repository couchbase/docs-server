...
The *Manage Collections in Scope* role (a _Bucket_ role) allows the creation and deletion of collections _per scope_, given the corresponding specification of _bucket_.
