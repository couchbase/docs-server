...
Even a certificate that has not expired can be untrustworthy: its private key may have been lost or stolen, or the person or system it identifies may no longer be entitled to access.
Couchbase Server can check certificates against Certificate Revocation Lists (CRLs) published by your certificate authorities, and refuse a certificate that has been revoked.
