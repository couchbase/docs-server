...
==== PKCS #12 Certificate Support for Nodes
...
* The PKCS #12 file must be named `couchbase.p12`.
...
In version 7.1 and later, Couchbase Server supports PKCS #1 and PKCS #8 file formats for private keys:
