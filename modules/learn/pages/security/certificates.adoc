...
The following options are available, for specifying the node-name as a SAN.
(Note that the wildcard character is permitted in all expressions.)

* _Fully Qualified Domain Name_ (FQDN). For example: `DNS:*.localhost.com`.

* _IPV4 IP Address_. For example: `IP Address:127.0.0.1`.

* _IPV6 IP Address_. For example: `IP Address:0:0:0:0:0:0:0:1`.
