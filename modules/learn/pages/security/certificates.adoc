...
Use of the _Subject Common Name_ to identify either a server or a client is now deprecated; meaning that server and client should each specify at least one _Subject Alternative Name_, in order to be identified.
