...
A _locally defined_ user can change their own password by means of the REST API: see xref:rest-api:rest-set-password.adoc[Change Password].
(For information on _local_ and _exernal_ domains, see xref:learn:security/authentication-domains.adoc[Authentication Domains].)
