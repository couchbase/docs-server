...
[abstract]
To access Couchbase Server, users must be authenticated: this can occur in either of two _domains_, which are respectively defined as _local_ and _external_.
