...
| Delete Design Doc | Design Doc is Deleted | Data
| Query DDoc Meta Data |Design Doc Meta Data Query Request | Data
| View Query | View Query Request | Data
| Update Design Doc | Design Doc is Updated | Data
| Audit Configuration Change | Change in Audit Configuration | Data
|===
