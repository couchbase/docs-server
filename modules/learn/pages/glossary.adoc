...
* xref:buckets-memory-and-storage/storage-settings.adoc[Storage]: The persistent retention of items on disk, in compressed form, with high-speed threaded access.
...
* xref:java-sdk:ref:glossary.adoc[Couchbase SDKs]
