...
Multiple instances of Couchbase Server can be combined into a single _cluster_: a _Cluster Manager_ program coordinates all node-activities, and provides a simple, cluster-wide interface to all clients.
