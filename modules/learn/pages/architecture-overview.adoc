...
* *Security*: Couchbase Server can be rendered highly secure, so as to preserve
the privacy and integrity of data, and account for access-attempts. The
security facilities provided cover areas including _Authentication_, _Authorization_, and
_Auditing_.
+
See
xref:learn:security/security-overview.adoc[Security] for information.
