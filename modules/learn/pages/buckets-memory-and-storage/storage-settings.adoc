...
See the xref:rest-api:rest-reader-writer-thread-config.adoc[] to learn how to use the `magma_flusher_thread_percentage` setting to increase the number of flusher threads.
