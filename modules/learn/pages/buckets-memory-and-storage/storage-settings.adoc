...
Note also that threads can also be configured for the _NonIO_ and _AuxIO_ thread pools:
...
Again, the maximum thread-allocation for each is _64_, the minimum _4_.
