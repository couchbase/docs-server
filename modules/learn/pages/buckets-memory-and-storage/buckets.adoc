...
See xref:learn:buckets-memory-and-storage/backend-storage.adoc[] for more information.

NOTE: The backend storage mechanism only applies to Couchbase buckets, not Ephemeral buckets.
