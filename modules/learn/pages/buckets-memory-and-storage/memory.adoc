...
For more information about buckets and bucket types, see xref:buckets-memory-and-storage/buckets.adoc[].
To learn how to change a bucket's ejection policy, see xref:manage:manage-buckets/change-ejection-policy.adoc[].
