...
If you notice that Magma's data compaction spikes CPU use, you can change the ratio of threads that compact data to the threads that flush data.
See xref:learn:buckets-memory-and-storage/storage-settings.adoc#magma-flushing-and-compaction-threads[Magma Flushing and Compaction Threads] for more information about these settings.

See xref:manage:manage-settings/general-settings.adoc#data-settings[Data Settings] To learn more about configuring thread settings for Magma buckets.
