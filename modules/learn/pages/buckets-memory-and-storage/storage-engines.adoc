...
It has a minimum memory requirement of 100{nbsp}MB per node, and a recommended minimum memory-to-data ratio of 10%.
...
For more information about this setting, see xref:manage:manage-settings/general-settings.adoc#data-settings[Data Settings].
