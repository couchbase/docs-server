...
As described in the _Expiration Overview_ section of xref:2.7@java-sdk::core-operations.adoc#expiry[Core Operations], an expiration time can be specified per item, by means of Couchbase SDK APIs: this is referred to as the item’s TTL.
