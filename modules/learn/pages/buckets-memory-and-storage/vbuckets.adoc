= vBuckets
:description: vBuckets (sometimes referred to as shards) are virtual buckets that distribute data across a cluster and support replication. Learn more with Couchbase.
