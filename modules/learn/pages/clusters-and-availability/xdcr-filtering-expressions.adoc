...
[abstract]
_XDCR filtering expressions_ allow individual documents to be included in or excluded from a filtered replication, based on the documents' fields and values.
