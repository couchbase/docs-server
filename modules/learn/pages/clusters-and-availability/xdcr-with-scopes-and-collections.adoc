...
Note that whereas replication based on _implicit_ mapping is available in both Couchbase Server Enterprise and Community Edition, replication based on _explicit_ mapping is available only in Couchbase Server Enterprise Edition.
