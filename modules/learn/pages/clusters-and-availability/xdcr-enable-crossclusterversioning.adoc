...
:page-aliases: learn:clusters-and-availability/xdcr-conflict-resolution.adoc
...
[#update-enablecrossclusterversioning]
== Update the bucket property enableCrossClusterVersioning

You can change the bucket property `enableCrossClusterVersioning` through REST API or from UI.

[#update-enablecrossclusterversioning-through-api]
=== Update enableCrossClusterVersioning through REST API



[#update-enablecrossclusterversioning-from-ui]
=== Update enableCrossClusterVersioning from UI
