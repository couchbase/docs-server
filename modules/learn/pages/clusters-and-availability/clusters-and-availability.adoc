...
xref:buckets-memory-and-storage/vbuckets.adoc)[vBuckets] and their replicas are redistributed across available nodes whenever a change of configuration is detected.
