...
In Couchbase Server 7.0+, metadata is managed by a _consensus protocol_; which achieves strong consistency by _synchronously_ replicating configuration to a majority of the nodes before considering it committed.
