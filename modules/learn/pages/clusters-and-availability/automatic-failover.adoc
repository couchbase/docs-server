= Automatic Failover
:description: One or more nodes can be failed over automatically when they become unresponsive or experience continous disk access problems. This is done as long as data safety is maintained;i.e. no data loss occurs as a result of failover.
