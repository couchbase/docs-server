...
To ensure cluster-security, in Couchbase Server Version 7.1.2+, restrictions can be placed on addition and joining, based on the establishment of _node-naming conventions_.
