...
In 7.0.2+, this remains the default way of creating new partitions during rebalance.
...
This is an Enterprise-only feature, and requires all Search-Service nodes to be running 7.0.2+.
...
The file-transfer feature can be enabled and disabled by means of the 7.0.2+ REST API.
