...
Couchbase Server either rebuilds indexes (using DCP-based method) in their new locations or moves index files between nodes (File-Based Rebalance) during a rebalance,
