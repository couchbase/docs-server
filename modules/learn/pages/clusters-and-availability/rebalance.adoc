...
For information about the rebalance operation in Index Service, see xref:learn:clusters-and-availability/rebalance-and-index-service.adoc[Rebalance and Index Service].
