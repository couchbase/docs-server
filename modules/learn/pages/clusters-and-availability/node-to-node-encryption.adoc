...
To enable or disable cluster encryption, or to determine the current setting, use the xref:cli:cbcli/node-to-node-encryption.adoc[node-to-node-encryption] CLI command.
...
. Use xref:cli:cbcli/node-to-node-encryption.adoc[node-to-node-encryption], to disable node-to-node encryption.
...
. Re-enable node-to-node encryption, using xref:cli:cbcli/node-to-node-encryption.adoc[node-to-node-encryption], and establish the appropriate level of encryption.
