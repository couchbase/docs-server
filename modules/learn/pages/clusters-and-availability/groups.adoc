...
* With Couchbase Web Console, see the information provided for the *Node Availability* settings panel, in xref:manage:manage-settings/change-failover-settings.adoc[Node Availability].
