...
You can find the following in the Conflict Record Document (CRD) of the conflict collection:
...
For more information about the Conflict Record Document, see xref:learn:clusters-and-availability/xdcr-conflict-logging-feature.adoc#conflict-record[Conflict Record].

[#using-sdk-sqlpp-for-conflict-logs]
== Using {sqlpp} to Query Conflict Logs

The common way to view conflict logs or conflict record documents is by using {sqlpp}.
