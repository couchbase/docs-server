...
For information on setting the address family as part of a cluster's initial configuration, see xref:manage:manage-nodes/create-cluster.adoc[Create a Cluster].
