...
For example, it might be desirable to modify the replication shown above in Figure 2 &#8121; which searches for the string `air`, followed by the string `l` &#8121; without deleting and recreating the replication.
...
image::xdcr/filter-replication-diagram-5.png[,500,align=left]
...
image::xdcr/filter-replication-diagram-6.png[,500,align=left]
...
image::xdcr/filter-replication-diagram-7.png[,500,align=left]
