...
Note that the replication of _binary_ documents is optional.
For details, see xref:manage:manage-xdcr/filter-xdcr-replication.adoc#filtering-binary-documents[Filtering Binary Documents].
