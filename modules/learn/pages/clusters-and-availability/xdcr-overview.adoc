...
This is explained in detail in xref:data/expiration.adoc[Expiration].
For specific information on how TTL is affected by XDCR, see the section xref:data/expiration.adoc#bucket-expiration-and-xdcr[Bucket-Expiration and XDCR].
