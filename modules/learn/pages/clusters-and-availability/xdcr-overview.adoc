...
The password received by the destination cluster can be authenticated either locally or externally, as described in xref:learn:authentication-overview.adoc[Authentication].
