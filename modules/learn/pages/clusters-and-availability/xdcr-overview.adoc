...
The REST API's xref:rest-api:rest-xdcr-create-replication.adoc#filter-binary[filterBinary flag] flag can be used to specify whether binary documents should be replicated.
See the REST reference page xref:rest-api:rest-xdcr-create-replication.adoc[Creating a Replication].
