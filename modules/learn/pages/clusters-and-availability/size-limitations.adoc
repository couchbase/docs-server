...
These numbers are established by means of the REST API: see xref:rest-api:rest-manage-cluster-connections.adoc[Manage Cluster Connections], for information.
|===
