...
| Max value size
| 20 MB
| The maximum size of the document, which is typically in JSON format.
...
| 30,000
| Each Data Service node allows up to 30,000 concurrent key-value connections by default, to either or both user ports -- 11207 (SSL) and/or 11210 (plain).
