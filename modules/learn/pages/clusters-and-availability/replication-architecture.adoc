= Availability
:page-aliases: understanding-couchbase:clusters-and-availability/replication-architecture,architecture:architecture/high-availability-replication-architecture
