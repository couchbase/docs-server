...
Additionally, although designed principally to handle indexes in memory, Nitro also saves indexes to disk at regular intervals: this allows the Indexer to recover from a restart, without needing to rebuild indexes.
+
