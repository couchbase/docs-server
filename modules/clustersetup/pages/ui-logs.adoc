...
* xref:cli:cbcli/collect-logs-start.adoc#reference_xd5_mm5_ls[[.cmd]`collect-logs-start`]
* xref:cli:cbcli/collect-logs-stop.adoc#reference_cqx_4m5_ls[[.cmd]`collect-logs-stop`]
* xref:cli:cbcli/collect-logs-status.adoc#reference_ufl_rm5_ls[[.cmd]`collect-logs-status`]
