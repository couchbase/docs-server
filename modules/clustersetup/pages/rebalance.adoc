...
Usually Couchbase Server deployments have a single service deployed on each node, see xref:concepts:multidimensional-scaling.adoc[Multidimensional scaling].
