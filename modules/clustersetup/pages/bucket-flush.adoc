...
[abstract]
Full, Cluster, and Bucket Administrators can use the [.uicontrol]*Flush* option to start bucket flushing and delete every object in a bucket.
