...
It can be used on any Couchbase Cluster node, whatever its service-configuration.
For information, see xref:clustersetup:hard-failover.adoc[Using Hard Failover].
