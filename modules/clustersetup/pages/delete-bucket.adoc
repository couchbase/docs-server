...
To delete a bucket using the Couchbase Web Console: access the console, and left-click on the [.uicontrol]*Buckets* tab, in the vertical navigation-bar at the left-hand side.
...
If you elect to proceed, by left-clicking on the btn:[Delete Bucket] button, the bucket and all its data are deleted from the system; and the bucket is no longer represented within the [.uicontrol]*Buckets* screen of the Couchbase Web Console.
