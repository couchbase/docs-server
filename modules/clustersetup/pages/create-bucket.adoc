...
For information on the differences between these bucket-types, see xref:architecture:core-data-access-buckets.adoc#couchbase-bucket-types[Buckets].
...
The settings [.uicontrol]*Conflict Resolution*, and [.uicontrol]*Flush* are identical in functionality for both Ephemeral and Couchbase buckets.
