[#topic_sc2_crk_5s]
= Cluster Operations
:page-aliases: concepts:deployment-and-operations.adoc
...
| 1024 bytes
| The maximum length of a sub-document path that may be used in one of the xref:nodejs-sdk:common:subdocument-operations.adoc[sub-document] operations.
