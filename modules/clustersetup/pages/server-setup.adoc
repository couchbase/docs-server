...
| 1024 bytes
| The maximum length of a sub-document path that may be used in one of the xref:java-sdk::subdocument-operations.adoc[sub-document] operations.

| Sub-document path nesting level
| 32
| The maximum number of _levels_ a path may reference in xref:java-sdk::subdocument-operations.adoc[sub-document] operations.
|===
