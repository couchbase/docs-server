...
NOTE: To fully understand how failover works, see xref:concepts:distributed-data-management.adoc#concept_cz5_szf_vs[Distributed data management] and xref:concepts:multidimensional-scaling.adoc#concept_ckt_svy_zs[Multidimensional scaling]to learn how Couchbase partitions data and how database services are distributed across a Couchbase cluster.
