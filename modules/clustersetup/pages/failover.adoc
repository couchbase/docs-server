...
NOTE: To fully understand how failover works, see xref:concepts:distributed-data-management.adoc#concept_cz5_szf_vs[Distributed Data Management] to learn how Couchbase partitions data and how database services are distributed across a Couchbase cluster.
