...
image::architecture/server-cluster-single-node-type.png[,600]
...
Finally, Couchbase Server presents a built-in Web Console for monitoring and managing the entire cluster.
