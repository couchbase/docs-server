...
For a more thorough discussion of the CAP Theorem as it applies to Couchbase Server, see https://blog.couchbase.com/cap-theorem-and-couchbase-server-time-xdcr[^].
