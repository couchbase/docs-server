...
Once you've xref:install:install-intro.adoc#topic_edn_wtd_54[installed the server], you can start storing, retrieving, and querying documents with Couchbase.
