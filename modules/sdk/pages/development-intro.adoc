...
First, do an
xref:install-intro.adoc[Install], then
xref:manage:manage-buckets/create-bucket.adoc[Create a Bucket]. Next,
you can start storing, retrieving, and querying documents with Couchbase Server.
