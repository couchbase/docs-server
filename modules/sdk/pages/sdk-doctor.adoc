...
A full example can be found on our xref:3.2@java-sdk:howtos:troubleshooting-cloud-connections.adoc#validating-connectivity-with-sdk-doctor[Troubleshooting Cloud Connections] page.
