...
N1QL also provides two legacy syntaxes for nests.

* A _lookup nest_ uses a foreign key field on the left-hand side of the nest and the primary document key on the right-hand side of the nest.
For more information and examples, refer to xref:n1ql:n1ql-language-reference/nest.adoc#nest[Lookup NEST Clause].

* An _index join_ uses the primary document key on the left-hand side of the nest and a foreign key field on the right-hand side of the nest.
For more information and examples, refer to xref:n1ql:n1ql-language-reference/nest.adoc#section_rgr_rnx_1db[Index NEST Clause].
