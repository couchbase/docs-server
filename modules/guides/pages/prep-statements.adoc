...
The following example supplies positional parameter values, using the cbq shell.
...
The following example supplies named parameter values, using the cbq shell.
