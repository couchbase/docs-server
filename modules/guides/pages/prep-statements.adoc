...
[source,n1ql]
----
include::n1ql:example$utility/prepare-names.n1ql[tag=query]
----
...
[source,n1ql]
----
include::n1ql:example$utility/prepare-numbers.n1ql[tag=query]
----
...
[source,n1ql]
----
include::n1ql:example$utility/prepare-positions.n1ql[tag=query]
----
...
* If you are using the N1QL REST API, specify the parameters in the request body or the query URI, alongside the statement.
...
The following example supplies a single positional parameter, using the cbq shell.

[source,n1ql]
----
include::example$prepared/param-numbers.n1ql[]
----
...
The following example supplies a single named parameter, using the cbq shell.

[source,n1ql]
----
include::example$prepared/param-names.n1ql[]
----
...
[source,n1ql]
----
include::n1ql:example$utility/prepare-numbers.n1ql[tags=**]
----

.Result
[source,json]
----
include::n1ql:example$utility/prepare-numbers.jsonc[tag=extract]
----
...
[source,n1ql]
----
include::n1ql:example$utility/prepare-names.n1ql[tags=**]
----

.Result
[source,json]
----
include::n1ql:example$utility/prepare-names.jsonc[tag=extract]
----
...
Positional parameters are specified using an array of values.
...
Named parameters are specified using an object containing name / value properties.
...
* xref:n1ql:n1ql-rest-api/admin.adoc#_prepared_statements_resource[N1QL Admin REST API for Prepared Statements]
