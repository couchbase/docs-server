...
[source,csharp]
----
include::3.3@dotnet-sdk:hello-world:example$KvHelloWorldScoped.csx[tag=kv-get,indent=0]
----
...
[source,java]
----
include::3.3@java-sdk:hello-world:example$KvHelloWorldScoped.java[tag=kv-get,indent=0]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:hello-world:example$kv-hello-world-scoped.js[tag=kv-get,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-get,indent=0]
----
...
[source,csharp]
----
include::3.3@dotnet-sdk:hello-world:example$KvHelloWorldScoped.csx[tag=kv-get-with-opts,indent=0]
----
...
[source,java]
----
include::3.3@java-sdk:hello-world:example$KvHelloWorldScoped.java[tag=kv-get-with-opts,indent=0]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:hello-world:example$kv-hello-world-scoped.js[tag=kv-get-with-opts,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-get-with-opts,indent=0]
----
...
[source,csharp]
----
include::3.3@dotnet-sdk:hello-world:example$KvHelloWorldScoped.csx[tag=kv-get-subdoc,indent=0]
----
...
[source,java]
----
include::3.3@java-sdk:hello-world:example$KvHelloWorldScoped.java[tag=kv-get-subdoc,indent=0]
----
...
----
include::4.1@nodejs-sdk:hello-world:example$kv-hello-world-scoped.js[tag=kv-get-subdoc]
----
...
[source,python]
----
include::4.0@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-get-subdoc,indent=0]
----
