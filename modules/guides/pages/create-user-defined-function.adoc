...
* the xref:n1ql:n1ql-language-reference/createfunction.adoc[standard N1QL `CREATE FUNCTION` DDL], using the External Functions option to reference the Javascript function.
