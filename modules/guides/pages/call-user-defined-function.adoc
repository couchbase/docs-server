...
:description: Calling a User-Defined Function from N1QL statements. This can be done using the Query Workbench, the CBQ or the REST API.
:page-pagination: 
...
A User-Defined Function can be called like any other N1QL function using a suitable N1QL statement.
