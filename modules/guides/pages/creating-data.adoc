...
It is assumed that the file `hotel-123.json` already exists in the `tmp` directory:
...
It is assumed that the file `hotel-456.json` already exists in the `tmp` directory:
