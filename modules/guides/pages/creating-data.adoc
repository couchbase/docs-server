...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-insert,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-insert-with-opts,indent=0]
----
