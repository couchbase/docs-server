...
:github: Click the icon:github[] View button on any sample to see the code in context.
...
Using xref:tools:cbimport.adoc[cbimport] is straightforward.
...
The following example will import a local CSV file, generating IDs such as `airline_1234`.
...
. Set the `--field-separator` argument to `"\t"`.
...
The following example will import a local TSV file, generating IDs such as `airline_1234`.
...
The following example will import a local JSON file, generating IDs such as `airline_1234`.
...
The following example will import a local JSONL file, generating IDs such as `airline_1234`.
