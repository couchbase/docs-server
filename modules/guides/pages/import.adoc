...
[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=csv-tsv-import,indent=0]
----

[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=csvImport,indent=0]
----

[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=tsvImport,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=json-jsonl-import,indent=0]
----

[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=jsonImport,indent=0]
----

[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=jsonlImport,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=connect,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=key,indent=0]
----
[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=process,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=upsertDocument,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:howtos:example$import.py[tags=csvImportMulti,indent=0]
----
