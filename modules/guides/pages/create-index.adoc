...
[source,python]
----
include::python-sdk:hello-world:example$n1ql_hello_world.py[tag=primary,indent=0]
----
...
3. Specify the field or fields to index.
...
[source,python]
----
include::python-sdk:hello-world:example$n1ql_hello_world.py[tag=secondary,indent=0]
----
