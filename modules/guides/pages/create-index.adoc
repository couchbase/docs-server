...
[source,python]
----
include::python-sdk:devguide:example$python/index_hello_world.py[tag=primary,indent=0]
----
...
[source,python]
----
include::python-sdk:devguide:example$python/index_hello_world.py[tag=named-primary,indent=0]
----
...
[source,python]
----
include::python-sdk:devguide:example$python/index_hello_world.py[tag=secondary,indent=0]
----
...
[source,python]
----
include::python-sdk:devguide:example$python/index_hello_world.py[tag=composite,indent=0]
----
