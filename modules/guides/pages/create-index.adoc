...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=primary,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=named-primary,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=secondary,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=composite,indent=0]
----
