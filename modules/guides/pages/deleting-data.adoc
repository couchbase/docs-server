...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-remove,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-remove-subdoc,indent=0]
----
