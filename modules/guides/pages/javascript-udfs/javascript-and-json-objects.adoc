...
include::partial$javascript-udfs/what-you-need.adoc[tags="json-setup"]
...
[source, json]
----
include::example$javascript-udfs/array.jsonc[]
----

.Code to generate array
[source, javascript]
----
include::example$javascript-udfs/array.js[]
----
...
[source, json]
----
include::example$javascript-udfs/key-value.jsonc[]
----
...
[source, javascript]
----
include::example$javascript-udfs/key-value.js[]
----
...
[source, javascript]
----
include::example$javascript-udfs/key-value-dates.js[]
----
<.> Use the `toJSON()` call on `Date` to create a string in ISO-8601 format.

[source, json]
----
include::example$javascript-udfs/key-values-dates.jsonc[]
----
