...
New libraries are created with a simple `add` example function to start with.

You can add your own function, such as the one given below, which will find the number of business days (weekdays) between two dates.
