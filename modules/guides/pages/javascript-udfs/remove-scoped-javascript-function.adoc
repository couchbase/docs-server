...
== Remove a Namespaced {sqlpp} Reference Function
...
+
--
To remove a {sqlpp} reference function, find it in the `User-Defined Functions` list:
...
[source, console]
----
include::example$javascript-udfs/drop-scoped-sqlpp-reference-function.sh[]
----
--
