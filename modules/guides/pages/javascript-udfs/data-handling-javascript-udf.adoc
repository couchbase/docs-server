...
If we look back at the `getBusinessDays` function:
...
[source, json]
----
include::example$javascript-udfs/true-response.json5[]
----
...
[source, json]
----
include::example$javascript-udfs/execute-airline-function-response.json5[]
----
...
[source, json]
----
include::example$javascript-udfs/add-airline-with-date-response.json5[]
----
...
[source, javascript]
----
include::example$javascript-udfs/no-parameter-expressions.js[]
----
