...
[source, javascript]
----
include::example$javascript-udfs/do-recursion.js[]
----

Executing the function throuwh the Query Workbench:
 
[source, n1ql]
----
include::example$javascript-udfs/execute-do-recursion.n1ql[]
----
...
----
include::example$javascript-udfs/do-recursion-response.json5[]
----
...
// TODO: Find out how the number of workers is decided
