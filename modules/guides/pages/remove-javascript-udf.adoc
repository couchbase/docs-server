...
== Remove a N1QL User-Defined Function
...
+
--
To remove a N1QL User-Defined Function, find it in the `User-Defined Functions` list:
...
+
--
To remove a N1QL User-Defined Function through the REST API, open a shell session and execute a CURL command to remove the function:

[source, console]
----
include::example$javascript-udfs/drop-scoped-n1ql-udf.sh[]
----
--
...
+
--
Execute a `DROP FUNCTION` instruction in the CBQ shell to delete the N1QL User-Defined Function.
--
====
