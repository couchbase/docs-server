...
[source,csharp]
----
include::3.3@dotnet-sdk:howtos:example$ManagingConnections.csx[tag=simpleconnect,indent=0]
----
...
[source,java]
----
include::3.3@java-sdk:howtos:example$ManagingConnections.java[tag=simpleconnect,indent=0]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:howtos:example$auth.js[tag=rbac-auth,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:howtos:example$managing_connections.py[tag=simpleconnect,indent=0]
----
...
[source,csharp]
----
include::3.3@dotnet-sdk:howtos:example$Auth.cs[tag=auth,indent=0]
----
...
[source,java]
----
include::3.3@java-sdk:howtos:example$Auth.java[tag=certauth,indent=0]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:howtos:example$auth.js[tag=tls-cacert,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:howtos:example$managing_connections.py[tag=tls,indent=0]
----
...
[source,csharp]
----
include::3.3@dotnet-sdk:devguide:example$dotnet/CloudConnect.cs[]
----
...
[source,java]
----
include::3.3@java-sdk:devguide:example$Cloud.java[]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:devguide:example$nodejs/cloud.js[tags=connect,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:hello-world:example$cloud.py[tags=connect]
----
