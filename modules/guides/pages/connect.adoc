...
To connect to the database via Couchbase Capella, ensure that you have set up some xref:cloud:get-started:cluster-and-data.adoc#credentials[credentials], including a xref:manage:manage-security/configure-client-certificates.adoc[client certificate].
