...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-update-upsert,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-update-replace,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_hello_world_scoped.py[tag=kv-update-subdoc,indent=0]
----
