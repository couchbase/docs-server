...
For more information about how to use an SDK with Couchbase transactions, see the <<related-links>> section.
...
NOTE: You must be using cbq shell version 2.0 or later to use the automatic transaction ID feature.

--
====

For more information about how to use each query tool with transactions, see xref:n1ql:n1ql-language-reference/transactions.adoc#query-tools[Query Tools].
...
For more information about the `BEGIN TRANSACTION` statement, see xref:n1ql:n1ql-language-reference/begin-transaction.adoc[BEGIN TRANSACTION].
...
NOTE: The only available transaction setting is "isolation level read committed."
...
For more information about the `SET TRANSACTION` statement, see xref:n1ql:n1ql-language-reference/set-transaction.adoc[SET TRANSACTION].
...
For more information about the `SAVEPOINT` statement, see xref:n1ql:n1ql-language-reference/savepoint.adoc[SAVEPOINT].
...
For more information about the `ROLLBACK TRANSACTION` statement, see xref:n1ql:n1ql-language-reference/rollback-transaction.adoc[ROLLBACK TRANSACTION].
...
For more information about the `COMMIT TRANSACTION` statement, see xref:n1ql:n1ql-language-reference/commit-transaction.adoc[COMMIT TRANSACTION].
