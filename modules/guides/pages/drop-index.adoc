...
[source,python]
----
include::python-sdk:devguide:example$python/index_hello_world.py[tag=drop-primary,indent=0]
----
...
[source,python]
----
include::python-sdk:devguide:example$python/index_hello_world.py[tag=drop-named-primary,indent=0]
----
...
[source,python]
----
include::python-sdk:devguide:example$python/index_hello_world.py[tag=drop-secondary,indent=0]
----
