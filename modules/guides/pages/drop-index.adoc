...
You can drop an _unnamed_ primary index using a N1QL statement or an SDK call.
You can also use an SDK call to drop a named primary index.
...
+
--
To drop a primary index, use the `dropPrimaryIndex` method.
...
[source,python]
----
include::python-sdk:hello-world:example$n1ql_hello_world.py[tag=drop-primary,indent=0]
----
...
You can drop a secondary index, or a _named_ primary index, using a N1QL statement.
You can also drop a secondary index using an SDK call.
...
+
--
To drop a named primary index or a secondary index, use the `DROP INDEX` statement.
...
[source,python]
----
include::python-sdk:hello-world:example$n1ql_hello_world.py[tag=drop-secondary,indent=0]
----
