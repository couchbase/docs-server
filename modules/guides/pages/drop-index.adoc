...
You can drop a primary index using a N1QL statement.
You can also drop a primary index using an SDK call.
...
You can drop a secondary index using a N1QL statement.
