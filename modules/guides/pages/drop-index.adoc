...
[source,csharp]
----
include::3.3@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=drop-primary,indent=0]
----
...
[source,csharp]
----
include::3.3@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=drop-named-primary,indent=0]
----
...
[source,java]
----
include::3.3@java-sdk:hello-world:example$IndexHelloWorld.java[tag=drop-primary,indent=0]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:hello-world:example$index-hello-world.js[tag=drop-primary,indent=0]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:hello-world:example$index-hello-world.js[tag=drop-named-primary,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:hello-world:example$index_hello_world.py[tag=drop-primary,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:hello-world:example$index_hello_world.py[tag=drop-named-primary,indent=0]
----
...
[source,csharp]
----
include::3.3@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=drop-secondary,indent=0]
----
...
[source,java]
----
include::3.3@java-sdk:hello-world:example$IndexHelloWorld.java[tag=drop-secondary,indent=0]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:hello-world:example$index-hello-world.js[tag=drop-secondary,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:hello-world:example$index_hello_world.py[tag=drop-secondary,indent=0]
----
