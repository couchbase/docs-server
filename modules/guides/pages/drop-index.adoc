...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=drop-primary,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=drop-named-primary,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=drop-secondary,indent=0]
----
