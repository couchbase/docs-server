...
[source,csharp]
----
include::3.2@dotnet-sdk:hello-world:example$StartUsing.cs[tag=n1ql-query,indent=0]
----
...
[source,java]
----
include::3.2@java-sdk:hello-world:example$StartUsing.java[tag=n1ql-query,indent=0]
----
...
[source,nodejs]
----
include::3.2@nodejs-sdk:hello-world:example$n1ql-hello-world.js[tag=n1ql-query,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:devguide:example$python/query_hello_world.py[tag=n1ql-query,indent=0]
----
