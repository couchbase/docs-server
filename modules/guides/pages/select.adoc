...
[source,csharp]
----
include::3.3@dotnet-sdk:hello-world:example$StartUsing.cs[tag=n1ql-query,indent=0]
----
...
[source,java]
----
include::3.3@java-sdk:hello-world:example$StartUsing.java[tag=n1ql-query,indent=0]
----
...
[source,nodejs]
----
include::4.1@nodejs-sdk:hello-world:example$n1ql-hello-world.js[tag=n1ql-query,indent=0]
----
...
[source,python]
----
include::4.0@python-sdk:hello-world:example$n1ql_hello_world.py[tag=n1ql-query,indent=0]
----
