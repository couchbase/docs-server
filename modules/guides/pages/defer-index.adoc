...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=defer-create-primary,indent=0]
----

[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=defer-create-secondary,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$index_hello_world.py[tag=defer-build,indent=0]
----
