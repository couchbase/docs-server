...
[source,csharp]
----
include::dotnet-sdk:hello-world:example$KvBulkHelloWorld.csx[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,java]
----
include::java-sdk:hello-world:example$KvBulkHelloWorld.java[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,csharp]
----
include::dotnet-sdk:hello-world:example$KvBulkHelloWorld.csx[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,java]
----
include::java-sdk:hello-world:example$KvBulkHelloWorld.java[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,java]
----
include::java-sdk:hello-world:example$KvBulkHelloWorld.java[tags=kv-users;kv-bulk-upsert,indent=0]
----
...
[source,csharp]
----
include::dotnet-sdk:hello-world:example$KvBulkHelloWorld.csx[tags=kv-users;kv-bulk-remove,indent=0]
----
...
[source,java]
----
include::java-sdk:hello-world:example$KvBulkHelloWorld.java[tags=kv-users;kv-bulk-remove,indent=0]
----
