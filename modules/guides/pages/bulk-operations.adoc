...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_bulk_hello_world.py[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_bulk_hello_world.py[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_bulk_hello_world.py[tags=kv-users;kv-bulk-upsert,indent=0]
----
...
[source,python]
----
include::3.2@python-sdk:hello-world:example$kv_bulk_hello_world.py[tags=kv-users;kv-bulk-remove,indent=0]
----
