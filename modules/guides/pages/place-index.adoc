...
:tabs:
:page-pagination:
:description: How to partition indexes, create index replicas, and place indexes on specified nodes.
...
In Enterprise Edition, you can create replicas of primary, secondary indexes, or secondary index partitions, to enhance index availability.
...
[source,N1QL]
----
include::example$n1ql-language-reference/create-idx-node.n1ql[]
----
====
