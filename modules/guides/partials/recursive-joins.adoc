...
For more information and examples, refer to xref:n1ql:n1ql-language-reference/join.adoc#section_nkd_3nx_1db[].
endif::[]

ifeval::["{clauses}" == "Nests and Unnests"]
For more information, refer to xref:n1ql:n1ql-language-reference/nest.adoc#from-term[] for NEST clauses, and xref:n1ql:n1ql-language-reference/unnest.adoc#from-term[] for UNNEST clauses.
endif::[]
