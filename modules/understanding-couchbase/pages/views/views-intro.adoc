[#topic2724]
= Views
:page-aliases: architecture:views-indexing-index-service.adoc, architecture:incremental-map-reduce-views.adoc, architecture:spatial-views.adoc, architecture:gsi-versus-views.adoc, architecture:querying-data-with-views.adoc, architecture:querying-geo-data-spatial-views.adoc
