 ...
 ** Access: The creation, update, and deletion of items, as supported by the xref:admin:ui-intro.adoc[Couchbase Web Console UI] and the xref:nodejs-sdk:common:development-intro.adoc[Couchbase SDK].
