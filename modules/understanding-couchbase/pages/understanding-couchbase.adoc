...
= Overview
:page-aliases: concepts:concepts-intro.adoc, architecture:architecture-intro.adoc, architecture:terminology.adoc
 ...
 ** xref:eventing:eventing-Introduction.adoc[Eventing]: Supports near real-time handling of changes to data: code can be executed both in response to document-mutations, and as scheduled by timers.
