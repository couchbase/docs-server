[#topic_tlg_jqz_bw2]
= Data
:page-aliases: data-access:data-access-intro.adoc
...
For further information, see xref:nodejs-sdk:common:subdocument-operations.adoc[Sub-Document Operations].
...
+
For information on _TTL_, see xref:nodejs-sdk:common:core-operations.adoc[Core Operations].
