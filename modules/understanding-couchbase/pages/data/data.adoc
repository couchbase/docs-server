...
For further information, see xref:2.7@java-sdk::subdocument-operations.adoc[Sub-Document Operations].
...
+
For information on _TTL_, see xref:2.7@java-sdk::core-operations.adoc[Core Operations].
