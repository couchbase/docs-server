...
| 8093, 18093 (SSL)
| Query with N1QL API
| Load-balanced connection across cluster-nodes running the xref:services-and-indexes/services/query-service.adoc[Query Service] for xref:java-sdk::common/n1ql-query.adoc[N1QL] queries.
...
For a complete list, see xref:install:install-ports.adoc#topic2659[Network and Firewall Requirements].
