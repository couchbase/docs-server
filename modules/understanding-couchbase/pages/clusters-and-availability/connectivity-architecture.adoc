[#concept_xh5_l3j_vs2]
= Connectivity
:page-aliases: architecture:connectivity-architecture.adoc
...
| 8093, 18093 (SSL)
| Query with N1QL API
| Load-balanced connection across cluster-nodes running the xref:services-and-indexes/services/query-service.adoc[Query Service] for xref:nodejs-sdk:common:n1ql-query.adoc[N1QL] queries.
