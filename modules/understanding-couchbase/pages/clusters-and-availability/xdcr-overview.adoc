...
xref:managing-clusters:managing-xdcr/create-xdcr-replication[Create a
Replication].
. Monitor the ongoing replication, pausing and resuming
the replication if and when appropriate. See
xref:managing-clusters:managing-xdcr/monitor-xdcr-replication.adoc[Monitor a
Replication],
...
xref:managing-clusters:managing-xdcr/xdcr-management-overview.adoc[XDCR
Management Overview].
...
xref:managing-clusters:managing-xdcr/recover-data-with-xdcr.adoc[Recover Data
with XDCR].
