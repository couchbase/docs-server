...
* Refer to section
xref:understanding-couchbase:services-and-indexes/indexes/index-scans.adoc[Scans] for more information.
...
See xref:understanding-couchbase:services-and-indexes/indexes/index-scans.adoc[Scans]
