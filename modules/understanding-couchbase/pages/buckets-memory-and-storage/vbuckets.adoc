[#topic_lzt_qr2_xs2]
= vBuckets
:page-aliases: architecture:core-data-access-vbuckets-bucket-partition.adoc
...
image::buckets-memory-and-storage/images/vbucketToNodeMapping.png[,820,align=left]
