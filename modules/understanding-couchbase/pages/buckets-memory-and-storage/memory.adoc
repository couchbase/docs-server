[#memory]
= Memory
:page-aliases: architecture:bloom-filters.adoc, architecture:managed-caching-layer-architecture.adoc
...
[#tunable_memory]
image::buckets-memory-and-storage/images/tunableMemory.png[,416]
