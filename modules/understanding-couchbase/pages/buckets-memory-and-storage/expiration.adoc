...
As described in the _Expiration Overview_ section of xref:nodejs-sdk:common:core-operations.adoc#expiry[Core Operations], an expiration time can be specified per item, by means of Couchbase SDK APIs: this is referred to as the item’s TTL.
