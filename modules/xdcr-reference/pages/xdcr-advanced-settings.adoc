...
Note that if the specified value is too high for the currently established number of xref:manage:manage-settings/general-settings.adoc#xdcr-maximum-processes[XDCR Maximum Processes], Couchbase Web Console displays a warning.
