...
For example, given the expression `variable > 4.5`, the constant `4.5` is determined to be a `Float`; and the value of `variable` is then attemptedly converted to `Float`.
