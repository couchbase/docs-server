...
The data types supported by XDCR Filtering are listed below, in descending order of _precedence_ &#8212; the lowest position therefore indicating the highest precedence.
...
| The comparison `"true" > "false"` returns `true`.
