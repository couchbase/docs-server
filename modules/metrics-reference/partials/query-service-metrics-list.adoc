...
*Description*: Number of {sqlpp} errors returned per second.
...
*Description*: Number of {sqlpp} requests processed per second.
...
*Description*: Number of {sqlpp} selects processed per second.
...
*Description*: Number of {sqlpp} warnings returned per second.
