...
Each longitude-latitude coordinate can be specified by means of any of the following.

=== Key-Value Pairs

An individual longitude-latitude coordinate can be specified by means of an object containing two key-value pairs.
...
Where multiple coordinates are required, for the specifying of a polygon, an array of such key-value pairs can be specified, as follows:
...
An individual longitude-latitude coordinate can be specified as an array of two floating-point numbers &#8212; the first signifying longitude, the second latitude.
For example, the top-left corner of a rectangle can be specified as follows:

[source,javascript]
----
"top-left": [ -2.235143, 53.482358 ]
----
...
A longitude-latitude coordinate can be specified by means of a single https://en.wikipedia.org/wiki/Geohash[Geohash] encoding.
For example, the bottom-right corner of a rectangle can be specified as follows:

[source,javascript]
----
"bottom-right": "gcw2m0hmm6hs"
----
...
The `top-left` of the rectangle is expressed by means of an array of floating-point numbers; specifying a longitude of `-2.235143` and a latitude of `53.482358`.
