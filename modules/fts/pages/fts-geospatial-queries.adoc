...
Each latitude-longitude coordinate can be specified by means of any of the following.

[#two-key-value-pairs]
=== Two Key-Value Pairs

An individual latitude-longitude coordinate can be specified by means of an object containing two key-value pairs.
...
An individual latitude-longitude coordinate can be specified as an array of two floating-point numbers &#8212; the first signifying longitude, the second latitude.
