...
[source,shell]
----
curl -XGET -H "Content-Type: application/json" -uAdministrator:asdasd 'http://localhost:8094/api/query/index/<indexName>?longerThan=1ms
----
...
[source,shell]
----
curl -XGET -H "Content-Type: application/json" -uAdministrator:asdasd 'http://localhost:8094/api/query?longerThan=10s'
----
