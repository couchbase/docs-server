...
You can control the sort behavior for missing attributes using the `missing` field in the _advanced sort_ syntax.
See xref:fts:fts-sorting.adoc#fts-advanced-sort-options[Sorting with Objects].
