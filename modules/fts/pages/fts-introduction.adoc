...
The irrelevant characters (such as punctuation marks or html tags)can be excluded from both input and target text-values.
...
To conclude, the coordinating node waits for responses from,
