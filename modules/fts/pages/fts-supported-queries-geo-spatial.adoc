...
If you copy and then run the above cURL command via the console the response form the Search service will report that there are 847 total_hits but only return the first 10 hits.  A subset of formatted console output might appear as follows:
