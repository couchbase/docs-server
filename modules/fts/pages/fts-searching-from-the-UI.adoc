...
If you don't have a Search index one you could create one one against `travel-sample` as follows:
...
** Creating a Dynamic Index xref:fts-creating-index-from-UI-classic-editor-dynamic.adoc[via the UI] or xref:fts-creating-index-from-UI-RST-dynamic.adoc[via the REST API].

** Creating a Geopoint Index xref:fts-creating-index-from-UI-classic-editor-geopoint.adoc[via the UI] or xref:fts-creating-index-from-UI-REST-geopoint.adoc[via the REST API].
