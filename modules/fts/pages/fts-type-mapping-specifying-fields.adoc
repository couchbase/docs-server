...
image::fts-type-mappings-ui-fields-buttons.png[,300,align=left]

Left-clicking on the edit button displays the following interface:

image::fts-type-mappings-ui-edit.png[,300,align=left]
...
image::fts-type-mappings-ui-field-options.png[,300,align=left]
