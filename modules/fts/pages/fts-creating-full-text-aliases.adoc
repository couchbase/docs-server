...
:description: Full Text Alias is the name that can be used in place of the actual full text index name.

[abstract]
{description} You can perform the searches across multiple buckets and multiple scopes by means of index aliases.
