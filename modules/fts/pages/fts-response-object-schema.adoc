...
When you query an xref:fts-index-alias.adoc[index alias], `total` is the sum of all the pindexes in each index that is included in the definition of the index alias.
