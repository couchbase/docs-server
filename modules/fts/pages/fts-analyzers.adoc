...
image::fts-custom-analyzer-dialog-initial.png[,700,align=left]
...
image::fts-analyzers-panel-select-char-filter.png[,700,align=left]
...
image::fts-add-tokenizer-pulldown.png[,700,align=left]
...
image::fts-analyzers-panel-select-token-filter.png[,700,align=left]
