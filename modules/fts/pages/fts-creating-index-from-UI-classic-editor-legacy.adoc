...
The example xref:fts-creating-index-from-UI-classic-editor-advanced.adoc#main[Creating an Advanced Index] example starts to introduce advanced feature for optimizing and using a fopcused Search index. 
