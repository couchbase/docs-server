...
The example xref:fts-creating-index-from-UI-classic-editor-advanced.adoc#main[Creating an Advanced Index] example starts to introduce advanced feature for optimizing and using a focused Search index. 
...
This section describes creating and Index on a bucket's *_default* scope/collection.  This collection is used when upgrading form Buckets to Collection in later versino of Couchbase.
