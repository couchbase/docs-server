...
The example xref:fts-creating-index-from-UI-classic-editor-onefield.adoc#main[Creating an One Field Index] example starts to introduce advanced feature for optimizing and using a focused Search index. 
