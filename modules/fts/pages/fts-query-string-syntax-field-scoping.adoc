...
Note, the above syntax is a simple and easy way to create https://docs.couchbase.com/server/current/fts/fts-supported-queries-compound-query.adoc[Compound Queries] in Search.
