...
== Selecting Scope/Collections
The _non-default scope/collection(s)_ option allows you to select a scope that adds the scope with its corresponding collections in the index.
For more information, see xref:introduction:whats-new.adoc[Scopes and Collections].

[#fts_select_scope_collections_ui]
