...
This example quickly creates the same index as xref:fts-creating-index-from-REST-geojson.adoc#main[Creating a GeoJSON Index via the REST API].  Note it hase the two (2) additional child field definitins to allow keyword sorting.  
