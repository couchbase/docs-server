...
_Geospatial_ geojson queries both search with and GeoJSON and return higher dimensional spatial structures.

A _geospatial geojson query_ specifies an area and returns each document that contains a reference to a location within the area.
