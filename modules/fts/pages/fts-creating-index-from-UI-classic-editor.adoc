...
Select this checkbox *[ ] Use non-default scope/collections* if you want the index to stream data from a non-default scope and/or non-default collection(s) on the source bucket.  For this example leave it unchecked.
