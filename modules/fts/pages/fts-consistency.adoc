...
The consistency mechanism provides xref:#consistency-vectors[Consistency] as objects in the search query that ensures FTS index searches all your last data written to the vBucket. 
