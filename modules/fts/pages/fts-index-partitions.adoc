= Index Partitioning
:description: pass:q[_Index Partitioning_ increases query performance by dividing and spreading a large index of documents across multiple nodes.]

{description} This feature is available only in Couchbase Server Enterprise Edition.
