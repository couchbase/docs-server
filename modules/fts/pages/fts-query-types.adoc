...
----
+
__Fuzziness__s is  demonstrated by means of the Java SDK, in the context of the _term query_ (see below), in xref:sdk:java/full-text-searching-with-sdk.adoc[Searching with the SDK].
