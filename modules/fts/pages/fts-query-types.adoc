...
----
+
A match query is also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
A match phrase query is also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
__Fuzziness__s is  demonstrated by means of the Java SDK, in the context of the _term query_ (see below), in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
A regexp query is also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
A wildcard query is also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
A conjunction query is also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
A disjunction query is also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
A doc ID Query is demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
A numeric range Query is also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
A query string Query is demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
+
A numeric range query is demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
Term queries are also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
----
+
A phrase query is also demonstrated by means of the Java SDK, in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
