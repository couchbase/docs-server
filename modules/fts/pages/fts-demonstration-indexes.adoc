...
An extensive code-example, which uses the Couchbase Java SDK, is provided in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
...
Optionally, the indexes can each be set up by means of the Couchbase Web Console, based on the descriptions provided in xref:2.5@java-sdk::full-text-searching-with-sdk.adoc[Searching with the SDK].
