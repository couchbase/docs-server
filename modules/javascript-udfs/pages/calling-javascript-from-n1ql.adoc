...
:description: Using a N1QL User-Defined Function to call JavaScript functions.
...
Before you can call a JavaScript function, you must first create a N1QL User-Defined Function to reference the JavaScript function.
...
If you are unfamiliar with the creating User-Defined Functions to call JavaScript, then the xref:guides:javascript-udfs.adoc[guide] is the best place to start.
...
You can define a N1QL User-Defined Function with a variadic parameter, which means that the parameter will accept a list of values which it will pass to the JavaScript function it references.
