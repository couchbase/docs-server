...
The process to do this is explained in the  xref:guides:creating-javascript-library.adoc#creating-the-n1ql-udf-function[Creating the N1QL User-Defined Function] section of our xref:guides:javascript-udfs.adoc[] guide.
...
And the corresponding N1QL User-Defined Function can be created through the xref:guides:creating-javascript-library.adoc#creating-the-n1ql-udf-function[Query Workbench] or by executing a N1QL statement:
