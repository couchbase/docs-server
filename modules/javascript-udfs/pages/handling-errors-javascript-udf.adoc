...
[source, javascript]
----
include::example$add-airline-with-check.js[]
----
...
[source, json]
----
include::example$add-airline-with-check-failure-response.json5[]
----

Unfortunately, this doesn't tell use very much about what caused the error, or indeed, the possibility of taking an alternative course of action depending on the type of error encountered. 
