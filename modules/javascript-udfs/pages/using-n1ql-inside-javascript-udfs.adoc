= Embedding N1QL in JavaScript UDFs
:description: Embedding N1QL inside JavaScript User-Defined Functions.
:page-pagination: 
...
Couchbase makes use of the standard JavaScript model for creating and extracting data using the JSON data format, which is detailed here: https://www.w3schools.com/js/js_json.asp[JavaScript JSON^]


Looking at a basic example that returns a number:
...
[source, n1ql]
----
include::example$execute-get-business-days.n1ql[]
----
...
[source, json]
----
include::example$execute-get-business-days-response.jsonc[]
----
...
[source, N1QL]
----
include::example$select-true-get-business-days.n1ql[]
----
...
[source, json]
----
include::example$true-response.jsonc[]
----
...
In order to do this, use a field alias in your N1QL statement:
...
[source, json]
----
include::example$true-alias-response.jsonc[]
----
== Transforming data in a Javascript UDF

If you're using a user-defined function, then the chances are that you want to perform some kind of transformation on the data received back from an embedded N1QL call, then returning the transformed from your Javascript function:

include::partial$diagrams.adoc[tags="data-transformation"]
...
[source, javascript]
----
include::example$select-airline-n1ql.js[]
----
====
<.> Using the `AS` clause in the N1QL statement renames the specified fields extracted from the collection. 
...
[source, N1QL]
----
include::example$execute-airline-function.n1ql[]
----
...
[source, json]
----
include::example$execute-airline-function-response.jsonc[]
----
...
[source,javascript]
----
include::example$add-airline-with-date-inline.js[]
----
...
[source,javascript]
----
include::example$add-airline-with-date-n1ql.js[]
----
====
...
<.> The ISO-8601 data string is used in the embedded N1QL call to supply the ISO-8601 date.

The record added to the bucket will look something like this:

[source, json]
----
include::example$add-airline-with-date-response.jsonc[]
----
