...
It is often the case that Javascript UDF will call an {sqlpp} statement that may itself call another Javascript UDF. 
...
include::guides:partial$javascript-udfs/further-reading.adoc[tags="query-workbench;select;execute-function;transactions;rbac"]
