...
For a complete account of the roles you can allocate and their significance, see xref:concepts-rbac.adoc[RBAC for Administrators] and xref:concepts-rbac-for-apps.adoc[RBAC for Applications].
