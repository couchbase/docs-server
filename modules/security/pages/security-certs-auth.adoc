...
You can enable certificate based authentication on the server using Couchbase Web Console, the REST API, or CLI.
...
See the information provided in xref:security:security-comm-encryption.adoc#handling-client-certificates[Handling Client Certificates].
