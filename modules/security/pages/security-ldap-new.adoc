...
To configure LDAP administrators using the Couchbase Web Console, see  xref:security-ldap-gui-new.adoc#topic_omm_dxq_wq[External Roles].
...
To configure LDAP using the Couchbase Web Console, see xref:security-ldap-gui-new.adoc#topic_omm_dxq_wq[External Roles].
