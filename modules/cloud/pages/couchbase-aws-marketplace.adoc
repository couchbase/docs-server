...
Select the [.in]`Amazon S3 template URL` and then click [.uicontrol]*Next*.image:aws/deploying/aws-marketplace-couchbase-ee-create-stack-select-template.png[,570]
