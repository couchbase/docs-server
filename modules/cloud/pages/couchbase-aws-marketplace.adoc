...
Alternately, you can click https://aws.amazon.com/marketplace/server/pp/prodview-zw6dtnc7i75ai[here^] to go to the Couchbase Enterprise Edition product page directly.
