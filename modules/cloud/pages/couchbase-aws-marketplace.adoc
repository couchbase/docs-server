...
Click [.ui]*Continue to Subscribe*.image:aws/deploying/aws-marketplace-couchbase-ee.png[,570]
...
Select the [.in]`Amazon S3 template URL` and then click [.ui]*Next*.image:aws/deploying/aws-marketplace-couchbase-ee-create-stack-select-template.png[,570]
...
Click [.ui]*Next*.image:aws/deploying/aws-marketplace-couchbase-ee-create-stack-options.png[,570]
...
+
Click the [.ui]*Servers* tab to explore the sever nodes that have been created.image:aws/logging-in/aws-couchbase-web-console-servers.png[,570]
