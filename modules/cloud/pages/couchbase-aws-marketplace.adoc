...
Alternately, you can click https://aws.amazon.com/marketplace/pp/prodview-zy5g2wqmqdyzw?sr=0-1&ref_=beagle&applicationId=AWSMPContessa[here^] to go to the Couchbase Enterprise Edition product page directly.
...
Enter the *Network coniguration/Access* parameters
+
image::aws/deploying/aws-marketplace-couchbase-ee-stack-stack-networkconfiguration.png[,570]

Enter the *Core Server Configuration* parameters. You can choose to use the default values defined in the AWS CloudFormation template or edit them.
+
...
If you plan to set up Couchbase Multi-Dimensional Scaling, you can customize the paramenters in the *Mutlti-Dimension Scaling Configuration* section. 
...
image::aws/logging-in/aws-marketplace-explore-couchbaseinstances.png[,570]
...
image::aws/logging-in/aaws-marketplace-running-couchbase-instances.png[,570]
