...
Follow the steps documented xref:sync-gateway:start-here:get-started-prepare.adoc#lbl-create-bucket[here] to configure the server to work with Couchbase Sync Gateway.
