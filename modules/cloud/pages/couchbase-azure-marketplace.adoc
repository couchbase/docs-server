...
+
Click the [.ui]*Servers* tab to explore the sever nodes that have been created.image:azure/logging-in/azure-cb-web-console-servers.png[,570]
...
. Click [.ui]*Scaling* under Settings and move the slider on the instance count up (or down) as needed.image:azure/scaling/azure-cb-vm-server-scaling-save-new-config.png[,570]
. Click [.ui]*Save*.
