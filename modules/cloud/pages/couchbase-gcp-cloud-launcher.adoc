...
image:gcp/logging-in/gcp-web-console-dashboard.png[,570]Click the Servers tab to explore the server nodes that have been created.
...
image:gcp/scaling/gcp-server-instance-group-details.png[,570] image:gcp/scaling/gcp-server-instance-group-edit-number.png[,570]
. Click [.ui]*Save*.
