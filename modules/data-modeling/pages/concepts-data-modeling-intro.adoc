...
image::concepts/relational-model-flight-status.png[,450]
...
image::concepts/document-data-model-flight-booking.png[,150]
...
Is it better to have fewer, richer documents that embed complex information, or more, simpler documents that refer to other independently maintained simple documents?
To answer this, consider the information access patterns and how objects are managed in application code.
