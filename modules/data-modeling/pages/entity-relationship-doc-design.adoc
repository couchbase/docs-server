...
The topics <<reference-vs-embed-docs>> and xref:modeling-relationships.adoc#concept_ol2_khr_dt[Modeling Relationships] present a detailed discussion of tools for representing relationships and best practices for each type of relationships.
