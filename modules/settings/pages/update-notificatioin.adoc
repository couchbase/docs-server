...
[abstract]
The Update notifications function allows the client that is accessing the Couchbase Web Console to determine whether a newer version of Couchbase Server is available.
