...
[.half-width]
image::learn:manage-settings/query-settings-top.png["The first few Advanced Query Settings"]
--
...
[.half-width]
image::tools:query-workbench-preferences.png["The Run-Time Preferences window"]
--
...
For more details and examples, see the xref:guides:prep-statements.adoc[] guide.
