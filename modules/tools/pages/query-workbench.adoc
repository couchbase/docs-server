...
Click the double-headed arrow icon icon:expand-alt[] to enlarge the [.ui]*Query Editor* and [.ui]*Query Results* areas -- the [.ui]*Data Insights* area is resized accordingly.
...
Click the double-headed arrow icon icon:expand-alt[] to enlarge the [.ui]*Data Insights* area -- the [.ui]*Query Editor* and [.ui]*Query Results* areas are resized accordingly.

Within the [.ui]*Data Insights* area, buckets, scopes, and collections are displayed in a hierarchy, which you can expand or collapse.
...
The information in the [.ui]*Data Insights* area is updated regularly, but it may take a short time to reflect recent changes.
To force the [.ui]*Data Insights* area to update, click btn:[Refresh].
