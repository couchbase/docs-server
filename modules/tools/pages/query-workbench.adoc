...
If the Index Advisor recommends any xref:n1ql:n1ql-language-reference/covering-indexes.adoc[covering indexes] for this query, they are listed under this heading.
+
...
If the Index Advisor recommends any indexes for this query, they are listed under this heading.
+
...
* The xref:n1ql:n1ql-language-reference/advise.adoc[ADVISE] statement
* The xref:n1ql:n1ql-language-reference/advisor.adoc[ADVISOR] function