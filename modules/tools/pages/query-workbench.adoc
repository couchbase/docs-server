...
1. You can render the chart in one of several formats: `X-Y`, `Connected Point`, `Line`, `Area`, `Bar`, `Group Bar`, `Pie`, and `Donut`.

2. Select a label for your axis. This must be one of the items returned in your query results.

3. The data series to be rendered on the chart.
