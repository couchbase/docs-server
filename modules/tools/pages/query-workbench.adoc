...
If the Index Advisor recommends any xref:n1ql:n1ql-language-reference/covering-indexes.adoc[covered indexes] for this query, they are listed under this heading.
+
