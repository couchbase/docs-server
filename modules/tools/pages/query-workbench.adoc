...
To display it, click the rightward-pointing arrowhead icon:chevron-right[] to the right of the btn:[Execute] button.
To hide it again, click the cross icon icon:times-circle[] to the right of the button.
...
You can specify the query settings by clicking the cog icon icon:cog[] near the top right of the Query Workbench.
