...
{empty} . The N1QL editor provides the following additional features:
...
You can also hover the mouse pointer over a field name to see example values for that field.
