...
Starting from Version 7.1, the Couchbase Administration console provides a CRUD{empty}footnote:[**CR**eate **U**pdate **D**elete] interface for user defined functions written in {sqlpp} or JavaScript.
