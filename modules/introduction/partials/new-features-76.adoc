...
* Couchbase Server 7.6 introduces Scoped Index Naming 
as an optional part of the `WHERE` clause in an {sqlpp} statement.
For more information, see xref:n1ql:n1ql-language-reference/searchfun.adoc#search-function-arguments-section[SEARCH function arguments]
