...
New to `8.0.0`, Couchbase Server now supports synonym matches in full-text searches.
+
...
New to `8.0.0`, we have added new data types to the FTS index, giving more ways to filter your documents.
+
The new types are:
...
+
For more details, see xref:search:create-type-mapping.adoc[]

https://jira.issues.couchbase.com/browse/MB-58901[MB-58901]::

Couchbase Server version `8.0.0` now supports the BM25 search algorithm for search ranking.
+
