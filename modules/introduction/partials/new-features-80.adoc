...
The Incoming Replications can be viewed on the XDCR tab of the UI or retrieved by using the REST API command `GET /xdcr/sourceClusters`.
+
To view the incoming replications:

* From the UI, see xref:manage:manage-xdcr/incoming-xdcr-replications.adoc#view-incoming-replications[View Incoming Replications] in xref:manage:manage-xdcr/incoming-xdcr-replications.adoc[Incoming Replications].
* Using the REST API, see xref:rest-api:rest-xdcr-list-incoming-replications.adoc[Listing Incoming Replications].
