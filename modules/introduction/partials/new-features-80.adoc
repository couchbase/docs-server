...
Before upgrading to Couchbase Server 8.0, you must remove any Memcached buckets.
You can replace them with ephemeral buckets which are similar to Memcached buckets but support more features such as rebalance, backup, query, and eventing.
