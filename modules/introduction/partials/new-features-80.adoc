...
* This feature is useful to prevent users from connecting to the database during maintenance.
* This feature is applicable to local domain user accounts only.
* This is an Enterprise only feature, and only available after the entire cluster is upgraded to the Couchbase Server 8.0 or a later version.
--
+
