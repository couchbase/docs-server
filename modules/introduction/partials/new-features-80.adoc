...
|===
+
 The settings `warmup_min_items_threshold`, `warmup_min_memory_threshold`, `exp_pager_stime`, `mem_high_wat`, and `mem_low_wat` are deprecated, and replaced by the above new settings.
+
