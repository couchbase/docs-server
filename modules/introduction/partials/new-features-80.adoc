...
+ 
See xref:learn:data/durability.adocl#maintaining-durable-writes[Maintaining Durable Writes During Single Replica Failovers] for more information about this feature.
