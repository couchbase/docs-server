...
You can now specify service configuration settings globally, or at the scope level.
A new service configuration setting enables you to how many Eventing nodes are used to execute the functions in scope.
For more information, see xref:eventing-rest-api:index.adoc#tag-ServiceConfig[Service Config].
