...
Previously, Couchbase Server always prevented auto-failover on nodes containing an ephemeral bucket without replicas.
...
See xref:manage:manage-settings/general-settings.adoc[] and xref:rest-api:rest-cluster-autofailover-settings.adoc[] for more information.
