...
See xref:manage:manage-settings/general-settings.adoc#node-availability[Node Availability] and
See xref:rest-api:rest-cluster-autofailover-enable.adoc[] to learn how to enable it.
