...
* _Capella_ databases use Certificate Authorities (CAs), to establish secure connections.
These CAs are automatically trusted when you use Couchbase Web Console or the REST API to establish _fully secure_ XDCR connections between Capella databases and Couchbase Enterprise Server 7.2+.
