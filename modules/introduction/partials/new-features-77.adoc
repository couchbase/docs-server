...
In `7.7.0` we have relaxed the limit on the number of xattrs that can be indexed.
Couchbase Server now supports up to 16 xattrs per index and can look up 15 subpaths per request. 
