...
+
** The new `base64Encode()` and `base64Decode()` functions let you pack large arrays of floats as base64-encoded strings when you use Eventing to generate vector embeddings.
