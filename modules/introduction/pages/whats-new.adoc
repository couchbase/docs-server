...
To learn more about this new service, see xref:eventing:eventing-overview.adoc[Eventing Service: Fundamentals].
...
Users can xref:settings:cluster-settings.adoc[enable log redaction] to prevent leaking sensitive user data when using the logs for troubleshooting production issues.
