...
For information about new supported platforms, deprecated or removed platforms, deprecation notifications, and known issues in thsi release, see xref:release-notes:relnotes.adoc[release notes].
