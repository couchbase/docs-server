...
For version 7.0.3 or greater, Search indexes may use up to 90% less disk space.
In consequence, the Search Service now supports up to 500 index partitions per cluster.
