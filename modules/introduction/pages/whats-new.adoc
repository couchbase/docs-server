...
We extend xref:security:security-certs-auth.adoc[X.509 certificate authentication] beyond key-value data access to query and search services for xref:dotnet-sdk::sdk-authentication-overview.adoc#sdk_authentication[all SDK].
