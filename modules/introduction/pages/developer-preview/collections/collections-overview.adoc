...
For the `cbstats` reference pages for collections, see xref:introduction:developer-preview/collections/collections-cbstats-reference.adoc[cbstats Reference].
