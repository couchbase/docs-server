...
For example, one solution might deliver data model flexibility (i.e might be very flexible in the data model) but lack the ability to add or remove nodes without a serious impact on up-time or performance.
