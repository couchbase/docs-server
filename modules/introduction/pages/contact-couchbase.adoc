...
To participate fully, you need to register: click on the *Sign Up* button, at the upper right.
...
If you find a documentation error, to fix it, you can click on the link at the upper right of each page:
...
When you have made your edits, click on the btn:[Commit changes] button, at the lower left:
