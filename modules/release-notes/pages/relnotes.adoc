...
[#release-712]
== Release 7.1.2 (September 2022)

Couchbase Server 7.1.2 was released in September 2022.
...
* The Eventing Services now allows multiple collections to be listed to.
