...
| *Summary*: Diag log full of Metadata overhead warning

| https://issues.couchbase.com/browse/MB-54449[MB-54449^]
| *Summary*: CURL function fails with SSL peer certificate or SSH remote key was not OK

| https://issues.couchbase.com/browse/MB-54349[MB-54349^]
| *Summary*: Stats comparison should handle ssl port

| https://issues.couchbase.com/browse/MB-54249[MB-54249^]
| *Summary*: cbcollect_info: golang component debug sweep up

| https://issues.couchbase.com/browse/MB-54134[MB-54134^]
| *Summary*: Leaking credentials in REST api crash dump

| https://issues.couchbase.com/browse/MB-54132[MB-54132^]
| *Summary*: Leaking credentials in REST api crash dump

| https://issues.couchbase.com/browse/MB-53994[MB-53994^]
| *Summary*: Upgrade all golang versions for ns_server dependencies

| https://issues.couchbase.com/browse/MB-53993[MB-53993^]
| *Summary*: cbauth & gometa - Update GoLang to 1.18 or 1.19

| https://issues.couchbase.com/browse/MB-53972[MB-53972^]
| *Summary*: Eventing RBAC: lifecycle operations succeed even though user lacks required set of permissions

| https://issues.couchbase.com/browse/MB-53891[MB-53891^]
| *Summary*: The socket pool manager for REST calls process should be further down the start order

| https://issues.couchbase.com/browse/MB-53077[MB-53077^]
| *Summary*: Couchbase Server should have warnings for high system memory usage

| https://issues.couchbase.com/browse/MB-52898[MB-52898^]
| *Summary*: Nodes can't connect to each other if at least one node in cluster changes IP (or disappears)

| https://issues.couchbase.com/browse/MB-52793[MB-52793^]
| *Summary*: Replica can persist deletion with xattr datatype but empty value

| https://issues.couchbase.com/browse/MB-52076[MB-52076^]
| *Summary*: goport may be vulnerable to CVE-2019-11888

| https://issues.couchbase.com/browse/MB-50111[MB-50111^]
| *Summary*: Index UI stats not working when "view by server node"
...
| *Summary*: Requesting XTOC without access to system xattr may return "null"

| https://issues.couchbase.com/browse/MB-54674[MB-54674^]
| *Summary*: cbcollect_info reading /proc/<PID>/smaps causes 20+ second pauses in CB processes

| https://issues.couchbase.com/browse/MB-54591[MB-54591^]
| *Summary*: Lost wakeup in ActiveStream can result in DCP clients not receiving seqnos until another mutation occurs

| https://issues.couchbase.com/browse/MB-53992[MB-53992^]
| *Summary*: Upgrade GO version to 1.18.2 for cbsummary
...
| *Summary*: Early unlock of hashtable lock whilst still referencing StoredValue

| https://issues.couchbase.com/browse/MB-53118[MB-53118^]
| *Summary*: Warmup can fail to make forward progress if Warmup LoadStorageKVPairCallback takes takes longer than 10ms

| https://issues.couchbase.com/browse/MB-53115[MB-53115^]
| *Summary*: XMEM will leak memory if pipeline is paused with full buffer

| https://issues.couchbase.com/browse/MB-53097[MB-53097^]
| *Summary*: Index rollback to zero after KV node autofailedover

| https://issues.couchbase.com/browse/MB-53003[MB-53003^]
| *Summary*: Don't allocate Blob objects for items read from disk which do not have values

| https://issues.couchbase.com/browse/MB-52383[MB-52383^]
| *Summary*: Warmup of loading data does not yield correctly

| https://issues.couchbase.com/browse/MB-52357[MB-52357^]
| *Summary*: Improve performance for document access auditing when using filtering

| https://issues.couchbase.com/browse/MB-52143[MB-52143^]
| *Summary*: Misuse of SASL Step causes immediate memcached crash

| https://issues.couchbase.com/browse/MB-51860[MB-51860^]
| *Summary*: It is possible to configure audit so that the system hangs

| https://issues.couchbase.com/browse/MB-51498[MB-51498^]
| *Summary*: TLS connection handshake does not yield to event loop until complete

| https://issues.couchbase.com/browse/MB-51424[MB-51424^]
| *Summary*: KVBucket::getValue can lead to incorrectly incrementing "failure_get" a failover trigger stat

| https://issues.couchbase.com/browse/MB-51373[MB-51373^]
| *Summary*: Protect against xattr datatype and empty value

| https://issues.couchbase.com/browse/MB-50874[MB-50874^]
| *Summary*: Replica to active promotion after receiving a SnapshotMarker(CHK) with de-duplicated seqno(s) crashes on next mutation

| https://issues.couchbase.com/browse/MB-50425[MB-50425^]
| *Summary*: Race in checking for already-existing Deleted document with Add&#124;CreateAsDeleted

| https://issues.couchbase.com/browse/MB-50423[MB-50423^]
| *Summary*: Bgfetched deleted item metadata is not cleaned up (value eviction)

| https://issues.couchbase.com/browse/MB-47851[MB-47851^]
| *Summary*: Bucket deletion hangs indefinitely if warmup is cancelled before VBucketMap is populated with outstanding requests
...
| *Summary*: ActiveStreamCheckpointProcessorTask should not be a AuxIO task
...
| *Summary*: Remote Cluster Service Refresh stuck
...
| https://issues.couchbase.com/browse/MB-53996[MB-53996^]
| *Summary*: Update GoLang to 1.18 or 1.19

| https://issues.couchbase.com/browse/MB-52470[MB-52470^]
| *Summary*: panic after capi replication is created

| https://issues.couchbase.com/browse/MB-51647[	MB-51647^]
| *Summary*: Content-length header missing from ES Plugin

| https://issues.couchbase.com/browse/MB-51604[MB-51604^]
| *Summary*: Pipeline restart under duress can overwrite valid ckpt with seqno 0

| https://issues.couchbase.com/browse/MB-38106[MB-38106^]
| *Summary*: XDCR Remote Cluster Service Cleanup
...
| https://issues.couchbase.com/browse/MB-55048[MB-55048^]
| *Summary*: N1QL non-ssl port address not getting updated to loopback

| https://issues.couchbase.com/browse/MB-54879[MB-54879^]
| *Summary*: TTL expiration set to max with -1 value

| https://issues.couchbase.com/browse/MB-54872[MB-54872^]
| *Summary*: indexing MISSING when array subscript > 0

| https://issues.couchbase.com/browse/MB-54751[MB-54751^]
| *Summary*: Connection management issues

| https://issues.couchbase.com/browse/MB-54750[MB-54750^]
| *Summary*: 	cbq should allow to pass in CA root with credential when connection over SSL

| https://issues.couchbase.com/browse/MB-54393[MB-54393^]
| *Summary*: INSERT/UPSERT options should not be shared
...
| https://issues.couchbase.com/browse/MB-54000[MB-54000^]
| *Summary*: Query Service - Update GoLang to 1.18 or 1.19
...
| https://issues.couchbase.com/browse/MB-54873[MB-54873^]
| *Summary*: index attempting to store array element is not storing any items
...
| *Summary*: Handle Panics in go routines while loading snapshot

| https://issues.couchbase.com/browse/MB-54176[MB-54176^]
| *Summary*: BP Snapshot latency histograms to 6.6.6

| https://issues.couchbase.com/browse/MB-53997[MB-53997^]
| *Summary*: Update GoLang to 1.18 or 1.19

| https://issues.couchbase.com/browse/MB-53574[MB-53574^]
| *Summary*: Indexer/Plasma crash lead to kv rebalance failure.

| https://issues.couchbase.com/browse/MB-53221[MB-53221^]
| *Summary*: RollbackAll to zero with need an older snapshot error seen in the indexer logs

| https://issues.couchbase.com/browse/MB-53207[MB-53207^]
| *Summary*: feed gen-server crashed: runtime error: invalid memory address or nil pointer dereference

| https://issues.couchbase.com/browse/MB-53183[MB-53183^]
| *Summary*: Secondary Index rollback to zero after KV node auto failover

| https://issues.couchbase.com/browse/MB-53075[MB-53075^]
| *Summary*: Index rollback to zero after KV node failover

| https://issues.couchbase.com/browse/MB-53057[MB-53057^]
| *Summary*: Snapshot invariant "snapStart > previous completed snapEnd" broken during autofailover

| https://issues.couchbase.com/browse/MB-52482[MB-52482^]
| *Summary*: Reduce number of ns_server calls in query client

| https://issues.couchbase.com/browse/MB-52481[MB-52481^]
| *Summary*: 	Error messages like "DDLServiceMgr:rebalanceDone(): Failed to initialize metadata provider" seen in indexer log during upgrade

| https://issues.couchbase.com/browse/MB-52392[MB-52392^]
| *Summary*: Optimize cinfo in newMetadataProvider

| https://issues.couchbase.com/browse/MB-52357[MB-52357^]
| *Summary*: Improve performance for document access auditing when using filtering

| https://issues.couchbase.com/browse/MB-52277[MB-52277^]
| *Summary*: Seeing errors "DDLServiceMgr: Failed to start metadata provider" several times in the test

| https://issues.couchbase.com/browse/MB-50574[MB-50574^]
| *Summary*: Repair more than one replicas for missing partitions

| https://issues.couchbase.com/browse/MB-50489[MB-50489^]
| *Summary*: Rebalance in 9 indexer nodes failed. agent_died

| https://issues.couchbase.com/browse/MB-49844[MB-49844^]
| *Summary*: Usage of global cluster info client object
...
[#table_fixedissues_v666-search-service,cols="25,66"]
|===
| Issue | Description

| https://issues.couchbase.com/browse/MB-53995[MB-53995^]
| *Summary*: Update GoLang to 1.18 or 1.19

| https://issues.couchbase.com/browse/MB-53969[	MB-53969^]
| *Summary*: Update transitive dependencies of golang.org/x/text package to 0.3.4 or later CVE-2020-14040
...
| https://issues.couchbase.com/browse/MB-54981[MB-54981^]
| *Summary*: Update Netty to 4.1.86.Final or higher [CVE-2022-41881,CVE-2022-41915]

| https://issues.couchbase.com/browse/MB-54594[MB-54594^]
| *Summary*: Include Couchbase jars & shadowed dependencies in BOM for Analytics BD scans

| https://issues.couchbase.com/browse/MB-54535[MB-54535^]
| *Summary*: Upon the failover & removal of an analytics node that never successfully bootstraps, the analytics service becomes unusable

| https://issues.couchbase.com/browse/MB-54266[MB-54266^]
| *Summary*: 	Online upgrade using swap rebalance from 6.6.5-MP8 -> 6.6.5-MP9 with n2n enabled + encryption level strict fails while rebalancing cbas

| https://issues.couchbase.com/browse/MB-54160[MB-54160^]
| *Summary*: Security update jackson-databind CVE-2022-42003 + CVE-2022-42004

| https://issues.couchbase.com/browse/MB-54013[MB-54013^]
| *Summary*: Analytics Upgrade Golang to address CVEs
...
| *Summary*: Analytics Service cannot be added nor re-added to a 6.6.5 cluster w/ node-to-node encryption configured

| https://issues.couchbase.com/browse/MB-47770[MB-47770^]
| *Summary*: Update OpenJDK version to address CVEs
...
| https://issues.couchbase.com/browse/MB-55191[MB-55191^]
| *Summary*: Online upgrade using graceful failover/delta recovery/rebalance fails during rebalance of eventing service

| https://issues.couchbase.com/browse/MB-54699[MB-54699^]
| *Summary*: Repair LCB handles on AUTH error

| https://issues.couchbase.com/browse/MB-54698[MB-54698^]
| *Summary*: Add all KV nodes to the bootstrap list

| https://issues.couchbase.com/browse/MB-53999[MB-53999^]
| *Summary*: Update GoLang to 1.18 or 1.19
...
| *Summary*: Eventing rebalance stuck at 99%

| https://issues.couchbase.com/browse/MB-51367[MB-51367^]
| *Summary*: Eventing rebalance failed due to timeout

| https://issues.couchbase.com/browse/MB-51340[MB-51340^]
| *Summary*: Eventing: Data mismatch for timers handler in couple of swap rebalance tests
...
| *Summary*: Handlers taking long time to bootstrap for RQG test

| https://issues.couchbase.com/browse/MB-51078[MB-51078^]
| *Summary*: Rebalance exited with reason "eventing rebalance hasn't made progress for past 1200 secs"
...
| *Summary*: Bucket ops failing with LCB_ERR_SSL_CANTVERIFY

| https://issues.couchbase.com/browse/MB-50630[MB-50630^]
| *Summary*: N2N Encryption : Bucket ops failing with LCB_ERR_SSL_CANTVERIFY

| https://issues.couchbase.com/browse/MB-47489[MB-47489^]
| *Summary*: Retry DcpGetSeqnos on failure
...
| *Summary*: Handle json/raw compressed xattr data type
