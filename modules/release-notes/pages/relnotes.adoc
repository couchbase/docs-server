...
[#table_fixedissues_v652-cluster-manager,cols="25,66"]
|===
| Issue | Description
...
| https://issues.couchbase.com/browse/MB-43041[MB-43046^]
...
| https://issues.couchbase.com/browse/MB-43046[MB-43041^]
