...
| https://issues.couchbase.com/browse/DOC-6506[DOC-6506^]
| *Summary*: Upgrading from version 6.0.4 to version 6.5.0 using offline upgrade or rolling online upgrade using graceful failover and delta node does not work as version 6.0.4 included a per-node configuration migration, and it was released after 6.5.0. 

*Workaround*: To upgrade successfully from version 6.0.4 to 6.5.0, you must use swap rebalance until the next maintenance release on the 6.5.x series is available.
