...
+
Starting with this release, dataset definitions no longer require the SHADOW keyword, and doing so returns an error.
You can use the following syntax to create a dataset:
+
----
