...
Couchbase Server 7.0.3 was released in December 2021. This maintenance release contains issue fixes.
...
IMPORTANT: This release fixes a high severity vulnerability related to Log4j 2. All users should upgrade to this release as soon as possible

==== Analytics

[#table_fixedissues_v703-analytics,cols="25,66"]
|===
|Issue | Description

| https://issues.couchbase.com/browse/MB-50052[MB50052^]
