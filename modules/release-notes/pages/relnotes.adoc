...
Upgrading from version 6.0.4 to version 6.5.0 using offline upgrade or rolling online upgrade using graceful failover and delta node does not work as version 6.0.4 included a per-node configuration migration, and it was released after 6.5.0. 
