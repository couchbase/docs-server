...
| *Summary*: Fixed an intermittent rebalance failure observed when upgrading the Analytics node.
|===
...
| *Summary*: The index service crashed if the data bucket was flushed while the initial index was being built.
|===
