...
| XDCR does not update memcached flag/body after txn xattribute removal if user xattr DNE
...
[#table-known-issues-711-analyticsservice, cols="25,66"]
|===
|Issue | Description

| https://issues.couchbase.com/browse/MB-52008[MB-52008^]
| Analytics average ingestion rate with magma is 90% lower compared to Couchstore
