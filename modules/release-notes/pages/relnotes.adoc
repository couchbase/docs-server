...
{description}
It also brings new capabilities to the Query Service in addition to support for scopes and collections.
...
For further details, see https://issues.couchbase.com/browse/MB-53347[MB-53347^].

* Couchbase Server has been updated to V8 version 10.7.21 to fix a number of high severity vulnerabilities.
For further details, see https://issues.couchbase.com/browse/MB-53824[MB-53824^].

* Couchbase Server has been updated to OpenSSL 1.1.1q+ to fix a 9.8 critical issue.
For further details, see https://issues.couchbase.com/browse/MB-53368[MB-53368^].

* Couchbase Server has been updated to use the latest versions of cURL and libcurl to fix a number of vulnerabilities.
For further details, see https://issues.couchbase.com/browse/MB-53365[MB-53365^].
...
For further details, see https://issues.couchbase.com/browse/MB-54307[MB-54307^], https://issues.couchbase.com/browse/MB-54254[MB-54254^], and https://issues.couchbase.com/browse/MB-54159[MB-54159^].
...
[#table_fixedissues_v705-nsserver,cols="25,66"]
|===
|Issue | Description

| https://issues.couchbase.com/browse/MB-54133[MB-54133^]
| *Summary*: Leaking credentials in REST api crash dump

| https://issues.couchbase.com/browse/MB-54103[MB-54103^]
| *Summary*: Whole couchbase cluster can be stolen during any cluster node restart
...
| https://issues.couchbase.com/browse/MB-54217[MB-54217^]
| *Summary*: Handle loadSkipLog: Error parsing version while sorting: expected integer

| https://issues.couchbase.com/browse/MB-53967[MB-53967^]
| *Summary*: Sync Metadata Files after Write
...
| https://issues.couchbase.com/browse/MB-54231[MB-54231^]
| *Summary*: Cannot debug 503 errors from Query Service
