...
This maintenance release contains feature-enhancements and bug fixes.
...
* A node's _alternate address_ can now be used to identify a target cluster for XDCR.
...
[#table_fixedissues_v702-dataservice,cols="25,66"]
|===
|Issue | Description
...
[#table_fixedissues_v702-queryservice,cols="25,66"]
|===
|Issue | Description
...
| https://issues.couchbase.com/browse/MB-47737[MB-47737^]
| *Summary*: Log more information when replica counter merge fails

| https://issues.couchbase.com/browse/MB-47760[MB-47760^]
| *Summary*: handleIndexMergeSnapshot() panic from extraneous s.muSnap.Unlock() calls

| https://issues.couchbase.com/browse/MB-47833[MB-47833^]
| *Summary*: getIndexStatus endpoint is getting timed out

| https://issues.couchbase.com/browse/MB-47878[MB-47878^]
| *Summary*: CBSE - Increase the poll time in pollForDeletedBuckets at projector

| https://issues.couchbase.com/browse/MB-48017[MB-48017^]
| *Summary*: CPU utilization is much higher in 7.0.1/2 when cluster is idle

| https://issues.couchbase.com/browse/MB-48030[MB-48030^]
| *Summary*: [TLS] Strict mode, see errors in query log for 9101 port for indexer client

| https://issues.couchbase.com/browse/MB-48144[MB-48144^]
| *Summary*: Add version check to enable plasma indexes on Ephemeral buckets from 7.0.2

| https://issues.couchbase.com/browse/MB-48145[MB-48145^]
| *Summary*: [Enforce-TLS] IndexStatus returns Cannot communicate with indexer process. Information on indexes may be stale. Will retry

| https://issues.couchbase.com/browse/MB-48145[MB-48145^]
| *Summary*: [IPV6] no index available when switching to ipv6 or ipv6only IP family

| https://issues.couchbase.com/browse/MB-48336[MB-48336^]
| *Summary*: Persist rollbacks stats in case of indexer crash - needed for verification

| https://issues.couchbase.com/browse/MB-48336[MB-48336^]
| *Summary*: [Enforce-TLS] 'Rebalance exited with reason {service_rebalance_failed,index}..'

|===

==== Search Service

[#table_fixedissues_v702-searchservice,cols="25,66"]
|===
|Issue | Description


https://issues.couchbase.com/browse/MB-46260[MB-46876^]
| *Summary*: FTS - Apply RBAC only for target collections in a multi-collection index
...
| https://issues.couchbase.com/browse/MB-47546[MB-47546^]
| *Summary*: Bind only to IPv4 addresses when invoked with IPv4-Only cluster-wide setting - xdcr

| https://issues.couchbase.com/browse/MB-47723[MB-47723^]
| *Summary*: Enforce TLS - XDCR
...
[#table_fixedissues_v702-tools,cols="25,66"]
|===
|Issue | Description
...
[#table_fixedissues_v702-install,cols="25,66"]
|===
|Issue | Description
...
| https://issues.couchbase.com/browse/MB-47992[MB-48356^]
...
| https://issues.couchbase.com/browse/MB-47094[MB-46876^]
