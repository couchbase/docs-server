...
| https://issues.couchbase.com/browse/MB-51261[MB-51261^]
...
| https://issues.couchbase.com/browse/MB-516291[MB-51629^]
| *Summary*: Negative integer in the 64bit range causes rounding
...
[#table_fixedissues_v704-installandupgrade,cols="25,66"]
|===
|Issue | Description

| https://issues.couchbase.com/browse/MB-52313[MB-52313^]
| *Summary*: Analytics Service crashes during upgrade
