...
Geospatial search queries now support bounded polygons in addition to radius-based and box-based queries. 
For details, see xref:fts:fts-geospatial-queries.adoc[Geospatial Queries].
...
* Starting with release 6.5.1, Memcached buckets are deprecated. We recommend using Ephemeral buckets as an alternative.
