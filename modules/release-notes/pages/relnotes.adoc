...
This maintenance release contains enhancements and fixes.
...
[#table-known-issues-712-index-service, cols="25,66"]
|===
|Issue | Description

| https://issues.couchbase.com/browse/MB-30249[MB-30249]
| Collection Indexer should index leading MISSING entries
