...
For example, `curl --location --request PUT 'http://localhost:8095/analytics/config/service' --header 'Authorization: Basic QWRtaW5pc3RyYXRvcjpwYXNzd29yZA==' --header 'Content-Type: application/x-www-form-urlencoded' --data-urlencode 'jvmArgs=-Djava.net.preferIPv4Stack=false'`.
