...
Couchbase Server 6.5 Beta brings many sought-after relational capabilities to the NoSQL world. This release targets improving developer agility, reduced TCO, enhanced manageability, and provides enterprise-grade security and performance. 
