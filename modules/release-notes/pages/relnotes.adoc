...
This maintenance release contains enhancements and bug fixes.
...
* The cluster's address family to be specifically restricted to either IPv4 or IPv6 &#8212; see xref:manage:manage-nodes/manage-address-families.adoc[Manage Address Families].

* A node's _alternate address_ can now be specified used to identify the target cluster for XDCR.
