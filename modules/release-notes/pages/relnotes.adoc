...
XDCR checkpointing is now entirely persistent through topology-changes on the target cluster.
This provides improved performance when failover and rebalance occur.
