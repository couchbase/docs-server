...
* Use N1QL to set document expiration. 
* New _file append mode_ in `cbq` to append redirected output to the end of an existing file, rather than overwriting the existing file. See xref:tools:cbq-shell.adoc[cbq: The Command Line Shell for N1QL] for details.
