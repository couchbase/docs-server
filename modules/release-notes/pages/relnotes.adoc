...
| If DCP nozzles are started and then stopped in sequence,
 gomemcache leaks may occur.
| A fix has been provided for the feed to be synchronised correctly and closed.
|===
