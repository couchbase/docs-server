...
In couchbase-server-8.0.0-2772, an update has been made to the indexing component. The change involves disabling the plasma configuration option enableCompressFullMarshal. This adjustment is related to the indexing commit c8f3dab, addressing issue MB-65644. The modification is expected to take effect in version 8.0.0-2905.
