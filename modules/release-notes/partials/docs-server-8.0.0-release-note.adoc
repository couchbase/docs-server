...
Couchbase Server 8.0.0-2772 includes an important indexing update with commit [c8f3dab]. The change addresses issue MB-65644 by setting the plasma configuration parameter `enableCompressFullMarshal` to false. This adjustment aims to optimize performance and address specific operational needs. The update is finalized in version 8.0.0-2905, ensuring the modification is properly integrated and functioning as intended.
