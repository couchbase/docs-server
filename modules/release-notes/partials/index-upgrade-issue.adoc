...
a| A critical issue occurs when using the offline-upgrade, graceful failover, or delta-recovery upgrade methods on Sndex Service nodes from Couchbase Server versions 7.1 through 7.2 to versions 7.6.0 or 7.6.1. 
