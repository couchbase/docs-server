...
| To work around this issue, modify settings using the Nodes and Clusters REST API.
...
| To work around this issue, merge backups manually using the UI or using the API.
|===
