...
The same issue was identified in Subdoc deletes,
requiring TTL to bypass the fetch-phase and trigger during the remove-phase.
These improvements have been integrated into several builds,
providing a more robust handling of document deletions triggered by TTL.
