...
The latest update includes a change to the plasma configuration, setting enableCompressFullMarshal to false. This adjustment addresses indexing changes made in response to issue MB-65644. The goal of this update is to improve system efficiency and performance. This setting modification is designed to prevent potential issues related to data compression during full marshalling. The change was merged into the main codebase as part of ongoing efforts to optimize system functionality in Couchbase Server.
