...
[#known-issues-800]
== Known Issues 8.0.0 (November 2025)

For Couchbase Server 8.0.0 was released in November 2025,
...
+
*Workaround:* Properly size the indexer for random sample vectors and configure the index build batch size to limit the number of indexes built together, taking into account available memory quota and vector sizes.
