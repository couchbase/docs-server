...
We are pleased to announce added support for Debian 13 (Trixie).
This update expands compatibility with the latest Debian distribution.
Comprehensive testing has confirmed stable performance on this new platform.
