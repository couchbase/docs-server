...
The `-o, --output` flag specifies the output file to write the report to. Example: `report.html`.

Optional flags:

The `-t2` flag specifies the start-time and end-time of the second time period. Enter both start-time and end-time in the `YYYY-MM-DDTHH:MM:SS` format, separated by a comma. Example: `2025-09-02T00:00:00,2025-09-03T00:00:00`.
