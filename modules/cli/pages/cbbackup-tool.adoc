...
To create backups with compression, you should use xref:backup-restore:cbbackupmgr.adoc[cbbackupmgr], which is available for Couchbase Server Enterprise Edition only.
|===
