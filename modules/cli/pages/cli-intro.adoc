...
+
--
Server developer tools package lets you install the following EE Server utilities on the systems where you have not installed Couchbase Server:
...
+
--
Server admin tools package lets you install the following Server utilities on the systems where you have not installed Couchbase Server:
...
The versions of the utilities installed by the tools package are same as the corresponding Couchbase Server installation package.
...
You can download and use the latest version of these utilities (`cbimport`, `cbexport`, `cbbackupmgr`, and `cbq`) with the earlier Couchbase Server versions.
