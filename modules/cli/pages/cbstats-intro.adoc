...
The `common options` for `cbstats` are described immediately below.

== Common Options

The `common options` for `cbstats` are as follows:
...
This following table displays statistics returned by `cbstats`.
