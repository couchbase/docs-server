...
For Server versions 6.0.4 or earlier, this maintenance process is configured to run every 60 minutes. Starting Server 6.0.5, this default has been changed to 10 minutes (600 s). Note that you can configure it to run at a different interval.
+
