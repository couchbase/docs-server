...
The ALTER INDEX statement provides two possible syntaxes for specifying the index and the keyspace on which the index is built.
...
index-with:: (Required) Refer to <<index-with>> below.
