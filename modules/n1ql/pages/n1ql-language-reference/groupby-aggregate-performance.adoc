...
[#image_lnh_v4q_xcb]
image::n1ql-language-reference/images/GBAP_Ex0_QP_before55.png[]
...
[#image_bln_w4q_xcb]
image::n1ql-language-reference/images/GBAP_Ex0_QP_after55.png[]
...
[#image_ngr_kzv_xcb]
image::n1ql-language-reference/images/GBAP_55execution.png[,700]

For your reference, this is how the same query executed before 5.5.

[#image_pbg_4zv_xcb]
image::n1ql-language-reference/images/GBAP_pre55execution.png[,700]
...
[#image_lhl_5xy_jdb]
image::n1ql-language-reference/images/GBAP_ExB_Plan.png[,70%]
...
[#image_fjx_cyy_jdb]
image::n1ql-language-reference/images/GBAP_ExC_Plan.png[,50%]
...
[#image_p31_ryy_jdb]
image::n1ql-language-reference/images/GBAP_ExD_Plan.png[,70%]
...
[#image_shx_czy_jdb]
image::n1ql-language-reference/images/GBAP_ExD2_Plan.png[]
...
[#image_dkl_w1z_jdb]
image::n1ql-language-reference/images/GBAP_ExE_Plan.png[,50%]
...
[#image_l3d_gvx_xcb]
image::n1ql-language-reference/images/GBAP_Ex2A_EP.png[]
...
[#image_kp1_yxd_ycb]
image::n1ql-language-reference/images/GBAP_Ex4A_VP.png[,50%]
...
[#image_kj3_xl2_ycb]
image::n1ql-language-reference/images/GBAP_Ex10_VP.png[,70%]
...
[#table_hvz_skf_ycb,cols="^3,^2,^2,^2,^2"]
|===
