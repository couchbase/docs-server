...
image::n1ql-language-reference/GBAP_Ex0_QP_before55.png["Execution plan with 6 steps: Authorize, IndexScan3, Filter, Group, Project with 2 terms, and Stream"]
...
image::n1ql-language-reference/GBAP_Ex0_QP_after55.png["Execution plan with 4 items: Authorize, IndexScan3, Project with 2 terms, and Stream"]
...
image::n1ql-language-reference/GBAP_55execution.png[,700, "Query execution process, showing grouping and aggregation pushed down to the indexer"]
...
image::n1ql-language-reference/GBAP_ExB_Plan.png["Visual plan with three steps: IndexScan3 using idx_grp_add, Filter, and Project with 5 terms"]
...
image::n1ql-language-reference/GBAP_ExC_Plan.png["Visual plan with 4 steps: IndexScan3 using idx_grp_add, Group, Filter, and Project with 3 terms"]
...
image::n1ql-language-reference/GBAP_ExD_Plan.png["Visual plan with 3 steps: IndexScan3 using idx_grp_add_distinct, Filter, and Project with 4 terms"]
...
image::n1ql-language-reference/GBAP_ExE_Plan.png["Visual plan with two steps: IndexScan3 using idx_grp_add_all, and Project with 4 terms"]
...
image::n1ql-language-reference/GBAP_Ex2A_EP.png["Query plan with 4 steps: IndexScan3 using idx1, Group, Project with 3 terms, and Order by Min Latitude"]
...
image::n1ql-language-reference/GBAP_Ex4A_VP.png["Query plan with 2 steps: IndexScan3 using idx4_expr, and Project with 3 terms"]
...
image::n1ql-language-reference/GBAP_Ex10_VP.png["Query plan with 3 steps: IndexScan3 using idx10, Project with 3 terms, and Order by SumAbs_Latitude"]
