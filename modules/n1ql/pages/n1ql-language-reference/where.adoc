...
You can construct complex conditional expressions, for example by using the xref:xref:n1ql-language-reference/logicalops.adoc[logical operators] `AND`, `OR`, and `NOT`.
