...
Refer also to {window-ex-3}[WINDOW Clause example 3] for a query showing this function used with the WINDOW clause.
...
Refer also to {window-ex-1}[WINDOW Clause example 1] for a query showing this function used with the WINDOW clause.
...
Refer also to {window-ex-2}[WINDOW Clause example 2] for a query showing this function used with the WINDOW clause.
