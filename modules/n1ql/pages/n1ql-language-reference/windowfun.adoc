...
See the xref:n1ql-language-reference/window.adoc[OVER clause and Window Functions] page for the generic syntax of window functions, window options, and the window definition.
...
=== Description
Returns the requested value from the first object in the current window frame, where the window frame is specified by the xref:n1ql-language-reference/window.adoc#window-definition[window definition].

=== Syntax

[subs="normal"]
----
first-value-function ::= FIRST_VALUE '(' <<fn-window-first-value-args,expr>> ')' [ <<fn-window-first-value-nulls>> ] OVER '(' xref:n1ql-language-reference/window.adoc#window-definition[window-definition] ')'
----
...
=== Description
Returns the requested value from the last object in the current window frame, where the window frame is specified by the xref:n1ql-language-reference/window.adoc#window-definition[window definition].

=== Syntax

[subs="normal"]
----
last-value-function ::= LAST_VALUE '(' <<fn-window-last-value-args,expr>> ')' [ <<fn-window-last-value-nulls>> ] OVER '(' xref:n1ql-language-reference/window.adoc#window-definition[window-definition] ')'
----
...
=== Description
Returns the requested value from an object in the current window frame, where the window frame is specified by the xref:n1ql-language-reference/window.adoc#window-definition[window definition].

=== Syntax

[subs="normal"]
----
nth-value-function ::= NTH_VALUE '(' <<fn-window-nth-value-args,expr>> ',' <<fn-window-nth-value-args,offset>> ')' [ <<fn-window-nth-value-from>> ] [ <<fn-window-nth-value-nulls>> ] OVER '(' xref:n1ql-language-reference/window.adoc#window-definition[window-definition] ')'
----
...
[subs="normal"]
----
ratio-to-report-function ::= RATIO_TO_REPORT '(' <<fn-window-ratio-to-report-args,expr>> ')' OVER '(' xref:n1ql-language-reference/window.adoc#window-definition[window-definition] ')'
----
