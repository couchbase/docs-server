...
This section shows the generic syntax of window functions, window options, and the OVER clause.
...
[subs="normal"]
----
first-value-function ::= FIRST_VALUE '(' <<fn-window-first-value-args,expr>> ')' [ <<fn-window-first-value-nulls>> ] OVER ( '(' {window-definition}[window-definition] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
lag-function ::= LAG '(' <<fn-window-lag-args,expr>> [ ',' <<fn-window-lag-args,offset>> [ ',' <<fn-window-lag-args,default>> ] ] ')' [ <<fn-window-lag-nulls>> ] OVER ( '(' {window-definition}[window-definition] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
last-value-function ::= LAST_VALUE '(' <<fn-window-last-value-args,expr>> ')' [ <<fn-window-last-value-nulls>> ] OVER ( '(' {window-definition}[window-definition] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
lead-function ::= LEAD '(' <<fn-window-lead-args,expr>> [ ',' <<fn-window-lead-args,offset>> [ ',' <<fn-window-lead-args,default>> ] ] ')' [ <<fn-window-lead-nulls>> ] OVER ( '(' {window-definition}[window-definition] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
nth-value-function ::= NTH_VALUE '(' <<fn-window-nth-value-args,expr>> ',' <<fn-window-nth-value-args,offset>> ')' [ <<fn-window-nth-value-from>> ] [ <<fn-window-nth-value-nulls>> ] OVER ( '(' {window-definition}[window-definition] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
ratio-to-report-function ::= RATIO_TO_REPORT '(' <<fn-window-ratio-to-report-args,expr>> ')' OVER ( '(' {window-definition}[window-definition] ')' | {identifier}[window-ref] )
----
