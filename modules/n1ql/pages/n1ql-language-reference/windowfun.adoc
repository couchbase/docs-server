...
[subs="normal"]
----
cume-dist-function ::= CUME_DIST '()' OVER ( '(' [ {window-partition-clause}[window-partition-clause] ] {window-order-clause}[window-order-clause] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
dense-rank-function ::= DENSE_RANK '()' OVER ( '(' [ {window-partition-clause}[window-partition-clause] ] {window-order-clause}[window-order-clause] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
lag-function ::= LAG '(' <<fn-window-lag-args,expr>> [ ',' <<fn-window-lag-args,offset>> [ ',' <<fn-window-lag-args,default>> ] ] ')' [ <<fn-window-lag-nulls>> ] OVER ( '(' [ {window-partition-clause}[window-partition-clause] ] {window-order-clause}[window-order-clause] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
lead-function ::= LEAD '(' <<fn-window-lead-args,expr>> [ ',' <<fn-window-lead-args,offset>> [ ',' <<fn-window-lead-args,default>> ] ] ')' [ <<fn-window-lead-nulls>> ] OVER ( '(' [ {window-partition-clause}[window-partition-clause] ] {window-order-clause}[window-order-clause] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
ntile-function ::= NTILE '(' <<fn-window-ntile-args,num_tiles>> ')' OVER ( '(' [ {window-partition-clause}[window-partition-clause] ] {window-order-clause}[window-order-clause] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
percent-rank-function ::= PERCENT_RANK '()' OVER ( '(' [ {window-partition-clause}[window-partition-clause] ] {window-order-clause}[window-order-clause] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
rank-function ::= RANK '()' OVER ( '(' [ {window-partition-clause}[window-partition-clause] ] {window-order-clause}[window-order-clause] ')' | {identifier}[window-ref] )
----
...
[subs="normal"]
----
row-number-function ::= ROW_NUMBER '()'  OVER ( '(' [ {window-partition-clause}[window-partition-clause] ] [ {window-order-clause}[window-order-clause] ] ')' | {identifier}[window-ref] )
----
