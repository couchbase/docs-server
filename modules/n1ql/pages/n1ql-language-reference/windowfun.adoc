...
[source,ebnf]
----
include::partial$grammar/n1ql.ebnf[tag=window-function]
----

image::n1ql-language-reference/window-function.png["Syntax diagram", align=left]
...
[source,ebnf]
----
include::partial$grammar/n1ql.ebnf[tag=window-function-arguments]
----

image::n1ql-language-reference/window-function-arguments.png["Syntax diagram", align=left]
...
[source,ebnf]
----
include::partial$grammar/n1ql.ebnf[tag=window-function-options]
----

image::n1ql-language-reference/window-function-options.png["Syntax diagram", align=left]

[horizontal.compact]
nthval-from:: <<nthval-from>> icon:caret-down[]
nulls-treatment:: <<nulls-treatment>> icon:caret-down[]
...
[source,ebnf]
----
include::partial$grammar/n1ql.ebnf[tag=nthval-from]
----

image::n1ql-language-reference/nthval-from.png["Syntax diagram", align=left]
...
[source,ebnf]
----
include::partial$grammar/n1ql.ebnf[tag=nulls-treatment]
----

image::n1ql-language-reference/nulls-treatment.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-cume-dist.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-dense-rank.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-first-value.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-lag.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-last-value.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-lead.png["Syntax diagram", align=left]
...
[source,ebnf]
----
nth-value-function ::= 'NTH_VALUE' '(' expr ',' offset ')' nth-val-from? nulls-treatment?
                       'OVER' ( '(' window-definition ')' | window-ref )
----

image::n1ql-language-reference/fn-window-nth-value.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-ntile.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-percent-rank.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-rank.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-ratio-to-report.png["Syntax diagram", align=left]
...
image::n1ql-language-reference/fn-window-row-number.png["Syntax diagram", align=left]
