...
See xref:n1ql-language-reference/correlated-subqueries.adoc[Correlated Subqueries] for more details and xref:n1ql-language-reference/subquery-examples.adoc#topic_9[Examples].
