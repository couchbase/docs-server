...
[subs="normal"]
----
select-clause ::= SELECT [ <<hints,hints>> ] <<sec_Arguments,projection>>
----
...
In Couchbase Server 7.1 and later, you can supply hints to the optimizer within a specially-formatted comment.
