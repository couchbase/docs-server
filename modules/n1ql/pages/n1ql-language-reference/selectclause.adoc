...
image::n1ql-language-reference/images/select-clause_RR_result-expr.png[,50%]

path:

image::n1ql-language-reference/images/select-clause_RR_path.png[,50%]

alias:

image::n1ql-language-reference/images/select-clause_RR_alias.png[,50%]
