...
[cols="4a,^1,^1"]
|===
| {sqlpp} Query| SELECT ALL | SELECT DISTINCT
...
[source,sqlpp]
----
EXPLAIN SELECT DISTINCT city FROM landmark; -- <1>
----
...
[source,sqlpp]
----
SELECT id, airline, stops FROM route;
----
====
...
[source,sqlpp]
----
SELECT schedule[0].day AS Weekday FROM route;
----
====
