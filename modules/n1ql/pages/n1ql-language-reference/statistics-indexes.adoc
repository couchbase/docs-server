...
indexes-clause:: [Required] Refer to <<indexes-clause>> below.
...
// TODO: Links in EBNF files
index-name:: [Alternative] A unique name that identifies an index.
subquery-expr:: [Alternative] Refer to <<subquery-expr>> below.
