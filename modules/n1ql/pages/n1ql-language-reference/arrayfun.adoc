...
Description:: This function returns a new array with all occurrences of [.in]`value1` replaced with [.in]`value2`.
+
...
Return Values:: A new array with all or [.var]`max_int` occurrences of [.in]`val1` replaced with [.in]`val2`.
+
If any of the arguments are `MISSING`, then it returns `MISSING`.
+
