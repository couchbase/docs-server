...
// Markup for future use [source,n1ql,highlight=90..92]

.Transaction
[source,n1ql,subs=macros]
----
include::example$transactions/multiple.n1ql[tags=transaction;commit-mark;!begin-mark;!set-mark;!savepoint-mark;!rollback-mark;!commit-plain]
----
