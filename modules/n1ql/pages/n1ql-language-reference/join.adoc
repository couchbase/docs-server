...
[source,N1QL]
----
include::example$select/lookup-join-1.n1ql[]
----

.Results
[source,JSON]
----
include::example$select/lookup-join-1.jsonc[]
----
====
...
.Route JOIN airline ON KEYS route.airlineid
====
List the schedule of flights from Boston to San Francisco on JETBLUE in the `route` keyspace.

[source,N1QL]
----
include::example$select/lookup-join-2.n1ql[]
----

.Results
[source,JSON]
----
include::example$select/lookup-join-2.jsonc[]
----
====
