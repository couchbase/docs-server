...
In this case, the path to the function is determined by the current xref:settings:query-settings.adoc#query_context[query context].
...
Refer to xref:n1ql-language-reference/createfunction.adoc#context[Global and Scope Functions] for more details.
