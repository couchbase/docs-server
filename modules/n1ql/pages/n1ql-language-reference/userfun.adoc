...
You can use the xref:n1ql:n1ql-language-reference/metafun.adoc#abort[ABORT()] function to check the parameters of a user-defined function and generate an error if something is wrong.
