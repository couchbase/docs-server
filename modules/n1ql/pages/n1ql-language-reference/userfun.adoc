...
When you have created a user-defined function, you can use it in any expression, just like a built-in function.
...
You must call the user-defined function using the same case that was used when it was defined.
