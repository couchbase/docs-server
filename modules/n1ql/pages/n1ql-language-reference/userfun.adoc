...
[abstract]
You can call a user-defined function in any expression where you could call a built-in function.
...
(Refer to xref:n1ql-language-reference/createfunction.adoc#create-function-inline[Inline Functions] for details about creating inline user-defined functions.)
