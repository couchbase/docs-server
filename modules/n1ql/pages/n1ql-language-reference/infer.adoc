...
The Query Workbench in the Couchbase Web console (available under the [.ui]*Query* tab) uses the INFER statement to display the structure of documents in the [.ui]*Bucket Analysis* area when you expand the keyspace name.
