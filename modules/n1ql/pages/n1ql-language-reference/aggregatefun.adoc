...
link:https://www.couchbase.com/products/editions[Enterprise Edition] | _Introduced in Couchbase Server 6.5_

[subs="normal"]
----
aggregate-function-window ::= function-name '(' [ <<aggregate-quantifier>> ] xref:n1ql-language-reference/index.adoc[expr] ')' OVER '(' xref:n1ql-language-reference/window.adoc#window-definition[window-definition] ')'
----
