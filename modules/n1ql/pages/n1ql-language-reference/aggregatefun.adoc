...
[source,n1ql]
----
SELECT ARRAY_AGG(reviews[0].ratings.Cleanliness) AS Reviews FROM `travel-sample`.inventory.hotel;
----
...
[source,n1ql]
----
SELECT ARRAY_AGG(DISTINCT reviews[0].ratings.Cleanliness) AS Reviews FROM `travel-sample`.inventory.hotel;
----
...
[source,n1ql]
----
SELECT COUNT(DISTINCT stops) AS CountOfDistinctStops FROM `travel-sample`.inventory.route;
----
...
[source,n1ql]
----
SELECT MEDIAN(geo.alt) AS MedianAltitude FROM `travel-sample`.inventory.airport;
----
...
[source,n1ql]
----
SELECT MIN(name) AS MinName FROM `travel-sample`.inventory.hotel WHERE SUBSTR(name,0)>="A";
----
...
[source,n1ql]
----
SELECT STDDEV(reviews[0].ratings.Cleanliness) AS StdDev FROM `travel-sample`.inventory.hotel WHERE city="London";
----
...
[source,n1ql]
----
SELECT STDDEV(reviews[0].ratings.Cleanliness) AS StdDevSingle FROM `travel-sample`.inventory.hotel WHERE name="Sachas Hotel";
----
...
[source,n1ql]
----
SELECT STDDEV(DISTINCT reviews[0].ratings.Cleanliness) AS StdDev FROM `travel-sample`.inventory.hotel WHERE city="London";
----
...
[source,n1ql]
----
SELECT STDDEV_POP(reviews[0].ratings.Cleanliness) AS PopStdDev FROM `travel-sample`.inventory.hotel WHERE city="London";
----
...
[source,n1ql]
----
SELECT STDDEV_POP(DISTINCT reviews[0].ratings.Cleanliness) AS PopStdDev FROM `travel-sample`.inventory.hotel WHERE city="London";
----
...
[source,n1ql]
----
SELECT STDDEV_SAMP(reviews[0].ratings.Cleanliness) AS StdDevSingle FROM `travel-sample`.inventory.hotel WHERE name="Sachas Hotel";
----
...
[source,n1ql]
----
SELECT VARIANCE(reviews[0].ratings.Cleanliness) AS Variance FROM `travel-sample`.inventory.hotel WHERE city="London";
----
...
[source,n1ql]
----
SELECT VARIANCE(reviews[0].ratings.Cleanliness) AS VarianceSingle FROM `travel-sample`.inventory.hotel WHERE name="Sachas Hotel";
----
...
[source,n1ql]
----
SELECT VARIANCE(DISTINCT reviews[0].ratings.Cleanliness) AS Variance FROM `travel-sample`.inventory.hotel WHERE city="London";
----
...
[source,n1ql]
----
SELECT VARIANCE_POP(reviews[0].ratings.Cleanliness) AS PopVariance FROM `travel-sample`.inventory.hotel WHERE city="London";
----
...
[source,n1ql]
----
SELECT VARIANCE_POP(DISTINCT reviews[0].ratings.Cleanliness) AS PopVarianceDistinct FROM `travel-sample`.inventory.hotel WHERE city="London";
----
...
[source,n1ql]
----
SELECT VARIANCE_SAMP(reviews[0].ratings.Cleanliness) AS VarianceSamp FROM `travel-sample`.inventory.hotel WHERE name="Sachas Hotel";
----
