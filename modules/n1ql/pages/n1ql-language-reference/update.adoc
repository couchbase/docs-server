...
_use-keys-clause:_ Specifies the keys of the data items to be updated.
Optional.
Keys can be any expression.

_set-clause:_ Specifies the value for an attribute to be changed.
...
_where-clause:_ Specifies the condition that needs to be met for data to be updated.
Optional.

_limit-clause:_ Specifies the greatest number of objects that can be updated.
This clause must have a non-negative integer as its upper bound.
Optional.

_returning-clause:_ Returns the data you updated as specified in the result_expression.
