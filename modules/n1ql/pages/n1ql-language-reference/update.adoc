...
[subs="normal"]
----
set-clause ::= SET <<path,path>> '=' expr [ <<update-for,update-for>> ] [ ',' <<path,path>> '=' expr [ <<update-for,update-for>> ] ]*
----
...
[subs="normal"]
----
update-for ::= ( FOR [ name-var ':' ] var ( IN | WITHIN ) <<path,path>> [ ',' [ name-var ':' ] var ( IN | WITHIN ) <<path,path>> ]* )+ [ WHEN cond ] END
----
...
[#path,subs="normal"]
----
path::= identifier [ '[' expr ']' ]* [ '.' <<path,path>> ]
----
