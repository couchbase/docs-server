...
[source,N1QL]
----
include::example$select/ansi-nest.n1ql[]
----

.Results
[source,JSON]
----
include::example$select/ansi-nest.jsonc[]
----
====
...
[source,JSON]
----
include::example$select/lookup-nest.jsonc[]
----
====
...
[source,JSON]
----
include::example$select/index-nest.jsonc[]
----
