...
[subs="normal"]
----
nest-clause ::= <<section_tc1_nnx_1db,ansi-nest-clause>> | <<nest,lookup-nest-clause>> | <<section_rgr_rnx_1db,index-nest-clause>>
----
...
* You may chain ANSI nests with comma-separated Cartesian joins; however, the comma-separated joins must come after any JOIN, NEST, or UNNEST clauses.
...
Lookup nests can be chained with other lookup joins or nests and index joins or nests, but they cannot be mixed with ANSI joins, ANSI nests, or comma-separated Cartesian joins.
...
Index nests can be chained with other index joins or nests and lookup joins or nests, but they cannot be mixed with ANSI joins, ANSI nests, or comma-separated Cartesian joins.
