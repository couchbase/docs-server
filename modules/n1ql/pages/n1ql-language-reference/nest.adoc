...
[subs="normal"]
----
ansi-nest-clause ::= [ <<ansi-nest-type,ansi-nest-type>> ] NEST <<ansi-keyspace-ref,keyspace-ref>> [ [ AS ] <<ansi-as-alias,alias>> ] <<ansi-nest-predicate,ansi-nest-predicate>>
----
...
[subs="normal"]
----
lookup-nest-clause ::= [ <<lookup-nest-type,lookup-nest-type>> ] NEST <<lookup-keyspace-ref,keyspace-ref>> [ [ AS ] <<lookup-as-alias,alias>> ] <<lookup-nest-predicate,lookup-nest-predicate>>
----
...
[subs="normal"]
----
index-nest-clause ::= [ <<index-nest-type,index-nest-type>> ] NEST <<index-keyspace-ref,keyspace-ref>> [ [ AS ] <<index-as-alias,alias>> ] <<index-nest-predicate,index-nest-predicate>>
----
