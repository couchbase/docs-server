...
====
The following statement creates a function called `locations`, which selects name and address information from all documents of the specified activity in the `landmark` keyspace.
