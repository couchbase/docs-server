...
[subs="normal"]
----
ansi-join-clause ::= [ <<ansi-join-type>> ] JOIN <<keyspace-ref>> [ [ AS ] xref:n1ql-language-reference/identifiers.adoc#identifier-alias[alias]] [ <<ansi-join-hints>> ] <<ansi-join-predicate>>
----
...
[subs="normal"]
----
index-nest-clause ::= [ <<index-nest-type>> ] NEST <<keyspace-ref>> [ [ AS ] xref:n1ql-language-reference/identifiers.adoc#identifier-alias[alias] ] <<index-nest-predicate>>
----
