...
[#window-specification,reftext="window-specification",subs="normal"]
----
window-specification ::= [ <<window-ref>> ] [ <<window-partition-clause>> ] [ <<window-order-clause>> ]
                         [ <<window-frame-clause>> ]
----

image::n1ql-language-reference/window-specification.png[]
