...
The WINDOW clause defines a named window for use 
This enables you to reuse the same window definition between two or more window functions in the same query.
