...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-clause]
----
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-declaration]
----
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-name]
----
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-definition]
----

image::n1ql-language-reference/window-definition.png["Syntax diagram", align=left]

[horizontal.compact]
window-ref:: <<window-ref>> icon:caret-down[]
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-ref]
----
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-partition-clause]
----
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-order-clause]
----
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-frame-clause]
----
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-frame-extent]
----

image::n1ql-language-reference/window-frame-extent.png["Syntax diagram", align=left]

[horizontal.compact]
valexpr:: The `_valexpr_` must be a positive constant or an expression that evaluates as a positive {number}[number].
...
[source,ebnf]
----
include::partial$grammar/dql.ebnf[tag=window-frame-exclusion]
----
