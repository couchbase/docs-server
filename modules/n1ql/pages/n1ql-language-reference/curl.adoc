...
In the Query Workbench, navigate to the *Settings > Advanced Query Settings* section as shown below: image:n1ql-language-reference/CURL_Whitelist.png[,70%]
...
Click image:n1ql-language-reference/CURL_Add_button.png[,30%] to add another URL to the list.

Click image:n1ql-language-reference/CURL_Remove_button.png[,30%] to remove a URL from the list.
