...
In the Query Workbench, navigate to the *Settings > Advanced Query Settings* section as shown below: image:n1ql-language-reference/images/CURL_Whitelist.png[]
...
Click image:n1ql-language-reference/images/CURL_Add_button.png[] to add another URL to the list.

Click image:n1ql-language-reference/images/CURL_Remove_button.png[] to remove a URL from the list.
