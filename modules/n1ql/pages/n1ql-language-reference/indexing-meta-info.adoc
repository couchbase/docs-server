...
+
_Indexable from Couchbase Server 5.0_ For details, see xref:2.5@java-sdk::concurrent-mutations-cluster.adoc[Concurrent Document Mutations].
...
+
_Indexable from Couchbase Server 5.0_ For details, see xref:2.5@java-sdk::core-operations.adoc[Core Operations].

.flags:::
Value set by the SDKs for non-JSON documents.
+
For details, see xref:2.5@java-sdk::nonjson.adoc[Non-JSON].
