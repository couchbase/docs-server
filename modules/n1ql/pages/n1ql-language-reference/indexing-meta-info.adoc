...
+
_Indexable from Couchbase Server 5.0_ For details, see xref:java-sdk::common/core-operations.adoc[Core Operations].

.flags:::
Value set by the SDKs for non-JSON documents.
+
For details, see xref:java-sdk::common/nonjson.adoc[Non-JSON].
