...
+
*Example 3*: If you don’t require the document key to be in a specific format, you can use the function xref:n1ql-language-reference/metafun.adoc[UUID()] to generate a unique key as shown here:
+
----
INSERT INTO `travel-sample` ( KEY, VALUE )
            VALUES ( UUID(),
