...
* To execute the following statement, you must have the _Query Insert_ privilege on `pass:c[hotel]`.
+
[source,sqlpp]
----
...
* To execute the following statement, you must have the _Query Insert_ and _Query Select_ privileges on `pass:c[hotel]`.
+
[source,sqlpp]
----
INSERT INTO hotel (KEY, VALUE)
...
* To execute the following statement, you must have the _Query Insert_ privilege on `pass:c[hotel]` and _Query Select_ privilege on `pass:c[`beer-sample`]`.
+
[source,sqlpp]
----
...
[source,sqlpp]
----
INSERT INTO airport (KEY UUID(), VALUE airport)
