...
See xref:settings:install-sample-buckets.adoc#topic_jqr_1rn_vs[Sample Buckets] for information on how to install the sample buckets and xref:nodejs-sdk:common:sample-application.adoc#story-h2-3[Sample Application] for details about the travel-sample data model.
