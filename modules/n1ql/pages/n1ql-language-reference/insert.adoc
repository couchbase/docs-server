...
See xref:settings:install-sample-buckets.adoc[Sample Buckets] for information on how to install the sample buckets and xref:java-sdk::common/sample-application.adoc#story-h2-3[Sample Application] for details about the travel-sample data model.
