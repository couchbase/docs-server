...
See xref:settings:install-sample-buckets.adoc[Sample Buckets] for information on how to install the sample buckets and xref:2.4@java-sdk::common/sample-application.adoc#datamodel[Travel App Data Model] for details about the travel-sample data model.
