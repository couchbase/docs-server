...
Sample buckets can be installed as explained xref:settings:install-sample-buckets.adoc#topic_jqr_1rn_vs[here].
...
[#ol_y3h_jzm_5z]
. *Adaptive Indexes are bound to the limitations of Array Indexes* because they are built over xref:n1ql-language-reference/indexing-arrays.adoc#topic_hv4_sbr_w5[Array Indexing] technology.
