...
For a partial adaptive index, you must ensure that any fields filtered by a WHERE clause in the index definition are also referenced by the {pairs}[PAIRS()] function.
