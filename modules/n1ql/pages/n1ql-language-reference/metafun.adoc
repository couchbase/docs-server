...
This function is useful for flow control in inline user-defined functions -- for example, to check parameters and abort if something is wrong.
For further details, refer to xref:n1ql:n1ql-language-reference/createfunction.adoc[CREATE FUNCTION].
