...
:description: Meta functions retrieve information about the document or item as well as perform base64 encoding.
...
For details, refer to xref:3.1@java-sdk:howtos:concurrent-document-mutations.adoc[Concurrent Document Mutations].
// end::metadata-cas[]
+
...
For details, refer to xref:3.1@java-sdk:howtos:kv-operations.adoc#document-expiration[KV Operations].
...
For details, refer to xref:3.1@java-sdk:howtos:transcoders-nonjson.adoc[Non-JSON Documents].
+
