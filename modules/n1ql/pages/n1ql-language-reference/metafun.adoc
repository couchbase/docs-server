...
[horizontal]
string:: The number of code points in the string -- equivalent to xref:n1ql-language-reference/stringfun.adoc#fn-str-length[LENGTH()].
object:: The field count -- equivalent to xref:n1ql-language-reference/objectfun.adoc#object_length[OBJECT_LENGTH()].
array:: The number of elements -- equivalent to xref:n1ql-language-reference/arrayfun.adoc#fn-array-length[ARRAY_LENGTH()].
