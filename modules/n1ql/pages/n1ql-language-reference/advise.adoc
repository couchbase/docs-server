...
[source,n1ql]
----
ADVISE SELECT * FROM `travel-sample`.inventory.hotel a WHERE a.country = 'France';
----
...
[source,n1ql]
----
ADVISE SELECT airportname FROM `travel-sample`.inventory.airport WHERE geo.alt NOT BETWEEN 0 AND 100;
----
...
[source,n1ql]
----
ADVISE SELECT * FROM `travel-sample`.inventory.landmark WHERE city LIKE "Par%" OR city LIKE "Lon%";
----
...
[source,n1ql]
----
ADVISE SELECT city FROM `travel-sample`.inventory.landmark WHERE city LIKE "Par%" OR city LIKE "Lon%";
----
...
[source,n1ql]
----
ADVISE SELECT * FROM `travel-sample`.inventory.landmark LIMIT 5;
----
