...
image::n1ql-language-reference/int.png["Syntax diagram"]
...
image::n1ql-language-reference/frac.png["Syntax diagram"]
...
image::n1ql-language-reference/exp.png["Syntax diagram"]
