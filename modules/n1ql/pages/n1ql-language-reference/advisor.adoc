...
[source,json]
----
include::example$functions/advisor-recent.jsonc[tag=current]
...
include::example$functions/advisor-recent.jsonc[tag=recommended]
...
----
...
[source,json]
----
include::example$functions/advisor-list.jsonc[tag=completed]
...
include::example$functions/advisor-list.jsonc[tag=cancelled]
----
...
[source,json]
----
include::example$functions/advisor-get.jsonc[tag=current]
...
include::example$functions/advisor-get.jsonc[tag=covering]
...
include::example$functions/advisor-get.jsonc[tag=recommended]
----
