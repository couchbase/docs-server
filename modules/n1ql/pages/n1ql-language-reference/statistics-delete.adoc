...
delete-clause:: [Required] Refer to <<delete-clause>> below.
...
// TODO: Links in EBNF files
delete-expr:: [Alternative] Refer to <<delete-expressions>> below.
delete-all:: [Alternative] Refer to <<delete-all>> below.
