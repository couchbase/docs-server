...
[subs="normal"]
----
update-statistics-delete ::= ( UPDATE STATISTICS [ FOR ] | ANALYZE [ KEYSPACE | COLLECTION ] ) <<keyspace-ref>> <<delete-clause>>
----
...
[source,n1ql]
----
UPDATE STATISTICS FOR `travel-sample` DELETE (type, city, country);
----
====
...
[source,n1ql]
----
ANALYZE KEYSPACE `travel-sample` DELETE STATISTICS (type, city, country);
----
...
[source,n1ql]
----
UPDATE STATISTICS FOR `travel-sample` DELETE ALL;
----
====
...
[source,n1ql]
----
ANALYZE KEYSPACE `travel-sample` DELETE STATISTICS;
----
