...
[source,n1ql]
----
UPDATE STATISTICS FOR `travel-sample`.inventory.hotel DELETE (city, country, free_breakfast);
----
====
...
[source,n1ql]
----
ANALYZE KEYSPACE `travel-sample`.inventory.hotel DELETE STATISTICS (city, country, free_breakfast);
----
