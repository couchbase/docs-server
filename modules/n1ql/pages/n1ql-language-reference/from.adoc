...
----
+
By using the xref:n1ql-language-reference/indexing-arrays.adoc#topic_hv4_sbr_w5[IN] clause, the right-hand side field value can match any of the elements of the left-hand side array.
