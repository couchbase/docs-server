...
[subs="normal"]
----
select-expr ::= <<select-expr-clause,subquery-expr>> [ AS ] <<select-expr-alias,alias>>
----
...
[subs="normal"]
----
generic-expr ::= xref:n1ql-language-reference/index.adoc[expr] [ AS <<generic-expr-alias,alias>> ]
----
