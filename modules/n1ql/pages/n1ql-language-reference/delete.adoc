...
*Q1 Examples* that require the _Query Delete_ privilege on ``travel-sample``.
...
*Q1 Example* that requires the _Query Delete_ privilege on ``travel-sample`` and on ``beer-sample``.
...
*Q2 Example* that requires the _Query Delete_ and _Query Select_ privilege on ``travel-sample``.
...
*Q3 Example* that requires the _Query Delete_ and _Query Select_ privilege on ``travel-sample``.
