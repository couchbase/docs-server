...
keyspace-ref:: [Required] <<keyspace-ref>>.

index-key:: [Required] <<index-key>>.

index-order:: [Optional] <<index-order>>.

index-partition:: [Optional] <<index-partition>>.

where-clause:: [Optional] <<where-clause>>.

index-using:: [Optional] <<index-using>>.

index-with:: [Optional] <<index-with>>.
