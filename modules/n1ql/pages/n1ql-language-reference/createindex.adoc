...
The following error is logged to indicate that an item is skipped when building the index: "[.out]``Encoded secondary key is too long``" in the [.path]_indexer.log_ file.
