...
:indexing-arrays-45: xref:4.5@n1ql-language-reference/indexing-arrays.adoc
...
For example, the following query <<Q7C>> uses the non-array index `def_type` ignoring the {use-index-clause}[USE INDEX hint] to use the array indexes.
