...
The following examples use the xref:settings:install-sample-buckets.adoc[travel-sample] keyspace that is shipped with the product.
...
a|
image::introduction/yes.png[,align=center]
a|
----
SELECT a
         FROM default
...
a|
image::introduction/no.png[,align=center]
a|
----
SELECT b,a
       FROM default;
