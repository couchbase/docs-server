...
.Q{counter:example-counter}: Find the list of scheduled 'UA' flights
...
====
.C{counter:example-counter}: Create an index on flight IDs scheduled in the first 4 days of the week
...
.Q{counter:example-counter}: Find the list of scheduled 'UA' flights on day 1
...
.Q{counter:example-counter}: Find the list of scheduled 'FL' flights that have one or more stops
...
.Q{counter:example-counter}: Use nested ANY operator to use the index
...
.Q{counter:example-counter}A: Use UNNEST operators to use the index
...
.Q{counter:example-counter}: Find the list of scheduled 'US681' flights on day 2
...
.Q{counter:example-counter}: Find details of all route documents matching a specific schedule
...
.Q{counter:example-counter}A: Find details of all route documents matching a specific schedule
...
.Covered Array Index
====
.C{counter:example-counter}: Creating a Covered Array Index
...
.Q{counter:example-counter}: Covered Array Index using the ANY clause
...
.Q{counter:example-counter}A: Covered Array Index using the ANY AND EVERY clause
...
.Q{counter:example-counter}B: Covered Array Index using the UNNEST clause and aliasing
...
.Q{counter:example-counter}C: Non-array index with an ALL array index
...
.C{counter:example-counter}: Creating an Implicit Covered Array Index with DISTINCT
...
.Q{counter:example-counter}: Implicit Covered Array Index using the ANY clause
...
.Q{counter:example-counter}A: UNNEST covered with the ALL index
...
.Q{counter:example-counter}B: UNNEST not covered when using the DISTINCT index
