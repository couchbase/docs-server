...
.Query B: Find the week day delta flights FROM SFO TO ATL
[[Q3,Query B]]
[source,N1QL]
----
...
[[example-5]]
.Indexing nested arrays multiple fields from different levels.
====
...
[[example-6]]
.Alternative with FLATTEN_KEYS of index `ixf_sched`
====
...
This is a variant of <<Q7>> using UNNEST in the SELECT statement.
====
