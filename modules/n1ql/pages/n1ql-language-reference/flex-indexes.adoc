...
Starting with Couchbase Server 6.6, it is also possible to use a full-text index within a N1QL query that does not contain a search function.
...
In this index definition, the following fields may be searched within a query:
