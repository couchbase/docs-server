...
|**request_time.count** +
__optional__|Total end-to-end time to process all queries.|integer
...
|**result_size.count** +
__optional__|Total size of data returned by the query engine.|integer
|**scan_plus.count** +
...
|**service_time.count** +
__optional__|Time to execute all queries.|integer
|**unbounded.count** +
