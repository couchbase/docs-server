...
| enum
| Optional.
Specify the consistency guarantee or constraint for index scanning using one of the following values: [.input]`not_bounded` (default), [.input]`request_plus`, [.input]`statement_plus`, and [.input]`at_plus`.
