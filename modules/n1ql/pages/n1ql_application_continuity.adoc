...
:description: No special strategy is required to ensure N1QL application continuity during Couchbase Server upgrades if you are already running Couchbase Server 5.0 or later.
