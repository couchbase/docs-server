...
. To pause, under menu:Ongoing Replications[Status], click the [.uicontrol]*Replicating* icon to pause the replication.
+
[#image_ltl_q25_zs]
image::xdcr-pause-resume.png[,720,align=left]

. To resume, under menu:Ongoing Replications[Status], click the [.uicontrol]*Paused* triangle icon to continue replicating.
