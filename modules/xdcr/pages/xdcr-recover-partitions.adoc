...
image::XdcrCbRecoveryLocalServersUp.png[,880,align=left]
...
image::XdcrCbRecoveryReplicationScreen.png[,880,align=left]
...
[#local_servers_down]
image::XdcrCbRecoveryLocalServersDown.png[,740,align=left]
...
image::XdcrCbRecoveryLocalServersBackUpAgain.png[,740,align=left]
+
