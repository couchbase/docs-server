...
* 2.0.0: http://packages.couchbase.com/clients/connectors/spark/2.0.0/Couchbase-Spark-Connector_2.10-2.0.0.zip[Download (Scala 2.10)^] | http://packages.couchbase.com/clients/connectors/spark/2.0.0/Couchbase-Spark-Connector_2.11-2.0.0.zip[Download (Scala 2.11)^] | http://docs.couchbase.com/sdk-api/couchbase-spark-connector-2.0.0/[API Reference^]
