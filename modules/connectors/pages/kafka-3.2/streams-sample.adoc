...
Connector configuration is accessible in the "Kafka Connect" section: image:kafka-3.2/images/kafka3-kafka-connect.png[,570]
...
Once the connector class is selected, the UI will render a list of all accessible configuration properties: image:kafka-3.2/images/kafka3-setup-source-connector.png[,570]
