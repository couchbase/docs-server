...
[#policyToolInitial]
image::elasticsearch-2.2/policyToolInitial.png[,480,align=left]
...
image::elasticsearch-2.2/policyToolPolicyEnter01.png[,480,align=left]

Left-click on the btn:[Add Permission] button.
The [.ui]*Permissions* dialog appears

[#policyToolFirstEntry]
image::elasticsearch-2.2/policyToolFirstEntry.png[,480,align=left]
...
image::elasticsearch-2.2/policyToolAuthPermission.png[,480,align=left]

. Open the [.ui]*Target Name* drop-down menu, and select [.ui]*modifyPrincipals*.
+
[#policyToolModifyPrincipals]
image::elasticsearch-2.2/policyToolModifyPrincipals.png[,480,align=left]

. Left-click the btn:[OK] button.
+
[#policyToolClickOK]
image::elasticsearch-2.2/policyToolClickOK.png[,320,align=left]
+
The [.ui]*Policy Entry* dialog now appears as follows:
+
[#policyToolpolicyEntryFirstEntry]
image::elasticsearch-2.2/policyToolpolicyEntryFirstEntry.png[,360,align=left]
...
image::elasticsearch-2.2/policyToolSocketPermission.png[,480,align=left]
...
[#policyTooldone]
image::elasticsearch-2.2/policyTooldone.png[,480,align=left]
