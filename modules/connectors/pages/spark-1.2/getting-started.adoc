...
Here is a reference to the http://docs.couchbase.com/sdk-api/couchbase-spark-connector-1.2.1/[Scala docs^].
...
----
// Spark SQL Setup
val sql = new SQLContext(sc) /*setup your spark context as usual*/
