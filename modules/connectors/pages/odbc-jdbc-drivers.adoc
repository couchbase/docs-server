...
We have developed our own xref:power-bi-connector::index.adoc[Power BI connector],
which uses an ODBC driver to connect https://www.microsoft.com/en-us/power-platform/products/power-bi[Power BI] to Couchbase Analytics/Columnar.

We have also developed xref:tableau-connector::index.adoc[Tableau Connector] that links to link https://www.tableau.com[Tableau] to Couchbase Analytics/Columnar using a JDBC driver.
