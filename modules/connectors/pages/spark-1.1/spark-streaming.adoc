...
Since DStreams are RDDs, the same persistence mechanisms apply (see xref:spark-1.1/working-with-rdds.adoc#spark-working-with-rdds[Working with RDDs] for more information).
