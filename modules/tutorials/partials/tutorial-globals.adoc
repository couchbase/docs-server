...
:point-to-capella: pass:q[This tutorial is designed for use with standalone or Docker installations of the Couchbase Server. If you wish to use  https://www.couchbase.com/products/capella[Couchbase Capella (the cloud service)] then you can run the https://docs.couchbase.com/cloud/get-started/get-started.html[Getting Started with Couchbase Capella] tutorials.]
