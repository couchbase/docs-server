...
So you have your cluster, bucket, scope and collections set up and ready to be populated. In the next section (xref:java-tutorial/install-couchbase-java-sdk.adoc[]), you'll set up your system to write your first Couchbase application.

:previous-page: xref:install-couchbase-server.adoc[]
:next-page: xref:java-tutorial/install-couchbase-java-sdk.adoc[]
