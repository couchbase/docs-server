...
Now you can add and search for records, the next section will consolidate what you've learned so far by demonstrating how to amend existing records by adding enrolment details. So when you're ready carry on to xref:adding-enrolments.adoc[]
