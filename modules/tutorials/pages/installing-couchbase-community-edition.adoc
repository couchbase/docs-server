...
== What's next …?
So you have a database. Next thing to do is add stuff to it and retrieve it again from the administration page. Later, you're going to get a feel for the Couchbase SDK{sdk-footnote} by building a small command line application to add records to the database. 
