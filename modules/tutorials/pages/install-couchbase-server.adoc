...
+
--
Instructions for provisioning a Couchbase server as a cloud instance can be found on xref:cloud::index.adoc[] site.
--
====
...
== What's next …?
Now you have installed the server and created a cluster, the next thing to do is create the database where you're going to store your documents. In xref:buckets-scopes-and-collections.adoc[] you will also learn other ways in which Couchbase allows you to logically partition your data.

:previous-page: xref:getting-started.adoc[]
:next-page: xref:buckets-scopes-and-collections.adoc[]
