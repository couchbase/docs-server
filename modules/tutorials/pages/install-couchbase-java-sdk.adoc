...
Even without any of your own source code, `maven` will still build a jar file in a freshly-created `target` folder.
You can use the

== What next …?

You're now ready to write your xref:first-couchbase-application.adoc[first Couchbase application].
