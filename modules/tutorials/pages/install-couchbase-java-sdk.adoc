...
[abstract]
In this tutorial, you're going to create a skeleton application for interacting with the student database you created in xref:installing-couchbase-community-edition.adoc[]
