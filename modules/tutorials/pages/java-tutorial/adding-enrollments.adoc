...
----
<1> As you'll remember from our xref:java-tutorial/creating-students.adoc#connecting-to-the-database[first example], the application first has to connect to the Couchbase cluster.
