...
<1> As you'll remember from our xref:first-couchbase-application.adoc#connecting-to-the-database[first example], the application first has to connect to the Couchbase cluster
