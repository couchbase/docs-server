...
image::admin/web-console-server-stats-tapqueues.png[,720]
...
image::admin/outbound_xdcr_2.2.png[outbound xdcr stats 2.2,720,align=left]
...
image::admin/inbound_xdcr_web_console.png[,720]
...
image::admin/web-console-server-stats-views.png[,720]
