...
See the documentation for xref:cli:cbcli-intro.adoc[couchbase-cli], xref:cli:cbstats-intro.adoc[cbstats], and xref:rest-api:rest-intro.adoc[REST API] for further details about using these interfaces into Couchbase Server’s operational information.
