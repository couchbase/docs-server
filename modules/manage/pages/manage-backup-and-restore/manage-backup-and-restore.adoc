...
From the *Backup* facility's *Data* screen, individual backups can be deleted.
...
*Disable Safe Remove Check* allows deletion of backups even if other incremental backups depend on them.

CAUTION: This can break backup cycles and make dependent backups invalid.

If you try to delete a backup that has dependent incremental backups, the following warning dialog appears.
