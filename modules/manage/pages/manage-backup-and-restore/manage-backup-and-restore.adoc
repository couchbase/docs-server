...
To set the property Disable the Safe Remove Check or `disable_safe_remove_check` in the API call, see xref:rest-api:backup-delete-backups.adoc[Delete a Backup].
...
* That backup's retention period should be expired.
