...
+
The *Couchbase Bucket* should be the name of either a _Couchbase_ or an _Ephemeral_ bucket, whose data is to be backed up.
...
Alternatively, cloud storage can be selected, from the *Storage Locations* field of the *Create Plan* dialog.
