...
* JWT: Integration with identity providers that issue JSON Web Tokens (JWTs), for authenticating the Web Console, clients, the CLI, and the REST API.
See xref:manage:manage-security/manage-jwt.adoc[JWT Authentication].
