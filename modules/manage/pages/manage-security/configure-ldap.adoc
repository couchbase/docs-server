...
*Filter* is the  https://ldap.com/ldap-filters/[search filter^]: `%u` will be replaced by the username that has been presented to Couchbase Server by the user who is attempting to gain access.
