...
Once a mapping has been defined between and LDAP group and a Couchbase-Server user-group, it can be edited.
Proceed as follows:
...
To display the _roles_ view, left-click on the *Roles* tab, towards the upper right:
+
...
+
This confirms the existence of user-group `Admins`.

. Left-click on the row displayed for this group.
