...
Once all appropriate setting have been made to *LDAP Host(s)*, *Encryption*, *Certificate*, and *Contact LDAP host* fields, optionally, the *Check Network Settings* button can be left-clicked on.
