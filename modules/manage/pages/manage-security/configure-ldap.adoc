...
==== Traverse Nested Groups, for User Attributes Search
...
==== Test Groups Query, for User Attributes Search
...
See the description provided above, in
 xref:manage:manage-security/configure-ldap.adoc#traverse-nested-groups-for-user-attributes[Traverse Nested Groups, for User Attributes Search]

[#test-groups-query-for-ldap-query]
==== Test Groups Query, for LDAP Query

See the description provided above, in xref:manage:manage-security/configure-ldap.adoc#test-groups-query-for-ldap-query[Test Groups Query, for User Attributes Search]
