...
The *ADD USER* tab allows individual users to be added, and allow their authentication to be optionally specified as *external*.
...
Note that `%u` will be replaced by the username that has been presented to Couchbase Server by the user who is attempting to gain access.
