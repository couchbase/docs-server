...
The *Advanced Query* option lets you supply a list of regular expressions and replacement strings for Couchbase Server try to match the username. 
When you select the *Advanced Query* option, a *Template* text edit box appears for you to enter your list. 

image::manage-security/ldapAdvancedQuery.png[,632,align=left]

You enter your the regular expressions and replacement strings as a JSON list. 
...
If this regular expression matches, Couchbase Server uses the address as the user ID and the domain name as the organization unit.
