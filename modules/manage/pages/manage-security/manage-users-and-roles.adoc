...
To create a group with a bucket-related role (for example, *Data Reader*), have entered a *Group Name* into the *Add New Group* dialog, access the *Data* category, in the *Roles* panel.
