...
which provides options for redefining full name, roles, and groups (the content of this dialog is similar to that of the [.ui]*Add New User* dialog, examined above).
...
Note that the *Users & Groups* panel, following the definition of a user, displays two buttons towards the upper right, whereby *Users* and *Groups* views can be accessed in turn.
...
For example, the *Query System Catalog* role can be assigned to the user; and the user then assigned to the *ClusterAdmins* group, whereby the *Cluster Admin* role is granted.
