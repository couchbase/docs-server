...
This example shows that a single group named `DataReaderGroup` is defined on the cluster and the `data_reader` role is assigned to it, for the specified collections.
