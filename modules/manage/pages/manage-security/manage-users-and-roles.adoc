...
Note that if a group still containing one or more users is deleted, those users are directly assigned the roles they previously held through membership of the now-deleted group, and thereby retain their privileges.
...
Note that on the group's deletion, group-members are individually assigned the roles they previously held through group-membership, and thereby retain their privileges.
