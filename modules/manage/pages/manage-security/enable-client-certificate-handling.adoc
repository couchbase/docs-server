...
This should be expressed as a _Subject Alternative Name_.
However, some clients may provide express their username as a _Subject Common Name_, even though this is now deprecated (see xref:learn:security/certificates.adoc#deprecation-of-subject-common-name[Deprecation of Subject Common Name]).
+
...
(Note also, however, that although use of _Subject Common Name_ in certificates is still common, it is now deprecated: see xref:learn:security/certificates.adoc#deprecation-of-subject-common-name[Deprecation of Subject Common Name].)
+
