...
You can use the xref:rest-api:rest-auditing#pruneAge[`pruneAge`] parameter of the `settings/audit` REST API to have Couchbase Server automatically delete log files based on their age.
