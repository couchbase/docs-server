...
== Configuring Auditing with the CLI
...
== Inspecting Audit Events with the REST API

For information on inspecting audit events with the REST API, see xref:rest-api:rest-auditing.adoc[Auditing API].
