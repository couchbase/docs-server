...
The _default_ certificates provided automatically by Couchbase Server &#8212; including the _root_ certificate and each of the _node_ certificates for the cluster &#8212; can be _regenerated_ at any time, by means of the REST API.
This means that the administrator-uploaded certificates are removed, and default certificates re-substituted.
For information, see xref:rest-api:rest-regenerate-all-certs.adoc[Regenerate All Certificates].
