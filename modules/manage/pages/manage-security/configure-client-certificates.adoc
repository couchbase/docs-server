...
A sample Java program, which accesses a keystore from a local filesystem, is provided in  xref:2.6@java-sdk::sdk-authentication-overview.adoc#authenticating-a-java-client-by-certificate[Authenticating a Java Client by Certificate].
