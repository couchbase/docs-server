...
+
image::import-documents/leftClickOnImportButton.png[,160,align=left]
+
...
+
image::import-documents/importButtonWithNotification.png[,160,align=left]

. Check the imported documents.
To check the imported documents, left-click on the *Document Editor* tab, on the horizontal, upper navigation bar:
+
