...
* The *cbimport csv* command-line utility, which imports documents that contain data in CSV, TSV, and other _separated value_ files.
...
The default value is *CSV*; and this is therefore displayed before any file has been selected.
