...
XDCR _timestamp-based_ conflict resolution can be monitored, as described in xref:manage:monitor/xdcr-monitor-timestamp-conflict-resolution.adoc[Monitor XDCR Timestamp-based Conflict Resolution].
