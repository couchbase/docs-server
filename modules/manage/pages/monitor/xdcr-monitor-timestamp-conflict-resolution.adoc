...
:description: Various aspects of XDCR timestamp-based conflict resolution should be \
monitored.
:page-aliases: xdcr:xdcr-monitor-timestamp-conflict-resolution

{description} This can be achieved by means of both Couchbase Web Console and
