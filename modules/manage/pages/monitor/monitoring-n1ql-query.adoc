...
|**#language** +
__required__
|The language of the function, for example, inline.
|String
...
|**namespace** +
__required__
|The namespace of the function, for example, default.
|String
...
|**type** +
__required__
|The type of the function, for example, global.
|String
...
|**class** +
__required__
|The class of the task; for example, `advisor`.
|string
...
|**state** +
__required__
|The class of the task -- `scheduled`, `cancelled`, `completed`.
|string

|**subClass** +
__required__
|The subclass of the task; for example, `analyze`.
|string
