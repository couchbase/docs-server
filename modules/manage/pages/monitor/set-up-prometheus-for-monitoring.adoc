...
<.> The username the process uses to log into the cluster.
<.> The password the process uses to log into the cluster.
<.> The name of target file. 
The process will use this to read the addresses of the target nodes.
