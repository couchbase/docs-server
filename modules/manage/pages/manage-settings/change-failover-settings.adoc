...
See xref:understanding-couchbase:clusters-and-availability/automatic-failover.adoc[Automatic Failover] for more information.
...
xref:understanding-couchbase:clusters-and-availability/groups.adoc[Groups].
