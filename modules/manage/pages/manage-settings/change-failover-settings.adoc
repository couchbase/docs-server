= Node Availability
:page-aliases: settings:change-failover-settings
...
For information on groups and _Server Group Awareness_, see xref:learn:clusters-and-availability/groups.adoc[Groups].
