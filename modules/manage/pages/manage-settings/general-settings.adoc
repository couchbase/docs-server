...
[abstract]
The [.ui]*General* panel can be used to establish settings for the cluster.
...
The *Node Availability* screen also contains an *Enable auto-reprovisioning* option, for Ephemeral Buckets
