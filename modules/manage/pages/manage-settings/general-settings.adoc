...
=== Statistics Settings via REST

In Couchbase Server Enterprise Edition, you can use the `/setting/stats` endpoint to turn off reporting of cluster statistics back to Couchbase:
