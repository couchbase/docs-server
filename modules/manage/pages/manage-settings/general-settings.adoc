...
NOTE: The *Reader Thread Settings* and the *Writer Thread Settings* only apply to disk-based buckets. Changing these setting will have no effect on clusters that contain only ephemeral (memory-based) buckets.
