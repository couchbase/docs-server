...
To set the number of reader and or writer threads for Couchbase Server, use the `POST /pools/default/settings/memcached/global` http method and endpoint, as follows:
