...
For additional details on all the Query settings in the lower section of the panel, see the xref:rest-api:rest-cluster-query-settings.adoc#_settings[Query Settings REST API].
...
For additional information, see xref:rest-api:rest-cluster-query-settings.adoc[Cluster Query Settings API].
