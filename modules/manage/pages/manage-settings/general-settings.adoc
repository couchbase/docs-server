...
* *Num Replica*.
The number of index replicas to be used.

* *Optimize Index Placement On Rebalance*.
When checked, the *Enable Redistribute Indexes* allows Couchbase Server to redistribute indexes when rebalance occurs, in order to optimize performanced.
