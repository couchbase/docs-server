...
+
[#add-bucket-button]
image::managing-settings/addBucketButton.png[,120,align=left]
+
...
image::managing-settings/show-advanced-settings.png[,360,align=left]
+
...
image::managing-settings/override-default-auto-compaction.png[,370,align=left]
+
...
image::managing-settings/edit-bucket-definition-button.png[,300,align=left]
+
...
+
[#auto_compaction_tab]
image::managing-settings//auto-compaction-tab.png[,360,align=left]
+
...
image::managing-settings/auto-compact-defaultNewUI.png[,820,align=left]
...
image::managing-settings/database-fragmentationNewUI.png[,360,align=left]
...
image::managing-settings/view-fragmentation-interface.png[,360,align=left]
...
image::managing-settings/time-interval-interface.png[,310,align=left]
...
image::managing-settings/time-interval-interface-completed.png[,310,align=left]
...
image::managing-settings/meta-data-purge-interface.png[,390,align=left]
