...
Note that Auto-Compaction settings can also be modified using the `/controller/setAutoCompaction` REST method:
...
See xref:rest-api:rest-autocompact-get.adoc[Setting Auto-Compaction] for more information.
