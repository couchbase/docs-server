= Auto-Compaction
:description: pass:The auto-Compaction settings controls if and when Couchbase Server compacts data files and view indexes.]
...
By default, Couchbase Server performs auto-compaction all Couchbase buckets.
...
The *Time Interval* section lets you limit he hours where Couchbase Server can compact Couchstore buckets. 
