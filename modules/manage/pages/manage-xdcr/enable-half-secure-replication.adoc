...
xref:manage:manage-xdcr/enable-half-secure-replication.adoc#enable-half-secure-replications-with-the-ui[UI],
the
xref:manage:manage-xdcr/enable-half-secure-replication.adoc#enable-half-secure-replications-with-the-cli[CLI],
and the
xref:manage:manage-xdcr/enable-half-secure-replication.adoc#enable-half-secure-replications-with-the-rest-api[REST
