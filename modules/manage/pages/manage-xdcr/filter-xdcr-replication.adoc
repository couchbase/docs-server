...
Note that when entered by means of _UI_, the expression can be a maximum of 250 bytes (characters) in length: this restriction does _not_ apply to expressions entered by means of the _CLI_ or the _REST API_.
