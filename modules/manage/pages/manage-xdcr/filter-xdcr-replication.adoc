...
-u Administrator -p password --create --xdcr-cluster-name 10.144.210.102 \
...
This expression specifies that all documents filtered by means of the specified `filter-expression` will be replicated from `travel-sample`, on the localhost `10.144.210.101`, to `US_airport` on the remote cluster `10.144.210.102`.
