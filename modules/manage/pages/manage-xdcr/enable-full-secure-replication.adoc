...
. Copy and paste the client certificate prepared for the local cluster into the middle interactive pane.
. Copy and paste the client private key generated for the local cluster into the bottom interactive pane.
