...
. Click on the *Edit* button, located at the right-hand side of the row:
...
. Click on the *Save* button, at the lower-right of the dialog.
...
Clicking on the *Add Remote Cluster* button, located at the upper-right of the *XDCR Replications* screen, brings up the *Add Remote Cluster* dialog.
