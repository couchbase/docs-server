...
xref:manage:manage-xdcr/delete-xdcr-replication.adoc#delete-an-xdcr-replication-with-the-ui[UI],
the
xref:manage:manage-xdcr/delete-xdcr-replication.adoc#delete-an-xdcr-replication-with-the-cli[CLI],
and the
xref:manage:manage-xdcr/delete-xdcr-replication.adoc#delete-an-xdcr-replication-with-the-rest-api[REST
API]
...
image::manage-xdcr/xdcr-ongoing-replications-after-deletion.png[,800,align=middle]
...
xref:manage:manage-xdcr/delete-xdcr-replication.adoc#examples-on-this-page-delete-xdcr-replication[Examples on This Page],
...
xref:manage:manage-xdcr/pause-xdcr-replication.adoc#pause-an-xdcr-replication-with-the-cli[Pause an
...
From the starting-point defined above, in
xref:manage:manage-xdcr/delete-xdcr-replication.adoc#examples-on-this-page-delete-xdcr[Examples on This Page],
...
xref:manage:manage-xdcr/pause-xdcr-replication.adoc#pause-an-xdcr-replication-with-the-rest-api
