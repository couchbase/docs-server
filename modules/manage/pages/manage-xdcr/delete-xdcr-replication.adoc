...
. To delete the replication, left-click on the `Delete` tab, which appears near the right-hand side of the row:
+
...
The *Ongoing Replications* panel now reappears, showing no replications:
+
