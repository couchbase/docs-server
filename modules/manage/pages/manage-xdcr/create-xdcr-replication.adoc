...
For information about the bucket property `enableCrossClusterVersioning`, see xref:learn:clusters-and-availability/xdcr-enable-crossclusterversioning.adoc[XDCR enableCrossClusterVersioning].

The additional settings are as follows:

* *Specify collections for storing conflict logs and documents*: Use this setting to enable choosing conflict collections for storing conflict logs and documents.
...
* *Enable Conflict Logging*: Use this setting to enable or disable conflict logging for the replication.
When enabled, XDCR starts logging conflicts in the specified bucket, scope, and collection.

* *Default Conflict Log Collection*: Use this setting to specify the default bucket, scope, and collection for conflict logging.
...
* *Customise Conflict Logging at scope level*: Use this setting to specify the scope for a custom conflict collection.
+
image::manage-xdcr/customise-conflict-logging-at-scope.png[,800,align=left]

* *Customise Conflict Logging at collection level*: Use this setting to specify a custom collection to store conflict logs.
