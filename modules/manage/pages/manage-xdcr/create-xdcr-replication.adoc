...
The information for the above incoming replications is retrieved using the REST API. See xref:rest-api:rest-xdcr-identify-target-cluster.adoc#complete-response[Cluster with replication specifications - a full example].
