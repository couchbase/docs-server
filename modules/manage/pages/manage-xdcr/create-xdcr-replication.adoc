...
The *XDCR Add Replication* page displays the following additional settings, which are specific to XDCR Conflict Logging:
...
+
image::manage-xdcr/customise-conflict-logging-at-collection.png[,400,align=left]
