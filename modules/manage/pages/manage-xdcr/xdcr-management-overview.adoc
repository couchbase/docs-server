...
xref:understanding-couchbase:clusters-and-availability/xdcr-overview.adoc[Cross
Data Center
...
xref:understanding-couchbase:clusters-and-availability/xdcr-monitor-timestamp-conflict-resolution.adoc[Monitoring XDCR].
