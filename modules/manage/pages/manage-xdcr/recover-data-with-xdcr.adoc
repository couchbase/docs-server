...
(Note that the following steps assume knowledge of xref:manage:manage-nodes/hard-failover.adoc#hard-failover-of-multiple-nodes[Hard Failover of Multiple Nodes].)
...
images::manage-xdcr/unsafeModeWarning.png[,440,align=left]

For information, see xref:manage:manage-nodes/hard-failover.adoc#hard-failover-of-multiple-nodes[Hard Failover of Multiple Nodes].
...
images::manage-xdcr/clusterFollowingUnsafeFailover.png[,620,align=left]
