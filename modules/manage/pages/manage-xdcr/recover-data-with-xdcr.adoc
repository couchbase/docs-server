...
image::manage-xdcr/XdcrCbRecoveryLocalServersUp.png[,880,align=left]
...
image::manage-xdcr/XdcrCbRecoveryReplicationScreen.png[,880,align=left]
...
the REST API. See
xref:manage:manage-xdcr/monitor-xdcr-replication.adoc[Monitor
a Replication].
