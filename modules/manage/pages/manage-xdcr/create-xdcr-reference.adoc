...
This instructs XDCR to use gRPC over HTTPS instead of direct node-to-node TCP connections.
The default port for CNG-based XDCR connections is *18098*.
Ensure your load balancer or gateway is configured to route traffic on this port.
