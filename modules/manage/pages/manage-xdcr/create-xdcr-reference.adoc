...
+
You can use either an alternate or an internal network IP address based on the Hostname:

** *Auto*: Automatically selects the specified Hostname.
** *Force using alternate address*: Enforces the use of an alternate IP addresses, which is external or remote.
** *Force using internal address*: Enforces the use of default IP addresses, which is internal.
+
