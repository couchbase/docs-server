...
For *IP/Hostname*, specify the IP address (if appropriate, the _alternate address_) or the hostname of the target cluster: in this case, the IP address to be used is `10.144.210.102`.
