...
+
You can use either an alternate or internal network IP address based on the Hostname:

** default: Enforces the use of internal IP addresses.
** external: Enforces the use of alternate IP addresses.
+
