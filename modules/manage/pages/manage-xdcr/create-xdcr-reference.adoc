...
** *Auto*: Automatically selects the appropriate IP address type.
** *Force using alternate address*: Enforces the use of an alternate IP addresses, which is external.
** *Force using internal address*: Enforces the use of internal IP addresses, which is default.
+
