...
NOTE: Ensure you check the details of usage, limitations, and information about how to read the output reports in the https://github.com/couchbase/xdcrDiffer?tab=readme-ov-file#readme[xdcrDiffer ReadMe].
