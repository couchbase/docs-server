...
All the settings contained here are described in detail for the [.ui]*Add Data Bucket* dialog, in the section xref:manage-buckets/create-bucket.adoc[Create a Bucket]
