...
+
Note that you can also set the conflict resolution method using the CLI
xref:cli:cbcli/couchbase-cli-bucket-create.adoc[bucket-create] command, or the xref:rest-api:rest-bucket-create.adoc[REST API].
...
+
[#new_bucket_display]
image::manage-buckets/newBucketDisplay.png[,720,align=left]
+
