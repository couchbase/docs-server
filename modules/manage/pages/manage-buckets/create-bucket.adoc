...
[abstract]
_Full_ and _Cluster_ Administrators can use Couchbase Web Console, the CLI, or the REST API to create a bucket: this section takes you through the procedures provided by Couchbase Web Console, step by step.
