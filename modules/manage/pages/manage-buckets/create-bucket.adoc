...
* *Storage Backend*: Allows selection of either *CouchStore* or *Magma*, for the storage backend used for the bucket.
This option is only provided for Couchbase buckets.
