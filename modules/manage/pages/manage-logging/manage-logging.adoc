...
| Log to record attempts to access the Analytics Service.

| `analytics_cbas_debug.log`
| Debugging information, related to the Analytics Service.

| `analytics_dcpdebug.log`
| Debugging information, related to DCP errors encountered by the Analytics Service.

| `analytics_dcp_failed_ingestion.log`
| Debugging information, related to failures encountered by the Analytics Service during the gathering of data for the creation or update of indexes.

| `analytics_debug.log`
| General debugging information, related to the Analytics Service.

| `analytics_error.log`
| Errors that have occurred in the Analytics Service.

| `analytics_info.log`
| General information on the Analytics Service.

| `analytics_shutdown.log`
| Information concerning the shutting down of the Analytics Service.

| `analytics_warn.log`
| Warning messages, related to Analytics Service activity.
