...
An example of the *Buckets* screen with xref:manage:manage-buckets/delete-bucket.adoc#new_bucket_display[two buckets displayed] is provided in xref:manage:manage-buckets/delete-bucket.adoc[Delete a Bucket].
...
Information on all is provided in xref:manage:manage-settings/manage-settings.adoc[Manage Settings].
