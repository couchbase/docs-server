...
For information on using the Query Workbench to make {sqlpp} queries, see xref:getting-started:try-a-query.adoc[Run Your First {sqlpp} Query], which is part of the _Getting Started_ sequence.
