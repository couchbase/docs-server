...
See the xref:n1ql:n1ql-language-reference/index.adoc[N1QL Language Reference] for information.
...
Left-clicking on the *Index Stats* tab provides a graphical display of statistics for the index.
