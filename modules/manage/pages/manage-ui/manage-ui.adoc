...
To access the *Vector Indexes* screen, left-click on the tab in the left-hand navigation bar:

[#console-vectors-tab]
image::manage-ui/vectorTab.png[,100,align=left]

This brings up the *Vector Indexes* screen:

[#console-vectors-screen]
image::manage-ui/vectorScreen.png[,700,align=left]
...
* For more information about creating a Search Vector Index, see xref:vector-search:create-vector-search-index-ui.html[].
...
image:manage-ui/vectorScreenWithIndexes.png[,700,align=left]
