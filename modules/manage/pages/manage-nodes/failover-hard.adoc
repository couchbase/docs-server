...
If the checkbox for each of these nodes is selected, and the *Failover Nodes* button is left-click, the following dialog appears:

image::manage-nodes/hardFailoverDangerDialog.png[,400,align=middle]

This indicates that hard failover of these nodes is dangerous; and should only be attempted if there is no alternative.
