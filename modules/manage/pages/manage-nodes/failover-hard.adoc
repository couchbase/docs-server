...
If you wish to perform a hard failover on multiple nodes, select those nodes from the checkboxes, then left-click on the *Failover Nodes* button, to start an _unsafe_ hard failover.
