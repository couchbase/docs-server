...
+
To continue with hard failover, confirm your choice by clicking btn:[Failover Node].
+
[WARNING]
====
...
image::manage-nodes/hardFailoverWithDataLoss.png[,500]
 
In this case, you must select  *Confirm failover* and click btn:[Failover Node] to continue the hard failover.
 
Continuing the failover results in data loss. 
====
+
