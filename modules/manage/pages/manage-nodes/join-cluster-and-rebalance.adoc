...
Note, at this point, the figure under the *Items* column for for `10.142.181.101`: this is `61.1 K/0`, which indicates that the node contains 63.1 K items in _active_ vBuckets, and 0 items in _replica_ vBuckets.
