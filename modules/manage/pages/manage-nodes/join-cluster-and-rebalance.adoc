...
In production and similar contexts, nodes should be joined in a secure fashion, over an administrator-configured, encrypted TLS connection.
The node to be joined should be properly validated first, then joined.
