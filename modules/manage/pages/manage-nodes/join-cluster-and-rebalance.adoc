...
To ensure cluster-security, in Couchbase Server 7.1.1 and later versions, restrictions can be placed on joining, based on the establishment of _node-naming conventions_.
