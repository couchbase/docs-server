...
xref:manage:manage-nodes/list-cluster-nodes.adoc#list-nodes-with-the-ui[UI], the xref:manage:manage-nodes/list-cluster-nodes.adoc#list-nodes-with-the-cli[CLI],
and the
...
the details used in the Couchbase Web Console `Statistics` panel, described
