...
xref:manage:manage-nodes/failover-graceful.adoc#graceful-failover-with-the-ui[UI],
the
xref:manage:manage-nodes/failover-graceful.adoc#graceful-failover-with-the-cli[CLI],
and the
xref:manage:manage-nodes/failover-graceful.adoc#graceful-failover-with-the-rest-api[REST
