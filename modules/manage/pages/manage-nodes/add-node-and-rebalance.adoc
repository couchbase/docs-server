...
In such a context, a node can be added to the cluster only after conformant administrator-configured certificates are loaded to the node. Such activities must be performed in addition to those shown by the examples on this page.
