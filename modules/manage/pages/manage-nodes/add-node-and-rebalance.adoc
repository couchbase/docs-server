...
In such a context, no node can be added to the cluster until conformant administrator-configured certificates have been loaded onto it such activities must be performed in addition to those shown by the examples on this page.
