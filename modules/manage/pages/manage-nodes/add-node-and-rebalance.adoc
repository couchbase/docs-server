...
In production and similar contexts, nodes should be added in a secure fashion, over an administrator-configured, encrypted TLS connection.
The node to be added should be properly validated first, then added.
