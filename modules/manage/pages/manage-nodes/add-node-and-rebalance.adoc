...
+
Note that, in this example, there is no need to check the *Change default disk paths* checkbox, in order to specify that disk paths other than the default be used for the new node.
+
