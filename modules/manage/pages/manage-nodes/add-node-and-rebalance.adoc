...
In such a context, no node can be added to the cluster until conformant administrator-configured certificates have been loaded onto it. Such activities need to be performed in addition to those shown by the examples on this page.
