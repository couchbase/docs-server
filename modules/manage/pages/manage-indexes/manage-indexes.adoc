...
image::manage-ui/queryEditorWithSelectQuery.png[,420,align=left]

Left-click on the *Execute* button.

image::manage-ui/leftClickOnExecuteButton.png[,120,align=left]

Couchbase Web Console now provides feedback on the ongoing execution of the query.

image::manage-ui/executingQuery.png[,300,align=left]

When query-execution has concluded, the results are duly displayed:

image::manage-ui/resultsOfqueryExecution.png[,420,align=left]

==== Explain

The *Explain* button can be left-clicked on to provide an explanation of how query-execution proceeded:

image::manage-ui/leftClickOnExplainButton.png[,140,align=left]

The explanation is now displayed in the *Query Results* panel:

image::manage-ui/queryExplanation.png[,520,align=left]
...
image::manage-ui/leftClickOnAdviseButton.png[,140,align=left]
