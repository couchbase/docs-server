...
Indexes provided by the _Index Service_ facilitate and enhance use of the _Query Service_ to read information from and write information to _documents_, which are provided by the _Data Service_.
