...
Note that towards the right, a further control provides a pull-down menu whereby indexes can be viewed either for all Index Service nodes on the cluster, or for a selected node.
