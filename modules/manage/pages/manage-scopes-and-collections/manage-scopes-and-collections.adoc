...
The *TTL* field can, for this example, be left at its default value of `0` &#8212; which indicates that no _expiration_ value is assigned to the collection and the documents it contains.
