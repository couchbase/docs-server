...
At the right-hand side of the row that displays the new bucket, three options appear: *Collections*, *Documents*, and *Statistics*.
Left-click on the *Collections* option:
+
