...
+
The screen features two rows.
The first row displays the *_default* scope.
...
+
The second row displays the *&#95;system* scope.
This scope, and its collections, are also created by default: however, they are _not_ for the use of administrators; and should _not_ be accessed in any way by users or user-created applications.
+
