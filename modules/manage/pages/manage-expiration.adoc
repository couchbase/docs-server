...
You can set the expiration to the document's current expiration value when mutating. 
...
ia the C SDK. See xref:c-sdk:concept-docs/documents.adoc#setting-document-expiration[Setting Document Expiration].
* Via the Go SDK, `maxTTL` 
