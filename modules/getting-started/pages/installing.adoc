...
NOTE: You can also read about sizing the Couchbase Server cluster in the blog https://blog.couchbase.com/how-many-nodes-part-1-introduction-sizing-couchbase-server-20-cluster[How many nodes?^].
