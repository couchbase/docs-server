...
image::Intellij-run-ok.png[Project Started successfully,720,align=center]
...
Create a new class called *WeatherForecast* and paste the content above.
...
Create a new class called *CmdRunner* and paste the content above. Then, go back to your main class (*QuickStartCouchbase* in this example), and run it again. Don't forget to stop your application first if it is already running.

The output should look like the following:

image::Intellij-application-run-succesfully.png[Application Ran Successfully,720,align=center]
...
image::document-inserted.png[Document Inserted,360,align=center]
...
image::document-metadata.png[Document Metadata, 360,align=center]
