...
* xref:manage:manage-nodes/provision-node.adoc[Provision a Node]: Provides a detailed explanation of how to
provision a Couchbase Server-node, and thereby create a one-node Couchbase cluster.
