...
For information about using containers to run Couchbase Server in production, see xref:install:running-couchbase-in-containers.adoc#run-couchbase-in-containers[Deploying Couchbase Server in Containers].
