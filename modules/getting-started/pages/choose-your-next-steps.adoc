...
The Developer Information section contains explanations to help you understand the services offered by Couchbase Server, and provides an introduction to the .
This provides you with important background detail that you will need to know for development.

The xref:guides:intro[Developer How-to Guides] section contains practical how-to guides, walking you through common Couchbase Server development tasks.
...
A full introduction to N1QL can be found in the section xref:getting-started:try-a-query.adoc[Querying with N1QL], including information on using `cbq`, which allows N1QL queries to be entered at the command line.
...
Take a look at the section xref:sdk:development-intro.adoc[Start Using the SDK].
