...
Read more about Primary Indexes and full table scan indexes here:
https://blog.couchbase.com/primary-uses-for-couchbase-primary-index/[Primary uses for Couchbase Primary Index]

You can read more about Adaptive indexes here:
https://docs.couchbase.com/server/current/n1ql/n1ql-language-reference/adaptive-indexing.html[N1QL Reference - Adaptive Index]
...
You can contiue with your quickstart exercises.  
