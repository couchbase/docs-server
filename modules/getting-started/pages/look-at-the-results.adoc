...
* xref:data-modeling:intro-data-modeling.adoc[Data Modeling Basics]: Provides more information about the Couchbase data-model and an extensive conceptual account of Couchbase buckets.
