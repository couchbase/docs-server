...
* xref:clustersetup:bucket-setup.adoc[Setting Up Buckets]: Contains basic information about buckets.
* xref:understanding-couchbase:data/document-data-model.adoc[Data Modeling Basics]: Provides more information about the Couchbase data-model and an extensive conceptual account of Couchbase buckets.
