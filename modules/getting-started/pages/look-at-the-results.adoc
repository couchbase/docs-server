...
* xref:manage:manage-buckets/create-bucket.adoc[Create a Bucket]: Provides step by step information on
how to create a bucket.
* xref:learn:data/document-data-model.adoc[The Couchbase Data Model]: Provides more information about the Couchbase data model and an extensive conceptual account of Couchbase buckets.
