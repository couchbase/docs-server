...
[abstract]
Now that you have a basic understanding of buckets, scopes and collections, and documents, you can try querying them using N1QL (pronounced "nickel"), the Couchbase Server query language.
