...
* xref:2.6@nodejs-sdk::n1ql-queries-with-sdk.adoc[N1QL from the SDK]: Explains how to execute N1QL queries programmatically using the official Couchbase SDKs.
