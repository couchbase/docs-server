...
* xref:nodejs-sdk::n1ql-queries-with-sdk.adoc#topic_esq_3td_5v[N1QL from the SDK]: Explains how to execute N1QL queries programmatically using the official Couchbase SDKs.
