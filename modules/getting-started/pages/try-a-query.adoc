...
You can run N1QL queries from the command line, using the https://docs.couchbase.com/server/current/cli/cbq-tool.html[`cbq`] tool; or from the Query Workbench in the Couchbase Server Web Console.
