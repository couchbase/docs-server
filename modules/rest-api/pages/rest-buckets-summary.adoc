...
The following example demonstrates getting information about a bucket named `travel-sample`. 
It uses the  https://stedolan.github.io/jq/[jq^] command-line JSON processor to format the output for readability and also filter out some of the less relevant fields.
...
* xref:learn:buckets-memory-and-storage/buckets.adoc[] for an overview of buckets.
* xref:learn:data/scopes-and-collections.adoc[] for an overview of scopes and collections.
