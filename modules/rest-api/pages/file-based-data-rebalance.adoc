...
For more information about file-based rebalance and how it compares to DCP-based rebalance, see xref:learn:clusters-and-availability/rebalance.adoc#file-based-rebalance[File-Based Rebalance].
...
You can get the current status of FBR by posting a GET request to the `/internalSettings` endpoint.
