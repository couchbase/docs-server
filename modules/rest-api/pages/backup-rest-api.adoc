...
NOTE: You can use the xref:rest-api:rbac.adoc#backup-and-restore-users-and-groups[Role-Based Access Control (RBAC)] REST API to backup and restore just the users and groups defined in the database cluster.
