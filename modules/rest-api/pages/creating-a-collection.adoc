...
The optional `maxTTL` parameter is a period of time in seconds. It defaults to 0. When you set `maxTTL` to value greater than zero (but less than its maximum value of 2147483648), it has the following effects:  
