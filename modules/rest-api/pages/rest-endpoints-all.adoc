...
| `GET`
| `/admin/clusters`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_clusters[Admin REST API]

| `GET`
| `/admin/clusters/{cluster}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_cluster[Admin REST API]

| `GET`
| `/admin/clusters/{cluster}/nodes`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_nodes[Admin REST API]

| `GET`
| `/admin/clusters/{cluster}/nodes/{node}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_node[Admin REST API]

| `GET`
| `/admin/config`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_config[Admin REST API]

| `GET`
| `/admin/prepareds`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_prepareds[Admin REST API]

| `GET`
| `/admin/prepareds/{name}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_prepared[Admin REST API]

| `DELETE`
| `/admin/prepareds/{name}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_delete_prepared[Admin REST API]

| `GET`
| `/admin/indexes/prepareds/{name}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_prepared_indexes[Admin REST API]

| `GET`
| `/admin/active_requests`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_active_requests[Admin REST API]

| `GET`
| `/admin/active_requests/{request}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_active_request[Admin REST API]

| `DELETE`
| `/admin/active_requests/{request}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_delete_active_request[Admin REST API]

| `GET`
| `/admin/indexes/active_requests`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_active_indexes[Admin REST API]

| `GET`
| `/admin/completed_requests`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_completed_requests[Admin REST API]

| `GET`
| `/admin/completed_requests/{request}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_completed_request[Admin REST API]

| `DELETE`
| `/admin/completed_requests/{request}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_delete_completed_request[Admin REST API]

| `GET`
| `/admin/indexes/completed_requests`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_completed_indexes[Admin REST API]

| `GET`
| `/admin/vitals`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_vitals[Admin REST API]

| `GET`
| `/admin/stats`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_stats[Admin REST API]

| `GET`
| `/admin/stats/{stats}`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_stat[Admin REST API]

| `GET`
| `/debug/vars`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_debug_vars[Admin REST API]

| `GET`
| `/admin/settings`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_settings[Admin REST API]

| `POST`
| `/admin/settings`
| xref:n1ql:n1ql-rest-api/admin.adoc#_post_settings[Admin REST API]

| `GET`
| `/admin/ping`
| xref:n1ql:n1ql-rest-api/admin.adoc#_get_ping[Admin REST API]
...
| xref:n1ql:n1ql-rest-api/functions.adoc#_get_collection[Functions REST API]

| `GET`
| `/evaluator/v1/libraries/{library}`
| xref:n1ql:n1ql-rest-api/functions.adoc#_get_library[Functions REST API]

| `POST`
| `/evaluator/v1/libraries/{library}`
| xref:n1ql:n1ql-rest-api/functions.adoc#_post_library[Functions REST API]

| `DELETE`
| `/evaluator/v1/libraries/{library}`
| xref:n1ql:n1ql-rest-api/functions.adoc#_delete_library[Functions REST API]
...
| `GET`
| `/api/v1/stats`
| xref:rest-api:rest-index-stats.adoc#_get_node_stats[Index Statistics API]

| `GET`
| `/api/v1/stats/{keyspace}`
| xref:rest-api:rest-index-stats.adoc#_get_keyspace_stats[Index Statistics API]

| `GET`
| `/api/v1/stats/{keyspace}/{index}`
| xref:rest-api:rest-index-stats.adoc#_get_index_stats[Index Statistics API]
...
| `GET`
| `/api/index`
| xref:rest-api:rest-fts-indexing.adoc#index-definition[Indexes]
...
| xref:rest-api:rest-fts-indexing.adoc#index-management[Indexes]
...
| `GET`
| `/api/stats`
| xref:rest-api:rest-fts-indexing.adoc#index-monitoring-and-debugging[Indexes]
...
| xref:rest-api:rest-fts-indexing.adoc#index-querying[Indexes]
...
| `GET`
| `/api/cfg`
| xref:rest-api:rest-fts-node.adoc#index-querying[Node Configuration]
...
| `GET`
| `/api/diag`
| xref:rest-api:rest-fts-node.adoc#node-diagnostics[Node Configuration]
...
| `GET`
| `/api/runtime`
| xref:rest-api:rest-fts-node.adoc#node-diagnosticsNode Configuration]
...
| `POST`
| `/api/runtime/gc`
| xref:rest-api:rest-fts-node.adoc#node-management[Node Configuration]
...
| `GET`
| `/api/runtime/stats`
| xref:rest-api:rest-fts-node.adoc#node-monitoring[Node Configuration]
...
| xref:rest-api:rest-fts-node.adoc[Advanced]
...
| xref:analytics:rest-service.adoc#request-cancellation[Request Cancellation]

| `POST`
| `/analytics/cluster/restart`
| xref:analytics:rest-service.adoc#cluster-restart[Cluster Restart]

| `POST`
| `/analytics/node/restart`
| xref:analytics:rest-service.adoc#node-restart[Node Restart]

| `GET`
| `/analytics/node/agg/stats/remaining`
| xref:analytics:rest-service.adoc#pending-mutations[Pending Mutations]
...
| `POST`
| `/analytics/link`
| xref:analytics:rest-links.adoc#create-link[Create Link (Alternative)]

| `GET`
| `/analytics/link`
| xref:analytics:rest-links.adoc#query-link[Query Link (Alternative)]

| `PUT`
| `/analytics/link/`
| xref:analytics:rest-links.adoc#edit-link[Edit Link (Alternative)]

| `DELETE`
| `/analytics/link`
| xref:analytics:rest-links.adoc#delete-link[Delete Link (Alternative)]
