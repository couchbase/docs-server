...
NOTE: In Couchbase Server versions 7.6.0 and 7.6.1, when you enabled file-based rebalance by setting `enableShardAffinity` to `true`, you could not choose which Index Service nodes would contain an index.
