...
The following command disables the File Transfer Based Rebalance (`enableShardAffinity`) feature in the xref:manage:general-settings.adoc#index-storage-mode[Index Storage Mode].
