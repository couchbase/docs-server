...
// Cross-references
:rebalancing-the-index-service: xref:learn:clusters-and-availability/rebalance-and-index-service.adoc
...
| `enableShardAffinity`
a| Selects the xref:learn:clusters-and-availability/rebalance-and-index-service.adoc#index-rebalance-methods[Index Rebalance Methods]:
...
----
include::example$post-settings-indexes.sh[tags=gsi-settings]
----
