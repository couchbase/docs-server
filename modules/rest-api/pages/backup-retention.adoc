...
* For setting a retention period for a repository from the UI, see xref:manage:manage-backup-and-restore/manage-backup-and-restore.adoc#set-retention-period-after-repo-creation[Set Retention Period after Repository Creation].
