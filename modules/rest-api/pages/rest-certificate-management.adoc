...
* Certificates can be checked against Certificate Revocation Lists (CRLs), and CRLs can be uploaded, listed, deleted, and reloaded.
See xref:rest-api:rest-certificate-revocation.adoc[Certificate Revocation API].
