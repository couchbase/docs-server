...
:description: pass:q[To retrieve information about existing buckets and the default bucket, use the `GET` operation with the `/pools/default/buckets/[bucket-name]` URI.]
