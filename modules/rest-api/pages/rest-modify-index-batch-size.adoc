...
An overview of rebalance as it affects the Index Service, including an overview of _smart batching_, is provided in xref:learn:clusters-and-availability/rebalance-and-index-service.adoc#rebalancing-the-index-service[Index Service].
