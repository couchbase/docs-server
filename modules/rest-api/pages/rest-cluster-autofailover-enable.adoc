...
Specifies the maximum number of sequential auto-failover nodes to be handled before administrator-intervention is required.
This could be one node failing over; or alternatively, of an entire server group failing over.
