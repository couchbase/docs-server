...
+
uuid field is mandatory for index definition updates.
It also helps the clients that want to check that they are not overwriting the index definition updates of other concurrent clients.
