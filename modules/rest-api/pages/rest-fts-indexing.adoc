...
| Yes
| String, URL path parameter
| The name of the Search index definition you want to return. 
...
While frozen, the Search index stops assigning 
...
| Yes
| String, URL path parameter
| The name of the Search index to use to analyze the document in the request body.
...
| Yes
| String, URL path parameter
| The name of the index where you want to count the number of available documents.
