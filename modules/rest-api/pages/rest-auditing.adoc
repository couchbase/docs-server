...
Internal users can only be specified on Couchbase Server Version 6.0.3 and later.
+
...
It confirms that event auditing is enabled, and lists `disabledUsers`: the list shown contains one local user, and two internal (internal users can only be specified on Couchbase Server Version 6.0.3 and later).
...
http://10.143.193.101:8091/settings/audit \
...
(Note that internal users can only be specified on Couchbase Server Version 6.0.3 and later.)
