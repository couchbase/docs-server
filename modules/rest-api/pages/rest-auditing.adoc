...
=== List of Non-filterable Audit Events
...
A successful call will return a JSON result string similar to the following,
 containing a list of the audit events that cannot be filtered.
...
==== Change User Activity Auditing Status
...
==== Get User Activity Auditing Status
...
* For more information about managing the auditing of user activity, see xref:manage:manage-security/manage-auditing.adoc#auditing-user-activity[Auditing User Activity].
* For learning more about auditing user activity, see xref:learn:security/auditing.adoc#audit-user-activity[Audit User Activity].
