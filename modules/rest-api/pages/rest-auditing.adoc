...
* For more information about auditing user activity, see xref:manage:manage-security/manage-auditing.adoc#auditing-user-activity[Auditing User Activity] and xref:learn:security/auditing.adoc#audit-user-activity[Audit User Activity].
