...
This parameter, which is available only in 7.1.2+, is described separately, in xref:rest-api:rest-specify-node-addition-conventions.adoc[Restrict Node-Addition].
