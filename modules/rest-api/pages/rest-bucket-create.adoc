...
_General_ parameters support both _standard_ and _memory-optimized_ storage, and apply equally to Couchbase Server Enterprise and Community Editions.
They include:
...
[#example-name-create]
==== Example: Specifying a Name When Creating
...
[#example-name-edit]
==== Example: Specifying a Name When Editing
