...
[#storageBackend]
=== storageBackend
Specifies the storage to be used for the bucket.
The value can be either `couchstore` or `magma`.
This option is only valid for Couchbase buckets.
