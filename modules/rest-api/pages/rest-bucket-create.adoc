...
You can create buckets of any type: Couchbase, Ephemeral, or Memcached.
(Memcached buckets are now deprecated.)
...
No policy can be assigned to a Memcached bucket.
...
No level can be assigned to a Memcached bucket.
