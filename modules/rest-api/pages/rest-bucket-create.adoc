...
The value of the `ramQuota` parameter (described below), is hereby increased to `512` megebytes.
...
An incorrect memory-specification returns a notification such as `{"ramQuota":"RAM quota cannot be less than 100 MB"}`.
