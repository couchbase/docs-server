...
The larger the specified block size, the better the block compression may be; potentially at the cost of greater consumption of memory, cpu, and I/O bandwidth.
