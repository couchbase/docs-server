...
If you are using XDCR Active - Active replication with Sync Gateway 4.0+, see xref:learn:clusters-and-availability/xdcr-active-active-sgw.adoc[XDCR Active-Active with Sync Gateway] for information about setting up the `enableCrossClusterVersioning` bucket property.
