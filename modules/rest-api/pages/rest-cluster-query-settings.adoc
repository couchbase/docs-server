...
:description: Unresolved directive in rest-cluster-query-settings.adoc - include::partial$query-settings/overview.adoc[tag=body] \
Unresolved directive in rest-cluster-query-settings.adoc - include::partial$query-settings/paths.adoc[] \
Unresolved directive in rest-cluster-query-settings.adoc - include::partial$query-settings/definitions.adoc[] \
Unresolved directive in rest-cluster-query-settings.adoc - include::partial$query-settings/security.adoc[]
