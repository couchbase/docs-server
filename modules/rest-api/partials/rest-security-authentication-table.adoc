...
| `GET`
| `/settings/jwt`
| xref:rest-api:rest-configure-jwt.adoc#get-settingsjwt[Configure JWT]

| `PUT`
| `/settings/jwt`
| xref:rest-api:rest-configure-jwt.adoc#put-settingsjwt[Configure JWT]

| `DELETE`
| `/settings/jwt`
| xref:rest-api:rest-configure-jwt.adoc#delete-settingsjwt[Configure JWT]
