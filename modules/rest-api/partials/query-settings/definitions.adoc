...
There is also a {completed-limit-srv}[node-level] `completed-limit` setting, which enables you to change this setting for a single node.
...
There is also a {completed-threshold-srv}[node-level] `completed-threshold` setting, which enables you to change this setting for a single node.
When you change the cluster-level setting, the node-level setting is over-written for all nodes in the cluster. +
**Default** : `1000` +
**Example** : `7000`|integer (int32)
|**queryLogLevel** +
...
There is also a {loglevel-srv}[node-level] `loglevel` setting, which enables you to change this setting for a single node.
When you change the cluster-level setting, the node-level setting is over-written for all nodes in the cluster. +
**Default** : `"INFO"` +
...
There is also a {max-parallelism-srv}[node-level] `max_parallelism` parameter, which enables you to change this setting for a single node.
When you change the cluster-level setting, the node-level setting is over-written for all nodes in the cluster.
...
There is also a {n1ql-feat-ctrl}[node-level] `n1ql-feat-ctrl` parameter, which enables you to change this setting for a single node.
...
There is also a {pipeline-batch-srv}[node-level] `pipeline-batch` parameter, which enables you to change this setting for a single node.
When you change the cluster-level setting, the node-level setting is over-written for all nodes in the cluster.
...
There is also a {pipeline-cap-srv}[node-level] `pipeline-cap` parameter, which enables you to change this setting for a single node.
When you change the cluster-level setting, the node-level setting is over-written for all nodes in the cluster.
...
There is also a {prepared-limit-srv}[node-level] `prepared-limit` parameter, which enables you to change this setting for a single node.
When you change the cluster-level setting, the node-level setting is over-written for all nodes in the cluster. +
**Default** : `16384` +
...
There is also a {scan-cap-srv}[node-level] `scan-cap` parameter, which enables you to change this setting for a single node.
When you change the cluster-level setting, the node-level setting is over-written for all nodes in the cluster.
...
There is also a {timeout-srv}[node-level] `timeout` parameter, which enables you to change this setting for a single node.
When you change the cluster-level setting, the node-level setting is over-written for all nodes in the cluster.
