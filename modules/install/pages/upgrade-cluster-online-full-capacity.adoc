...
NOTE: Running Eventing functions during a rolling upgrade increases rebalance duration.
To reduce rebalance time, pause all your Eventing functions before starting the upgrade, and resume them after the upgrade completes.
