...
:erlang-upgrade-note: The upgrade to Erlang support in Couchbase server 7.2.4 requires that you first upgrade Couchbase to version 7.1.0 or later before upgrading to version 7.2.4
...
then make sure your cluster is *not* running in `mixed mode`.
(i.e. some nodes are using IPv4 addressing while some are using IPv6).
====
...
so that each of its nodes subsequently runs Couchbase Server Enterprise Edition Version 7.2.
...
For example, if you are upgrading three enterprise nodes (`*Node{nbsp}1*`, `*Node{nbsp}2*` and `*Node{nbsp}3*`) from version 5.1x to 7.2.4, then you would use the following sequence:

[#upgrade-example]
.Upgrading from version `5.1x` to `7.2.4`
====
[cols="1,2,2"]
|===
...
|
`*Node{nbsp}1*` => 7.2.3 -> 7.2.4 +
`*Node{nbsp}2*` =>  7.2.3 -> 7.2.4 +
`*Node{nbsp}3*` => 7.2.3 -> 7.2.4
...
| 5.0.x and 5.1.x -> 6.6 -> 7.2.3 -> 7.2.4{blank}xref:erlang-7-2-4-footnote1[^+[1]+^] -> 7.6

| 5.5x

| 5.5.0+ -> 6.6 -> 7.2.3 -> 7.2.4{blank}xref:erlang-7-2-4-footnote1[^+[1]+^] -> 7.6

| 6.x
| 6.0 -> 6.6 -> 7.2.3 -> 7.2.4{blank}xref:erlang-7-2-4-footnote1[^+[1]+^] -> 7.6

| 7.x
| 7.0 -> 7.1 -> 7.2.4{blank}xref:erlang-7-2-4-footnote1[^+[1]+^] -> 7.6




|===
[#erlang-7-2-4-footnote1]^1^{erlang-upgrade-note}
...
| 5.x
| 5.x  -> 6.6 -> 7.2.3 -> 7.2.4{blank}xref:erlang-7-2-4-footnote2[^+[1]+^] -> 7.6

| 6.x
| 6.0 -> 6.6 -> 7.2.3 -> 7.2.4{blank}xref:erlang-7-2-4-footnote2[^+[1]+^] -> 7.6

| 7.x
| 7.0 -> 7.1 -> 7.2.4{blank}xref:erlang-7-2-4-footnote2[^+[1]+^] -> 7.6
