...
| Any 5.0.x / 5.1.x / 5.5.x → 6.6 → 7.2.3 → 8.0.1
...
| 5.x
| Any 5.x → 6.6.0 → 7.2.2 → 8.0{empty}xref:erlang-8-0-footnote1[^+[1]+^] → 

| 6.x
| Any 6.0.x / 6.5.x → 6.6.0 → 7.2.2 → 8.0{empty}xref:erlang-8-0-footnote1[^+[1]+^]

| 7.x
| Any 7.0.x / 7.1.x → 7.2.2 → 8.0{empty}xref:erlang-8-0-footnote1[^+[1]+^]
