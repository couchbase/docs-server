...
[NOTE]
====
For example, to upgrade from *6.6* to *7.6.x*, then _two_ upgrades must be performed (as shown in <<upgrade-example>>): +
first, from *6.6* to *7.2.3* +
and then, from *7.2.3* to *7.6.x*.
====
...
then a _downgrade_ to the earlier version of Couchbase Server can be performed,
