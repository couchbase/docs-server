...
| 5.0.x and 5.1.x -> 6.0.4+ -> 6.6 -> 7.2.x (except 7.2.4) -> 7.2.4

5.0.x and 5.1.x -> 6.6 -> 7.2.x (except 7.2.4) -> 7.2.4

5.5.0+ -> 6.6 -> 7.2.x (except 7.2.4) -> 7.2.4

| 6.x
| 6.0 -> 6.6 -> 7.2.x (except 7.2.4) -> 7.2.4
...
| 5.x
| 5.x -> 6.0 -> 6.6 -> 7.2.x (except 7.2.4) -> 7.2.4
