...
For example, an upgrade from version 7.6.0 to version 7.6.1 is a maintenance version upgrade.
...
See xref:install:upgrade-procedure-selection.adoc#offline-upgrade[Upgrade with Cluster Offline] for more information about offline upgrades.
