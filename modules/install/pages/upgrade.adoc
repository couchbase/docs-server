...
| 5.0.x
| 5.0.x and 5.1.x -> 6.0.4+ -> 6.6 -> 7.2.x (except 7.2.4{blank}xref:footnote-7241[^+[1]+^]) -> 7.2.4

5.0.x and 5.1.x -> 6.6 -> 7.2.x (except 7.2.4{blank}xref:footnote-7241[^+[1]+^]) -> 7.2.4

5.5.0+ -> 6.6 -> 7.2.x (except 7.2.4{blank}xref:footnote-7241[^+[1]+^]) -> 7.2.4

| 6.x
| 6.0 -> 6.6 -> 7.2.x (except 7.2.4{blank}xref:footnote-7241[^+[1]+^]) -> 7.2.4

| 7.x
| 7.0 -> 7.1 -> 7.2.4

7.0 -> 7.2.x (except 7.2.4{blank}xref:footnote-7241[^+[1]+^]) -> 7.2.4

|===

[#footnote-7241]
^1^ You must install `7.2.x` (e.g. `7.2.1`, `7.2.2` …) *before* installing `7.2.4`.
...
| 5.x
| 5.x -> 6.0 -> 6.6 -> 7.2.x (except 7.2.4{blank}xref:footnote-7242[^+[1]+^]) -> 7.2.4

| 6.x
| 6.0 -> 6.6 -> 7.2.x (except 7.2.4{blank}xref:footnote-7242[^+[1]+^]) -> 7.2.4

| 7.x
| 7.0 -> 7.1 -> 7.2.4

7.0 -> 7.2.x (except 7.2.4{blank}xref:footnote-7242[^+[1]+^]) -> 7.2.4

7.0 -> 7.2.x (except 7.2.4) -> 7.2.4
