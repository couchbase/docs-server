...
| 5.0.x
| 5.0.x and 5.1.x -> 6.0.4+ -> 6.6 -> 7.2.x (except 7.2.3) -> 7.2.3

5.0.x and 5.1.x -> 6.6 -> 7.2.x (except 7.2.3) -> 7.2.3

5.5.0+ -> 6.6 -> 7.2.x (except 7.2.3) -> 7.2.3

| 6.x
| 6.0 -> 6.6 -> 7.2.x (except 7.2.3) -> 7.2.3

| 7.x
| 7.0 -> 7.1 -> 7.2.3

7.0 -> 7.2.x (except 7.2.3) -> 7.2.3
...
| 5.x
| 5.x -> 6.0 -> 6.6 -> 7.2.x (except 7.2.3) -> 7.2.3
