...
When upgrading to Version 7.x from Version 5.x or v6.6, _turn off auditing_.
...
.Important note when upgrading from 7.0.4 to 7.1x on Windows 2019
[sidebar]
****
Upgrading from version 7.0.4 -> 7.1x on Windows Server 2019 may result in a missing `java` executable files.
