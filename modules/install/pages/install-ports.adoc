...
:afnote-eventing-debug-port: afnote:table-2[The Eventing Service Debugger port `eventing_debug_port` (9140) is an internal port and is not supported for external access outside of the cluster. You should only use this port in your development environments.]
...
| _Client-to-node_
| *Unencrypted*: 8091-8097, 9123, 9140 {afnote-eventing-debug-port}, 11210, 11280
