...
. Create a backup of your cluster data.
For Couchbase Server Enterprise Edition, use the xref:backup-restore:cbbackupmgr.adoc[cbbackupmgr tool].
For Couchbase Server Community Edition, use the  xref:cli:cbbackup-tool.adoc[cbbackup tool].
