...
. Create a backup of your cluster data using the xref:backup-restore:cbbackupmgr.adoc[cbbackupmgr] tool, which is available in the Enterprise Edition. For Couchbase Server Community Edition, use the  xref:cli:cbbackup-tool.adoc[cbbackup tool].
