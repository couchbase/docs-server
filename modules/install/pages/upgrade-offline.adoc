...
. After you shut down the services, perform a standard node upgrade to the new version of Couchbase Server as explained in xref:upgrade-individual-nodes.adoc#topic_tc1_vry_p4[Performing the Single Node Upgrade].
+
