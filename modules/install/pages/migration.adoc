...
Cluster 1 (Bucket A) continuously replicates data to Cluster 2 (Bucket A'), which is one way.

* Scenario 2: Bidirectional replication for data locality -
Cluster 1 (Bucket A) and Cluster 2 (Bucket A’) replicate data to each other.
