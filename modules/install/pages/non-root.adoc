...
* Different from those used for standard, package-based installation.
...
. Choose &#8212; and if necessary, create &#8212; a directory into which the installation will occur.
For example:
+
----
mkdir ./cb-install
...
To uninstall, stop the server, then remove all files from the install location.
For example:
