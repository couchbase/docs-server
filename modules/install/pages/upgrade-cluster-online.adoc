...
Couchbase Server 7.0.2 and later versions allow TLS to be specified as mandatory for all internal and external cluster-communications -- see xref:manage:manage-security/manage-tls.adoc[Manage On-the-Wire Security].
