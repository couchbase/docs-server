= Installing Couchbase Server on macOS
:tabs:
...
When Couchbase Server starts, the Couchbase Server icon image:macos-menu-bar-icon-light.png[,20] will appear in the menu bar.
