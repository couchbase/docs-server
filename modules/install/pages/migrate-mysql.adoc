...
Various tools are available, but the most common use cases are best served by combining our xref:connectors:odbc-jdbc-drivers.html[JDBC drivers] with our xref:2.7@java-sdk::start-using-sdk.adoc[Java SDK]..
