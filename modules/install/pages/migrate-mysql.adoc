...
With Couchbase Server, you also get an expressive SQL-like query language and query engine called xref:n1ql:n1ql-intro/queriesandresults.adoc[N1QL], which is combined with a new powerful indexing mechanism – xref:indexes:gsi-for-n1ql.adoc[global secondary indexes].
