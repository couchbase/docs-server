...
For next steps, see xref:init-setup.adoc[Initialize the Cluster], xref:startup-shutdown.adoc[Couchbase Server Startup and Shutdown], and xref:testing.adoc[Testing Couchbase Server].
