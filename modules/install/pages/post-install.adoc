...
For next steps, see xref:init-setup.adoc[Initializing the Cluster], xref:startup-shutdown.adoc[Couchbase Server Startup and Shutdown], and xref:testing.adoc[Verifying Your Couchbase Server Installation].
