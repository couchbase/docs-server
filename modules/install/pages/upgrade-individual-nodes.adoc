...
. Perform the upgrade installation for your platform; see the section xref:install-intro.adoc#topic_edn_wtd_54[Installing On-Premises] appropriate for your platform for detailed installation instructions.
