...
. Perform the upgrade installation for your platform; see the section xref:install-intro.adoc[Installing Couchbase Server] appropriate for your platform for detailed installation instructions.
