...
. On one of the physical hosts, access the Web Console from the browser using [.path]_http://node-ip:8091_.
...
. On the remaining physical hosts, access the Web Console from the browse using [.path]_http://node-ip:8091_.
...
Open the Web Console at [.path]_http://node-ip:8091_ and switch to the Query tab.
Run the following N1QL query:
