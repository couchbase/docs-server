...
If your cluster is not sized to handle both the existing workload and the new XDCR streams, the performance of both XDCR and your cluster might be negatively impacted.
