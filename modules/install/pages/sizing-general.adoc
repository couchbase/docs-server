...
The Eventing memory quota is discussed in detail in the xref:manage/manage-eventing/eventing-memory-quota.adoc[Eventing Memory Quota] doc. 
Refer this document to learn:
* What is Eventing Service memory quota
* How the Eventing Service memory quota works
