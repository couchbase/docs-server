...
The access scanner is highly CPU-intensive, and shares a thread pool with the Index Service: consequently, if scanning is performed simultaneously with index updates, the performance of the index updates may be adversely affected.
