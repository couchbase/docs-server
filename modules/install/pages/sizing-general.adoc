...
The xref:eventing-memory-quota.adoc[Eventing Memory Quota] doc discusses the Eventing Service memory quota in detail. 
Refer this document to learn more about:
