...
With the introduction of xref:architecture:services-archi-multi-dimensional-scaling.adoc[Multi-Dimensional Scaling (MDS)], sizing is becoming more challenging, and this guideline aims to help users better size their clusters.
