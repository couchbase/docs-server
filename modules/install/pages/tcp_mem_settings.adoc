...
For example, it minimize the amount of memory it allocates for TCP/IP windows, buffers, and incoming packets aad agressively freeing buffers for closing sockets.
...
Remember that the `tcp_mem` values are in pages, so you need to convert the amount of RAM erported by your system into pages.
