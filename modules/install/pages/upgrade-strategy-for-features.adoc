...
The following table summarizes the new features in this release and provides a handy reference to help you upgrade.

.Couchbase Server 6.0 Features and Upgrade Strategy
[cols="5,2,2,2,2,2,2"]
|===
...
. Upgrade the source cluster to Couchbase Server version 5.5 or newer.
