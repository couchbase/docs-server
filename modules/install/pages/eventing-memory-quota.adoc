...
The Eventing Service memory quota controls specific aspects of memory management, such as queue sizing and garbage collection, but does not act as an absolute ceiling on memory usage.
