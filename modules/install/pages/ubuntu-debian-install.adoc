...
Before you begin, ensure that your system has all the dependencies installed. To see the list of packages that our package depends on, use the command:

[source,bash]
----
dpkg --info couchbase-server.deb | grep Depends
----
