...
. Download and install the appropriate meta package from the https://packages.couchbase.com/releases/couchbase-release/couchbase-release-1.0-6-amd64.deb[package download location^].
