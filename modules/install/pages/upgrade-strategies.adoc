...
If the speed of an upgrade is a primary concern for your cluster, as it might be if you have a tight maintenance window, see xref:clustersetup:setup-failover-graceful.adoc#topic_ysk_ycm_zs[Graceful Failover] or xref:upgrade-offline.adoc#topic_q11_1my_p4[Performing the Offline Upgrade].
