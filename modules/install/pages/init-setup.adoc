...
When you have entered the appropriate details, you can left-click on the *Join With Default Configuration* button, at the lower right, in order to join the cluster using a default configuration.
...
When you have made the appropriate changes, left-click on the *Save Settings* button.
