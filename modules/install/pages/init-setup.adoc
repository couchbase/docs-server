...
image::managing-clusters:managing-nodes/setUpNewCluster01.png[,390,align=left]
...
[#ts_and_cs_01]
image::managing-clusters:managing-nodes/TsAndCs01.png[,390,align=left]
...
image::managing-clusters:managing-nodes/registerForUpdates01.png[,390,align=left]
...
image::managing-clusters:managing-nodes/configureNewCluster01.png[,390,align=left]
...
[#dashboard_01]
image::managing-clusters:managing-nodes/dashboard01.png[,820,align=left]
...
image::managing-clusters:managing-nodes/joinClusterInitial.png[,390,align=left]
...
image::managing-clusters:managing-nodes/joinWithDefaultConfig.png[,390,align=left]
...
image::managing-clusters:managing-nodes/joinClusterServiceCheckboxes.png[,140,align=left]

Note that due to this change, the button at the lower right has been renamed:

[#join_with_custom_configuration_button]
image::managing-clusters:managing-nodes/joinWithCustomConfigurationButton.png[,240,align=left]
...
image::managing-clusters:managing-nodes/joinExistingNewServiceSettings.png[,390,align=left]
...
image::managing-clusters:managing-nodes/joinClusterMemoryQuotaSaved.png[,720,align=left]
