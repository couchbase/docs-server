...
Each administrator and application is considered to be a _user_, and must be xref:learn:security/authorization-overview.adoc[authorized] to gain access to the data within Couchbase.
