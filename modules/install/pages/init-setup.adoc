...
* [.ui]*Create Admin Username*: Your choice of username for the first user account; the default username `Administrator` is provided.
+
...
* [.ui]*Create Password*: Your choice of password for the new user account.
