...
If your language and development environment supports a smart client library, xref:sdks:intro.adoc#concept_yqn_tjg_ps[Couchbase Server client SDKs] are the preferred deployment option.
