...
:description: Couchbase Server can be installed on Red Hat Enterprise Linux and CentOS Linux for production and development use-cases.
:tabs:
...
Non-root installation is performed identically for all supported Linux distributions, including Red Hat Enterprise and CentOS.
