...
| Amazon Linux AMIfootnote:[Amazon Linux is only supported when it is run using the official Couchbase Server AMI on AWS.]footnote:[Amazon Linux is supported with the CentOS 6 package of Couchbase Server.]
| Certified 2017.09
