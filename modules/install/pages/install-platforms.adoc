...
NOTE: If you're using the xref:cloud::index.adoc[Capella platform], then you can find the supported platforms for Capella  xref:cloud:reference:browser-compatibility.adoc[here]
